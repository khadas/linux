...
static u8 free_bit[] = {
	0, 1, 0, 2, 0, 1, 0, 3, 0, 1,
	0, 2, 0, 1, 0, 4, 0, 1, 0, 2, /*   0 ~  19 */
	0, 1, 0, 3, 0, 1, 0, 2, 0, 1,
	0, 5, 0, 1, 0, 2, 0, 1, 0, 3, /*  20 ~  39 */
	0, 1, 0, 2, 0, 1, 0, 4, 0, 1,
	0, 2, 0, 1, 0, 3, 0, 1, 0, 2, /*  40 ~  59 */
	0, 1, 0, 6, 0, 1, 0, 2, 0, 1,
	0, 3, 0, 1, 0, 2, 0, 1, 0, 4, /*  60 ~  79 */
	0, 1, 0, 2, 0, 1, 0, 3, 0, 1,
	0, 2, 0, 1, 0, 5, 0, 1, 0, 2, /*  80 ~  99 */
	0, 1, 0, 3, 0, 1, 0, 2, 0, 1,
	0, 4, 0, 1, 0, 2, 0, 1, 0, 3, /* 100 ~ 119 */
	0, 1, 0, 2, 0, 1, 0, 7, 0, 1,
	0, 2, 0, 1, 0, 3, 0, 1, 0, 2, /* 120 ~ 139 */
	0, 1, 0, 4, 0, 1, 0, 2, 0, 1,
	0, 3, 0, 1, 0, 2, 0, 1, 0, 5, /* 140 ~ 159 */
	0, 1, 0, 2, 0, 1, 0, 3, 0, 1,
	0, 2, 0, 1, 0, 4, 0, 1, 0, 2, /* 160 ~ 179 */
	0, 1, 0, 3, 0, 1, 0, 2, 0, 1,
	0, 6, 0, 1, 0, 2, 0, 1, 0, 3, /* 180 ~ 199 */
	0, 1, 0, 2, 0, 1, 0, 4, 0, 1,
	0, 2, 0, 1, 0, 3, 0, 1, 0, 2, /* 200 ~ 219 */
	0, 1, 0, 5, 0, 1, 0, 2, 0, 1,
	0, 3, 0, 1, 0, 2, 0, 1, 0, 4, /* 220 ~ 239 */
	0, 1, 0, 2, 0, 1, 0, 3, 0, 1,
	0, 2, 0, 1, 0                 /* 240 ~ 254 */
};
...
static u8 used_bit[] = {
	0, 1, 1, 2, 1, 2, 2, 3, 1, 2,
	2, 3, 2, 3, 3, 4, 1, 2, 2, 3, /*   0 ~  19 */
	2, 3, 3, 4, 2, 3, 3, 4, 3, 4,
	4, 5, 1, 2, 2, 3, 2, 3, 3, 4, /*  20 ~  39 */
	2, 3, 3, 4, 3, 4, 4, 5, 2, 3,
	3, 4, 3, 4, 4, 5, 3, 4, 4, 5, /*  40 ~  59 */
	4, 5, 5, 6, 1, 2, 2, 3, 2, 3,
	3, 4, 2, 3, 3, 4, 3, 4, 4, 5, /*  60 ~  79 */
	2, 3, 3, 4, 3, 4, 4, 5, 3, 4,
	4, 5, 4, 5, 5, 6, 2, 3, 3, 4, /*  80 ~  99 */
	3, 4, 4, 5, 3, 4, 4, 5, 4, 5,
	5, 6, 3, 4, 4, 5, 4, 5, 5, 6, /* 100 ~ 119 */
	4, 5, 5, 6, 5, 6, 6, 7, 1, 2,
	2, 3, 2, 3, 3, 4, 2, 3, 3, 4, /* 120 ~ 139 */
	3, 4, 4, 5, 2, 3, 3, 4, 3, 4,
	4, 5, 3, 4, 4, 5, 4, 5, 5, 6, /* 140 ~ 159 */
	2, 3, 3, 4, 3, 4, 4, 5, 3, 4,
	4, 5, 4, 5, 5, 6, 3, 4, 4, 5, /* 160 ~ 179 */
	4, 5, 5, 6, 4, 5, 5, 6, 5, 6,
	6, 7, 2, 3, 3, 4, 3, 4, 4, 5, /* 180 ~ 199 */
	3, 4, 4, 5, 4, 5, 5, 6, 3, 4,
	4, 5, 4, 5, 5, 6, 4, 5, 5, 6, /* 200 ~ 219 */
	5, 6, 6, 7, 3, 4, 4, 5, 4, 5,
	5, 6, 4, 5, 5, 6, 5, 6, 6, 7, /* 220 ~ 239 */
	4, 5, 5, 6, 5, 6, 6, 7, 5, 6,
	6, 7, 6, 7, 7, 8              /* 240 ~ 255 */
};
...
s32 ffsMountVol(struct super_block *sb)
{
	...
	DPRINTK("[EXFAT] mounted successfully\n");
...
s32 ffsUmountVol(struct super_block *sb)
{
	...
	DPRINTK("[EXFAT] trying to unmount...\n");
	...
	if (p_fs->dev_ejected) {
		DPRINTK("[EXFAT] unmounted with media errors.");
		DPRINTK("device's already ejected.\n");
		return FFS_MEDIAERR;
	}

	DPRINTK("[EXFAT] unmounted successfully\n");
...
s32 ffsLookupFile(struct inode *inode, char *path, struct FILE_ID_T *fid)
{
	...
	ret = get_num_entries_and_dos_name(
			sb, &dir, &uni_name, &num_entries, &dos_name);
	if (ret)
		return ret;

	/* search the file name for directories */
	dentry = p_fs->fs_func->find_dir_entry(sb, &dir,
	...
	if (dentry == -1) {
		...
		if (p_fs->vol_type == EXFAT) {
			es = get_entry_set_in_dir(sb, &dir,
				dentry, ES_2_ENTRIES, &ep);
			if (!es)
				return FFS_MEDIAERR;
			ep2 = ep+1;
		} else {
...
s32 ffsCreateFile(struct inode *inode, char *path,
...
s32 ffsReadFile(struct inode *inode,
	struct FILE_ID_T *fid, void *buffer, u64 count, u64 *rcount)
{
...
s32 ffsWriteFile(struct inode *inode, struct FILE_ID_T *fid,
	...
	while (count > 0) {
		...
		if (clu == CLUSTER_32(~0)) {
			num_alloc = (s32)((count-1) >>
				p_fs->cluster_size_bits) + 1;
			new_clu.dir = (last_clu ==
				CLUSTER_32(~0)) ? CLUSTER_32(~0) : last_clu+1;
			new_clu.size = 0;
			new_clu.flags = fid->flags;

			/* (1) allocate a chain of clusters */
			num_alloced =
			p_fs->fs_func->alloc_cluster(sb, num_alloc, &new_clu);
			if (num_alloced == 0)
				break;
...
s32 ffsTruncateFile(struct inode *inode, u64 old_size, u64 new_size)
{
	...
	if (fid->size != old_size) {
		DPRINTK("[EXFAT] truncate : can't skip it because of");
		DPRINTK(" size-mismatch(old:%lld->fid:%lld).\n",
				old_size, fid->size);
	}
	...
	struct inode *new_parent_inode, struct dentry *new_dentry)
{
	...
	if (olddir.dir == newdir.dir)
		ret = rename_file(new_parent_inode,
			&olddir, dentry, &uni_name, fid);
	else
		ret = move_file(new_parent_inode, &olddir,
			dentry, &newdir, &uni_name, fid);
	...
	if ((ret == FFS_SUCCESS) && new_inode) {
		...
		num_entries = p_fs->fs_func->count_ext_entries(sb,
			p_dir, new_entry, ep);
		if (num_entries < 0)
			goto out;
		p_fs->fs_func->delete_dir_entry(sb, p_dir,
			new_entry, 0, num_entries+1);
	}
out:
#ifdef CONFIG_EXFAT_DELAYED_SYNC
	fs_sync(sb, 0);
...
s32 ffsGetStat(struct inode *inode, struct DIR_ENTRY_T *info)
{
	...
	if (is_dir) {
		if ((fid->dir.dir == p_fs->root_dir) &&
			...
			memset((char *) &info->CreateTimestamp,
				0, sizeof(struct DATE_TIME_T));
			memset((char *) &info->ModifyTimestamp,
				0, sizeof(struct DATE_TIME_T));
			memset((char *) &info->AccessTimestamp,
				0, sizeof(struct DATE_TIME_T));
			...
			if (p_fs->root_dir == CLUSTER_32(0))
				info->Size =
				p_fs->dentries_in_root << DENTRY_SIZE_BITS;
			else
	...
	*(uni_name.name) = 0x0;
	...
	p_fs->fs_func->get_uni_name_from_ext_entry(sb,
		&(fid->dir), fid->entry, uni_name.name);
	if (*(uni_name.name) == 0x0 && p_fs->vol_type != EXFAT)
		get_uni_name_from_dos_entry(sb,
		(struct DOS_DENTRY_T *) ep, &uni_name, 0x1);
	...
	if (p_fs->vol_type == EXFAT) {
		...
		get_uni_name_from_dos_entry(sb,
			(struct DOS_DENTRY_T *) ep, &uni_name, 0x0);
...
s32 ffsReadDir(struct inode *inode, struct DIR_ENTRY_T *dir_entry)
{
	...
	while (clu.dir != CLUSTER_32(~0)) {
		...
		for ( ; i < dentries_per_clu; i++, dentry++) {
			...
			memset((char *) &dir_entry->AccessTimestamp,
					0, sizeof(struct DATE_TIME_T));

			*(uni_name.name) = 0x0;
			p_fs->fs_func->get_uni_name_from_ext_entry(sb,
				&dir, dentry, uni_name.name);
...
s32 fs_init(void)
{
	/* critical check for system
	   requirement on size of DENTRY_T structure */
	if (sizeof(struct DENTRY_T) != DENTRY_SIZE)
		return FFS_ALIGNMENTERR;

	if (sizeof(struct DOS_DENTRY_T) != DENTRY_SIZE)
		return FFS_ALIGNMENTERR;

	if (sizeof(struct EXT_DENTRY_T) != DENTRY_SIZE)
		return FFS_ALIGNMENTERR;

	if (sizeof(struct FILE_DENTRY_T) != DENTRY_SIZE)
		return FFS_ALIGNMENTERR;

	if (sizeof(struct STRM_DENTRY_T) != DENTRY_SIZE)
		return FFS_ALIGNMENTERR;

	if (sizeof(struct NAME_DENTRY_T) != DENTRY_SIZE)
		return FFS_ALIGNMENTERR;

	if (sizeof(struct BMAP_DENTRY_T) != DENTRY_SIZE)
		return FFS_ALIGNMENTERR;

	if (sizeof(struct CASE_DENTRY_T) != DENTRY_SIZE)
		return FFS_ALIGNMENTERR;

	if (sizeof(struct VOLM_DENTRY_T) != DENTRY_SIZE)
		return FFS_ALIGNMENTERR;
...
void fs_error(struct super_block *sb)
{
	...
	if (opts->errors == EXFAT_ERRORS_PANIC)
		...
		sb->s_flags |= MS_RDONLY;
		DPRINTK("[EXFAT] Filesystem has been set read-only\n");
	}
}
...
s32 fat_alloc_cluster(struct super_block *sb,
...
s32 exfat_alloc_cluster(struct super_block *sb,
	s32 num_alloc, struct CHAIN_T *p_chain)
{
	s32 num_clusters = 0;
	...
	struct CHAIN_T *p_chain, s32 do_relse)
{
	...
	if (p_chain->size <= 0) {
		DPRINTK("[EXFAT] free_cluster : skip free-req clu:%u,",
				p_chain->dir);
		DPRINTK("because of zero-size truncation\n");
		return;
	}
...
s32 load_alloc_bitmap(struct super_block *sb)
{
	...
	while (clu.dir != CLUSTER_32(~0)) {
		...
		for (i = 0; i < p_fs->dentries_per_clu; i++) {
			...
			type =
			p_fs->fs_func->get_entry_type((struct DENTRY_T *) ep);
			...
			if (ep->flags == 0x0) {
				...
				p_fs->map_sectors =
				((map_size-1) >> p_bd->sector_size_bits) + 1;

				p_fs->vol_amap =
				kmalloc(sizeof(struct buffer_head *) *
				p_fs->map_sectors, GFP_KERNEL);
...
s32 clr_alloc_bitmap(struct super_block *sb, u32 clu)
{
	...
	if (opts->discard) {
		...
		if (ret == -EOPNOTSUPP) {
			DPRINTK("discard not supported by device, disabling");
			opts->discard = 0;
		}
	}
#endif /* CONFIG_EXFAT_DISCARD */
 ...
 */
s32 __load_upcase_table(struct super_block *sb,
	u32 sector, u32 num_sectors, u32 utbl_checksum)
{
	int i, ret = FFS_ERROR;
	u32 j;
	struct FS_INFO_T *p_fs = &(EXFAT_SB(sb)->fs_info);
	...
	kmalloc(UTBL_COL_COUNT * sizeof(u16 *), GFP_KERNEL);
...
s32 load_upcase_table(struct super_block *sb)
{
	...
	while (clu.dir != CLUSTER_32(~0)) {
		for (i = 0; i < p_fs->dentries_per_clu; i++) {
			ep = (struct CASE_DENTRY_T *) get_entry_in_dir(sb,
					&clu, i, NULL);
			if (!ep)
				return FFS_MEDIAERR;
			...
			num_sectors = ((tbl_size-1) >>
				p_bd->sector_size_bits) + 1;
			if (__load_upcase_table(sb, sector,
				num_sectors, GET32_A(ep->checksum)) !=
				FFS_SUCCESS)
				break;
			else
				return FFS_SUCCESS;
...
s32 fat_init_dir_entry(struct super_block *sb,
	struct CHAIN_T *p_dir, s32 entry, u32 type, u32 start_clu, u64 size)
{
	u32 sector;
	struct DOS_DENTRY_T *dos_ep;

	dos_ep = (struct DOS_DENTRY_T *) get_entry_in_dir(sb,
			p_dir, entry, &sector);
	if (!dos_ep)
		return FFS_MEDIAERR;
...
s32 exfat_init_dir_entry(struct super_block *sb,
	struct CHAIN_T *p_dir, s32 entry, u32 type, u32 start_clu, u64 size)
{
	u32 sector;
	u8 flags;
	...
	/* we cannot use get_entry_set_in_dir here
	   because file ep is not initialized yet */
	file_ep = (struct FILE_DENTRY_T *) get_entry_in_dir(sb,
		p_dir, entry, &sector);
	if (!file_ep)
		return FFS_MEDIAERR;

	strm_ep = (struct STRM_DENTRY_T *) get_entry_in_dir(sb,
		p_dir, entry+1, &sector);
	if (!strm_ep)
		return FFS_MEDIAERR;
...
s32 fat_init_ext_entry(struct super_block *sb,
	struct CHAIN_T *p_dir, s32 entry, s32 num_entries,
...
s32 exfat_init_ext_entry(struct super_block *sb, struct CHAIN_T *p_dir,
		...
		struct UNI_NAME_T *p_uniname, struct DOS_NAME_T *p_dosname)
{
	...
	for (i = 2; i < num_entries; i++) {
		name_ep = (struct NAME_DENTRY_T *) get_entry_in_dir(sb,
				p_dir, entry+i, &sector);
		if (!name_ep)
			return FFS_MEDIAERR;
...
void init_strm_entry(struct STRM_DENTRY_T *ep,
	u8 flags, u32 start_clu, u64 size)
{
...
void update_dir_checksum(struct super_block *sb,
	struct CHAIN_T *p_dir, s32 entry)
{
	...
	for (i = 1; i < num_entries; i++) {
		...
		chksum = calc_checksum_2byte((void *) ep,
			DENTRY_SIZE, chksum, CS_DEFAULT);
	}
	...
	struct ENTRY_SET_CACHE_T *es)
{
	...
	for (i = 0; i < es->num_entries; i++) {
		...
		chksum = calc_checksum_2byte((void *) ep,
			DENTRY_SIZE, chksum, chksum_type);
		ep++;
...
static s32 _walk_fat_chain(struct super_block *sb,
	struct CHAIN_T *p_dir, s32 byte_offset, u32 *clu)
{
	struct FS_INFO_T *p_fs = &(EXFAT_SB(sb)->fs_info);
	s32 clu_offset;
	u32 cur_clu;
...
s32 find_location(struct super_block *sb,
	struct CHAIN_T *p_dir, s32 entry, u32 *sector, s32 *offset)
{
	s32 off, ret;
	u32 clu = 0;
	struct FS_INFO_T *p_fs = &(EXFAT_SB(sb)->fs_info);
...
struct DENTRY_T *get_entry_in_dir(struct super_block *sb,
	struct CHAIN_T *p_dir, s32 entry, u32 *sector)
{
	s32 off;
	u32 sec;
	u8 *buf;
 ...
 * Note that this is a copy (dump) of dentries
 * so that user should call write_entry_set()
...
struct ENTRY_SET_CACHE_T *get_entry_set_in_dir(struct super_block *sb,
	struct CHAIN_T *p_dir, s32 entry, u32 type, struct DENTRY_T **file_ep)
{
	...
	DPRINTK("trying to kmalloc %zx bytes for %d entries\n",
		offsetof(struct ENTRY_SET_CACHE_T, __buf) +
		(num_entries)  * sizeof(struct DENTRY_T), num_entries);
	es = kmalloc(offsetof(struct ENTRY_SET_CACHE_T, __buf) +
		(num_entries)  * sizeof(struct DENTRY_T), GFP_KERNEL);
	if (es == NULL)
		goto err_out;
	...
	DPRINTK("es sec %u offset %d flags %d, num_entries %u buf ptr %p\n",
		   es->sector, es->offset, es->alloc_flag,
...
static s32 __write_partial_entries_in_entry_set(struct super_block *sb,
	struct ENTRY_SET_CACHE_T *es, u32 sec, s32 off, u32 count)
{
	...
	while (num_entries) {
		...
		copy_entries = MIN(remaining_byte_in_sector >>
...
s32 find_empty_entry(struct inode *inode,
	struct CHAIN_T *p_dir, s32 num_entries)
{
	s32 ret, dentry;
	u32 last_clu, sector;
	...
	while ((dentry = search_deleted_or_unused_entry(sb,
		p_dir, num_entries)) < 0) {
		if (p_fs->dev_ejected)
			break;
	...
	struct DOS_NAME_T *p_dosname, u32 type)
{
	...
	if (p_dir->dir == p_fs->root_dir) {
		if ((!nls_uniname_cmp(sb, p_uniname->name,
			...
			(!nls_uniname_cmp(sb,
			p_uniname->name, (u16 *) UNI_PAR_DIR_NAME)))
			...
			if ((entry_type == TYPE_FILE) ||
				...
				if (ext_ep->order > 0x40) {
					...
					*(uniname+len) = 0x0;
					...
					if (nls_uniname_cmp(sb,
						uniname, entry_uniname))
...
/* returns -1 on error */
s32 fat_count_ext_entries(struct super_block *sb,
	struct CHAIN_T *p_dir, s32 entry, struct DENTRY_T *p_entry)
{
	s32 count = 0;
	u8 chksum;
	...
	for (entry--; entry >= 0; entry--) {
		...
		if ((p_fs->fs_func->get_entry_type(
...
/* returns -1 on error */
s32 exfat_count_ext_entries(struct super_block *sb,
	struct CHAIN_T *p_dir, s32 entry, struct DENTRY_T *p_entry)
{
	int i, count = 0;
	u32 type;
...
/* returns -1 on error */
s32 count_dos_name_entries(struct super_block *sb,
	struct CHAIN_T *p_dir, u32 type)
{
	int i, count = 0;
	s32 dentries_per_clu;
	u32 entry_type;
...
struct CHAIN_T *p_dir, struct UNI_NAME_T *p_uniname,
	s32 *entries, struct DOS_NAME_T *p_dosname)
{
...
void get_uni_name_from_dos_entry(struct super_block *sb,
	struct DOS_DENTRY_T *ep, struct UNI_NAME_T *p_uniname, u8 mode)
{
	struct DOS_NAME_T dos_name;
...
void fat_get_uni_name_from_ext_entry(struct super_block *sb,
	struct CHAIN_T *p_dir, s32 entry, u16 *uniname)
{
	int i;
	...
	for (entry--, i = 1; entry >= 0; entry--, i++) {
		ep = (struct EXT_DENTRY_T *) get_entry_in_dir(sb,
			p_dir, entry, NULL);
		if (!ep)
			return;
	...
	*/
	for (i = 2; i < es->num_entries; i++, ep++) {
		if (p_fs->fs_func->get_entry_type(ep) == TYPE_EXTEND)
			extract_uni_name_from_name_entry(
			(struct NAME_DENTRY_T *)ep,	uniname, i);
		else
			goto out;
		uniname += 15;
	}
...
s32 fat_generate_dos_name(struct super_block *sb,
	struct CHAIN_T *p_dir, struct DOS_NAME_T *p_dosname)
{
	...
	while (clu.dir != CLUSTER_32(~0)) {
		...
		for (i = 0; i < dentries_per_clu; i++) {
			ep = (struct DOS_DENTRY_T *) get_entry_in_dir(sb,
				&clu, i, NULL);
			if (!ep)
				return FFS_MEDIAERR;

			type = p_fs->fs_func->get_entry_type(
				(struct DENTRY_T *) ep);
 ...
 *  File Operation Functions
 */
static struct FS_FUNC_T fat_fs_func = {
...
static struct FS_FUNC_T exfat_fs_func = {
		...
		struct UNI_NAME_T *p_uniname, struct FILE_ID_T *fid)
{
	...
	ret = get_num_entries_and_dos_name(sb,
			p_dir, p_uniname, &num_entries, &dos_name);
	if (ret)
		return ret;
	...
	if (p_fs->vol_type == EXFAT) {
		...
		ret = p_fs->fs_func->init_dir_entry(sb,
			&clu, 0, TYPE_DIR, clu.dir, 0);
		if (ret != FFS_SUCCESS)
			return ret;

		ret = p_fs->fs_func->init_ext_entry(sb,
			&clu, 0, 1, NULL, &dot_name);
		if (ret != FFS_SUCCESS)
			return ret;
		...
		if (p_dir->dir == p_fs->root_dir)
			ret = p_fs->fs_func->init_dir_entry(sb,
					&clu, 1, TYPE_DIR, CLUSTER_32(0), 0);
		else
			ret = p_fs->fs_func->init_dir_entry(sb,
					&clu, 1, TYPE_DIR, p_dir->dir, 0);

		if (ret != FFS_SUCCESS)
			return ret;

		ret = p_fs->fs_func->init_ext_entry(sb,
				&clu, 1, 1, NULL, &dot_name);
		if (ret != FFS_SUCCESS)
			return ret;
	}
	...
	ret = p_fs->fs_func->init_dir_entry(sb,
		p_dir, dentry, TYPE_DIR, clu.dir, size);
	if (ret != FFS_SUCCESS)
		return ret;

	ret = p_fs->fs_func->init_ext_entry(sb, p_dir,
			dentry, num_entries, p_uniname, &dos_name);
	if (ret != FFS_SUCCESS)
		return ret;
		...
		struct UNI_NAME_T *p_uniname, u8 mode, struct FILE_ID_T *fid)
{
	...
	ret = get_num_entries_and_dos_name(sb, p_dir,
			p_uniname, &num_entries, &dos_name);
	if (ret)
		return ret;
	...
	ret = p_fs->fs_func->init_dir_entry(sb, p_dir,
			dentry, TYPE_FILE | mode, CLUSTER_32(0), 0);
	if (ret != FFS_SUCCESS)
		return ret;
...
s32 rename_file(struct inode *inode,
	struct CHAIN_T *p_dir, s32 oldentry,
	struct UNI_NAME_T *p_uniname, struct FILE_ID_T *fid)
{
	...
	/* buf_lock() before call count_ext_entries() */
	num_old_entries = p_fs->fs_func->count_ext_entries(sb,
			p_dir, oldentry, epold);
	...
	ret = get_num_entries_and_dos_name(sb, p_dir,
			p_uniname, &num_new_entries, &dos_name);
	if (ret) {
		buf_unlock(sb, sector_old);
		return ret;
	}
	...
	if (num_old_entries < num_new_entries) {
		...
		if (p_fs->vol_type == EXFAT) {
			epold = get_entry_in_dir(sb,
				p_dir, oldentry+1, &sector_old);
			buf_lock(sb, sector_old);
			epnew = get_entry_in_dir(sb,
				p_dir, newentry+1, &sector_new);
		...
		ret = p_fs->fs_func->init_ext_entry(sb,
			p_dir, newentry, num_new_entries,
			p_uniname, &dos_name);
		if (ret != FFS_SUCCESS)
			return ret;

		p_fs->fs_func->delete_dir_entry(sb, p_dir,
				oldentry, 0, num_old_entries);
		fid->entry = newentry;
	} else {
		if (p_fs->fs_func->get_entry_type(epold) == TYPE_FILE) {
			p_fs->fs_func->set_entry_attr(epold,
			p_fs->fs_func->get_entry_attr(epold) | ATTR_ARCHIVE);
			fid->attr |= ATTR_ARCHIVE;
		}
		...
		ret = p_fs->fs_func->init_ext_entry(sb,
			p_dir, oldentry, num_new_entries,
			p_uniname, &dos_name);
		if (ret != FFS_SUCCESS)
			return ret;

		p_fs->fs_func->delete_dir_entry(sb,
			p_dir, oldentry,
	...
	struct UNI_NAME_T *p_uniname, struct FILE_ID_T *fid)
{
	...
	epmov = get_entry_in_dir(sb, p_olddir,
		oldentry, &sector_mov);
	if (!epmov)
		return FFS_MEDIAERR;
	...
	ret = get_num_entries_and_dos_name(sb, p_newdir,
			p_uniname, &num_new_entries, &dos_name);
	if (ret) {
		buf_unlock(sb, sector_mov);
		return ret;
	...
	ret = p_fs->fs_func->init_ext_entry(sb, p_newdir,
			newentry, num_new_entries, p_uniname, &dos_name);
	if (ret != FFS_SUCCESS)
		return ret;

	p_fs->fs_func->delete_dir_entry(sb,
		p_olddir, oldentry, 0, num_old_entries);
...
s32 sector_read(struct super_block *sb,
u32 sec, struct buffer_head **bh, s32 read)
{
	...
	if ((sec >= (p_fs->PBR_sector+p_fs->num_sectors)) &&
		(p_fs->num_sectors > 0)) {
		DPRINTK("[EXFAT] sector_read:");
		DPRINTK("out of range error! (sec = %d)\n", sec);
		fs_error(sb);
		return ret;
	}
...
s32 sector_write(struct super_block *sb,
	u32 sec, struct buffer_head *bh, s32 sync)
{
	s32 ret = FFS_MEDIAERR;
	struct FS_INFO_T *p_fs = &(EXFAT_SB(sb)->fs_info);
	...
	if (bh == NULL) {
		DPRINTK("[EXFAT] sector_write: bh is NULL!\n");
		fs_error(sb);
		return ret;
	}
...
s32 multi_sector_read(struct super_block *sb,
u32 sec, struct buffer_head **bh, s32 num_secs, s32 read)
{
	s32 ret = FFS_MEDIAERR;
	struct FS_INFO_T *p_fs = &(EXFAT_SB(sb)->fs_info);
	...
	if (((sec+num_secs) > (p_fs->PBR_sector+p_fs->num_sectors)) &&
		(p_fs->num_sectors > 0)) {
		DPRINTK("[EXFAT] multi_sector_read: out of range error!");
		DPRINTK("(sec = %d, num_secs = %d)\n", sec, num_secs);
		fs_error(sb);
		return ret;
	}
...
s32 multi_sector_write(struct super_block *sb,
u32 sec, struct buffer_head *bh, s32 num_secs, s32 sync)
{
	s32 ret = FFS_MEDIAERR;
	struct FS_INFO_T *p_fs = &(EXFAT_SB(sb)->fs_info);
	...
	if ((sec+num_secs) > (p_fs->PBR_sector+p_fs->num_sectors) &&
		(p_fs->num_sectors > 0)) {
		DPRINTK("[EXFAT] multi_sector_write: out of range error!");
		DPRINTK("(sec = %d, num_secs = %d)\n", sec, num_secs);
		fs_error(sb);
		return ret;
	}
	if (bh == NULL) {
		DPRINTK("[EXFAT] multi_sector_write: bh is NULL!\n");
		fs_error(sb);
		return ret;
	}

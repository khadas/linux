...
struct DOS_NAME_T *p_dosname, struct UNI_NAME_T *p_uniname, s32 *p_lossy);
void   nls_dosname_to_uniname(struct super_block *sb,
struct UNI_NAME_T *p_uniname, struct DOS_NAME_T *p_dosname);
void   nls_uniname_to_cstring(struct super_block *sb,
	u8 *p_cstring, struct UNI_NAME_T *p_uniname);
void   nls_cstring_to_uniname(struct super_block *sb,
struct UNI_NAME_T *p_uniname, u8 *p_cstring, s32 *p_lossy);

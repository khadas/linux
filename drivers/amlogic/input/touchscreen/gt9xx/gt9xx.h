...
#define CTP_CFG_GROUP0 {\
	0x00,0x80,0x07,0xB0,0x04,0x0A,0x0D,0x00,0x01,0x08,0x28,\
	0x05,0x50,0x32,0x03,0x05,0x00,0x00,0x00,0x00,0x00,0x00,\
	0x00,0x00,0x00,0x00,0x00,0x90,0x30,0xAA,0x17,0x15,0x31,\
	0x0D,0x00,0x00,0x01,0x99,0x04,0x24,0x00,0x00,0x00,0x00,\
	...
	0x22,0x23,0x24,0x25,0x26,0x27,0x28,0x29,0x2A,0xFF,0xFF,\
	0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0x4D,0x01\
    }
...
// Log define
#define GTP_INFO(fmt,arg...)           printk("<<-GT9XX-INFO->> "fmt"\n",##arg)
#define GTP_ERROR(fmt,arg...)          printk("<<-GT9XX-ERROR->> "fmt"\n",##arg)
#define GTP_DEBUG(fmt,arg...)          do{\
                                         if(GTP_DEBUG_ON)\
                                         printk("<<-GT9XX-DEBUG->> [%d]"fmt"\n",__LINE__, ##arg);\
                                       }while(0)
...
#define GTP_DEBUG_FUNC()               do{\
                                         ...
                                         printk("<<-GT9XX-FUNC->> Func:%s@Line:%d\n",__func__,__LINE__);\
                                       }while(0)

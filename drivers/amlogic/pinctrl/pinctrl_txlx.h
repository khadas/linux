...
#ifndef __AMLOGIC_PINCTRL_TXLX_H
#define __AMLOGIC_PINCTRL_TXLX_H

#include <dt-bindings/gpio/txlx.h>

#define PIN_AO_BASE		(0)
#define PIN_AO_SIZE		(14)
#define PIN_EE_BASE		(PIN_AO_BASE + PIN_AO_SIZE)
#define PIN_EE_SIZE		(107)
...
#define	PIN_GPIOH_10		PIN_EE(GPIOH_10)
...
/* pin gpioc [5-0] */
#define PIN_GPIOC_BASE		(PIN_BOOT_BASE + PIN_BOOT_SIZE)
#define PIN_GPIOC_SIZE		(6)

#define	PIN_GPIOC_0		PIN_EE(GPIOC_0)
#define	PIN_GPIOC_1		PIN_EE(GPIOC_1)
#define	PIN_GPIOC_2		PIN_EE(GPIOC_2)
#define	PIN_GPIOC_3		PIN_EE(GPIOC_3)
#define	PIN_GPIOC_4		PIN_EE(GPIOC_4)
#define	PIN_GPIOC_5		PIN_EE(GPIOC_5)

/* pin gpiodv [10-0] */
#define PIN_GPIODV_BASE		(PIN_GPIOC_BASE + PIN_GPIOC_SIZE)
#define PIN_GPIODV_SIZE		(11)
...
/* pin gpioy [27-0] */
#define	PIN_GPIOY_BASE		(PIN_GPIOW_BASE + PIN_GPIOW_SIZE)
#define	PIN_GPIOY_SIZE		(28)

#define	PIN_GPIOY_0		PIN_EE(GPIOY_0)
#define	PIN_GPIOY_1		PIN_EE(GPIOY_1)
#define	PIN_GPIOY_2		PIN_EE(GPIOY_2)
#define	PIN_GPIOY_3		PIN_EE(GPIOY_3)
#define	PIN_GPIOY_4		PIN_EE(GPIOY_4)
#define	PIN_GPIOY_5		PIN_EE(GPIOY_5)
#define	PIN_GPIOY_6		PIN_EE(GPIOY_6)
#define	PIN_GPIOY_7		PIN_EE(GPIOY_7)
#define	PIN_GPIOY_8		PIN_EE(GPIOY_8)
#define	PIN_GPIOY_9		PIN_EE(GPIOY_9)
#define	PIN_GPIOY_10		PIN_EE(GPIOY_10)
#define	PIN_GPIOY_11		PIN_EE(GPIOY_11)
#define	PIN_GPIOY_12		PIN_EE(GPIOY_12)
#define	PIN_GPIOY_13		PIN_EE(GPIOY_13)
#define	PIN_GPIOY_14		PIN_EE(GPIOY_14)
#define	PIN_GPIOY_15		PIN_EE(GPIOY_15)
#define	PIN_GPIOY_16		PIN_EE(GPIOY_16)
#define	PIN_GPIOY_17		PIN_EE(GPIOY_17)
#define	PIN_GPIOY_18		PIN_EE(GPIOY_18)
#define	PIN_GPIOY_19		PIN_EE(GPIOY_19)
#define	PIN_GPIOY_20		PIN_EE(GPIOY_20)
#define	PIN_GPIOY_21		PIN_EE(GPIOY_21)
#define	PIN_GPIOY_22		PIN_EE(GPIOY_22)
#define	PIN_GPIOY_23		PIN_EE(GPIOY_23)
#define	PIN_GPIOY_24		PIN_EE(GPIOY_24)
#define	PIN_GPIOY_25		PIN_EE(GPIOY_25)
#define	PIN_GPIOY_26		PIN_EE(GPIOY_26)
#define	PIN_GPIOY_27		PIN_EE(GPIOY_27)

/* pin test_n */
#define PIN_GPIO_TEST_N_BASE	(PIN_GPIOY_BASE + PIN_GPIOY_SIZE)
...
#define GPIO_W_D_REG1			GPIO_D_REG1
#define GPIO_W_O_REG1			GPIO_O_REG1
#define GPIO_W_I_REG1			GPIO_I_REG1
#define GPIO_W_REG4_BIT0		0

#define GPIO_C_D_REG2			GPIO_D_REG2
#define GPIO_C_O_REG2			GPIO_O_REG2
#define GPIO_C_I_REG2			GPIO_I_REG2
#define GPIO_C_REG2_BIT20		20
...
#define GPIO_Y_D_REG4			GPIO_D_REG4
#define GPIO_Y_O_REG4			GPIO_O_REG4
#define GPIO_Y_I_REG4			GPIO_I_REG4
#define GPIO_Y_REG3_BIT0		0



#define PMX_FUNCTION_NUM	(7)

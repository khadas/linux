...
static unsigned int gpio_to_pin[][6] = {
	...
	[PIN_GPIOX_8] = {PK(5, 23), PK(5, 13), PK(5, 3), PK(6, 3), NE, NE,},
	[PIN_GPIOX_9] = {PK(5, 22), PK(5, 12), PK(5, 2), PK(6, 2), NE, NE,},
	[PIN_GPIOX_10] = {PK(5, 21), PK(5, 11), PK(5, 5), PK(5, 1), PK(6, 1),
			NE,},
	[PIN_GPIOX_11] = {PK(5, 20), PK(5, 10), PK(5, 4), PK(5, 0), PK(6, 0),
			NE,},

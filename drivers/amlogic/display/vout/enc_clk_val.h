...
static struct enc_clk_val_s setting_enc_clk_val_m8m2[] = {
	...
	{VMODE_480P_59HZ,  2161, 8, 1, VIU_ENCP, 5,  4, 2,  1, -1, 1,},
#endif
	...
	{VMODE_720P_59HZ,  2975, 4, 2, VIU_ENCP, 10, 1, 2,  1, -1, 1,},
#endif
	{VMODE_1080I,      2970, 4, 2, VIU_ENCP, 10, 1, 2,  1, -1, 1,},
#ifdef CONFIG_AML_VOUT_FRAMERATE_AUTOMATION
	{VMODE_1080I_59HZ, 2975, 4, 2, VIU_ENCP, 10, 1, 2,  1, -1, 1,},
#endif
	{VMODE_1080P,      2970, 2, 2, VIU_ENCP, 10, 1, 1,  1, -1, 1,},
	{VMODE_1080P,      2970, 2, 2, VIU_ENCP, 10, 1, 1,  1, -1, 1,},
#ifdef CONFIG_AML_VOUT_FRAMERATE_AUTOMATION
	/* 2975 for hpll: vco2970 * 0.999 */
	{VMODE_1080P_59HZ, 2975, 2, 2, VIU_ENCP, 10, 1, 1,  1, -1, 1,},
#endif
...
#ifdef CONFIG_AML_VOUT_FRAMERATE_AUTOMATION
	{VMODE_480P_59HZ,  1081, 4, 1, VIU_ENCP,  5, 4, 2,  1, -1, 1,},
#endif
	{VMODE_480P_RPT,   2160, 2, 1, VIU_ENCP,  5, 4, 1,  2, -1, 1,},

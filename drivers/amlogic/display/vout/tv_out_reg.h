/*
 * drivers/amlogic/display/vout/tv_out_reg.h
 *
...
#ifndef __TV_OUT_REG_H__
#define __TV_OUT_REG_H__
 ...
 * ********************************* */
/* base & offset */
#define TV_OUT_REG_BASE_CBUS                       (0xc1100000L)
#define TV_OUT_REG_BASE_HIU                        (0xc883c000L)
#define TV_OUT_REG_BASE_VCBUS                      (0xd0100000L)
#define TV_OUT_REG_OFFSET_CBUS(reg)                ((reg << 2))
#define TV_OUT_REG_OFFSET_HIU(reg)                 ((reg << 2))
#define TV_OUT_REG_OFFSET_VCBUS(reg)               ((reg << 2))
...
#else
#define TV_OUT_HIU_REG_GX(addr)                    (addr & 0xff)
#endif
...
extern int tv_out_ioremap(void);
extern unsigned int tv_out_reg_read(unsigned int _reg);
extern void tv_out_reg_write(unsigned int _reg, unsigned int _value);
extern void tv_out_reg_setb(unsigned int reg, unsigned int value,
		unsigned int _start, unsigned int _len);
extern unsigned int tv_out_reg_getb(unsigned int reg,
		unsigned int _start, unsigned int _len);
extern void tv_out_reg_set_mask(unsigned int reg, unsigned int _mask);
extern void tv_out_reg_clr_mask(unsigned int reg, unsigned int _mask);

extern unsigned int tv_out_hiu_read(unsigned int _reg);
extern void tv_out_hiu_write(unsigned int _reg, unsigned int _value);
extern void tv_out_hiu_setb(unsigned int _reg, unsigned int _value,
		unsigned int _start, unsigned int _len);
extern unsigned int tv_out_hiu_getb(unsigned int _reg,
		unsigned int _start, unsigned int _len);
extern void tv_out_hiu_set_mask(unsigned int _reg, unsigned int _mask);
extern void tv_out_hiu_clr_mask(unsigned int _reg, unsigned int _mask);

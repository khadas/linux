...
extern void set_mipi_dsi_control_config(struct Lcd_Config_s *pConf);
extern void set_mipi_dsi_control_config_post(struct Lcd_Config_s *pConf);
extern void mipi_dsi_link_on(struct Lcd_Config_s *pConf);

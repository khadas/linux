/*
 * drivers/amlogic/display/ge2d/ge2dgen.h
 *
...
void ge2dgen_post_release_src1buf(struct ge2d_context_s *wq, unsigned buffer);

void ge2dgen_post_release_src1canvas(struct ge2d_context_s *wq);

void ge2dgen_post_release_src2buf(struct ge2d_context_s *wq, unsigned buffer);
...
void ge2dgen_src2(struct ge2d_context_s *wq,
		unsigned canvas_addr, unsigned format);
...
void ge2dgen_cb(struct ge2d_context_s *wq,
		int (*cmd_cb)(unsigned), unsigned param);

void ge2dgen_const_color(struct ge2d_context_s *wq, unsigned color);

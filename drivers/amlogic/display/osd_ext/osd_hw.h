...
extern void osd_ext_set_free_scale_width_hw(u32 index, u32 width);
extern void osd_ext_get_free_scale_width_hw(u32 index, u32 *free_scale_width);
extern void osd_ext_set_free_scale_height_hw(u32 index, u32 height);
...
extern void osd_ext_get_info_hw(u32 index, s32(*posdval)[4], u32(*posdreq)[5],
				s32 info_flag);

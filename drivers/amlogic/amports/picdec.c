...
static int render_frame(ge2d_context_t *context,
...
int fill_color(struct vframe_s *vf, ge2d_context_t *context,
			   config_para_ex_t *ge2d_config)
{
...
int picdec_fill_buffer(struct vframe_s *vf, ge2d_context_t *context,
					   config_para_ex_t *ge2d_config)
{

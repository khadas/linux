...
/* 182.14M <-- (2550/7)/2 */
#define VDEC1_182M() \
	WRITE_MPEG_REG_BITS(HHI_VDEC_CLK_CNTL,  (3 << 9) | (1), 0, 16)
#define VDEC2_182M() \
	WRITE_MPEG_REG(HHI_VDEC2_CLK_CNTL, (3 << 9) | (1))

/* 212.50M <-- (2550/3)/4 */
#define VDEC1_212M() \
	WRITE_MPEG_REG_BITS(HHI_VDEC_CLK_CNTL,  (1 << 9) | (3), 0, 16)
#define VDEC2_212M() \
	WRITE_MPEG_REG(HHI_VDEC2_CLK_CNTL, (1 << 9) | (3))

/* 255.00M <-- (2550/5)/2 */
#define VDEC1_255M() \
	WRITE_MPEG_REG_BITS(HHI_VDEC_CLK_CNTL,  (2 << 9) | (1), 0, 16)
#define VDEC2_255M() \
	WRITE_MPEG_REG(HHI_VDEC2_CLK_CNTL, (2 << 9) | (1))
#define HCODEC_255M() \
	WRITE_MPEG_REG_BITS(HHI_VDEC_CLK_CNTL, (2 << 9) | (1), 16, 16)
#define HEVC_255M()  \
	WRITE_MPEG_REG_BITS(HHI_VDEC2_CLK_CNTL, (2 << 9) | (1), 16, 16)

/* 283.33M <-- (2550/3)/3 */
#define VDEC1_283M() \
	WRITE_MPEG_REG_BITS(HHI_VDEC_CLK_CNTL,  (1 << 9) | (2), 0, 16)
#define VDEC2_283M() \
	WRITE_MPEG_REG(HHI_VDEC2_CLK_CNTL, (1 << 9) | (2));

/* 318.75M <-- (2550/4)/2 */
#define VDEC1_319M() \
	WRITE_MPEG_REG_BITS(HHI_VDEC_CLK_CNTL,  (0 << 9) | (1), 0, 16)
#define VDEC2_319M() \
	WRITE_MPEG_REG(HHI_VDEC2_CLK_CNTL, (0 << 9) | (1))

/* 364.29M <-- (2550/7)/1 -- over limit, do not use */
#define VDEC1_364M() \
	WRITE_MPEG_REG_BITS(HHI_VDEC_CLK_CNTL,  (3 << 9) | (0), 0, 16)
#define VDEC2_364M() \
	WRITE_MPEG_REG(HHI_VDEC2_CLK_CNTL, (3 << 9) | (0))
...
/* 510.00M <-- (2550/5)/1 */
#define VDEC1_510M() \
	WRITE_MPEG_REG_BITS(HHI_VDEC_CLK_CNTL,  (2 << 9) | (0), 0, 16)
#define HEVC_510M()  \
	WRITE_MPEG_REG_BITS(HHI_VDEC2_CLK_CNTL, (2 << 9) | (0), 16, 16)

/* 637.50M <-- (2550/4)/1 */
#define VDEC1_638M() \
	WRITE_MPEG_REG_BITS(HHI_VDEC_CLK_CNTL,  (0 << 9) | (0), 0, 16)
#define HEVC_638M()  \
	WRITE_MPEG_REG_BITS(HHI_VDEC2_CLK_CNTL, (0 << 9) | (0), 16, 16)
...
#define VDEC2_CLOCK_ON()   do {\
		WRITE_MPEG_REG_BITS(HHI_VDEC2_CLK_CNTL, 1, 8, 1); \
		WRITE_VREG(DOS_GCLK_EN1, 0x3ff);\
	} while (0)

#define HCODEC_CLOCK_ON()  do {\
		WRITE_MPEG_REG_BITS(HHI_VDEC_CLK_CNTL, 1, 24, 1); \
...
#define VDEC1_SAFE_CLOCK() do {\
	WRITE_MPEG_REG_BITS(HHI_VDEC3_CLK_CNTL, \
...
#define VDEC1_CLOCK_OFF()  \
	WRITE_MPEG_REG_BITS(HHI_VDEC_CLK_CNTL,  0, 8, 1)
#define VDEC2_CLOCK_OFF()  \
	WRITE_MPEG_REG_BITS(HHI_VDEC2_CLK_CNTL, 0, 8, 1)
#define HCODEC_CLOCK_OFF() \
	WRITE_MPEG_REG_BITS(HHI_VDEC_CLK_CNTL, 0, 24, 1)
#define HEVC_SAFE_CLOCK()  do { \
	WRITE_MPEG_REG_BITS(HHI_VDEC2_CLK_CNTL, \
		(READ_MPEG_REG(HHI_VDEC2_CLK_CNTL) >> 16) & 0x7f, 16, 7); \
	WRITE_MPEG_REG_BITS(HHI_VDEC2_CLK_CNTL, 1, 24, 1); \
...
#define CLK_FOR_CPU {MESON_CPU_MAJOR_ID_M8, MESON_CPU_MAJOR_ID_M8M2, 0}
#include "clk.h"
ARCH_VDEC_CLK_INIT();

/*
 * drivers/amlogic/ionvideo/videobuf2-ion.c
 *
...
const struct vb2_mem_ops vb2_ion_memops = {
	.alloc = vb2_ion_alloc, .put = vb2_ion_put, .get_userptr =
		vb2_ion_get_userptr, .put_userptr = vb2_ion_put_userptr,
	.map_dmabuf = vb2_ion_map_dmabuf, .unmap_dmabuf = vb2_ion_unmap_dmabuf,
	.attach_dmabuf = vb2_ion_attach_dmabuf, .detach_dmabuf =
		vb2_ion_detach_dmabuf, .vaddr = vb2_ion_vaddr, .mmap =
		vb2_ion_mmap, .num_users = vb2_ion_num_users, .cookie =
		vb2_ion_cookie, };

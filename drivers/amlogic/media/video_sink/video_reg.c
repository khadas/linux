...
struct hw_vd_reg_s vd_mif_reg_a4_array[MAX_VD_LAYER_C3] = {
	{
		A4_VOUT_VD1_GEN_REG,
		A4_VOUT_VD1_CANVAS0,
		A4_VOUT_VD1_EMPTY_REG,
		A4_VOUT_VD1_LUMA_X0,
		A4_VOUT_VD1_LUMA_Y0,
		A4_VOUT_VD1_CHROMA_X0,
		A4_VOUT_VD1_CHROMA_Y0,
		A4_VOUT_VD1_EMPTY_REG,
		A4_VOUT_VD1_EMPTY_REG,
		A4_VOUT_VD1_EMPTY_REG,
		A4_VOUT_VD1_EMPTY_REG,
		A4_VOUT_VD1_RPT_LOOP,
		A4_VOUT_VD1_LUMA0_RPT_PAT,
		A4_VOUT_VD1_CHROMA0_RPT_PAT,
		A4_VOUT_VD1_EMPTY_REG,
		A4_VOUT_VD1_EMPTY_REG,
		A4_VOUT_VD1_EMPTY_REG,
		A4_VOUT_VD1_EMPTY_REG,
		A4_VOUT_VD1_LUMA_FIFO_SIZE,
		A4_VOUT_VD1_GEN_REG2,
		A4_VOUT_VD1_GEN_REG3,
		A4_VOUT_VD1_CFMT_CTRL,
		A4_VOUT_VD1_CFMT_W,
	}
};
...
struct hw_vd_linear_reg_s vd_mif_linear_reg_a4_array[MAX_VD_LAYER_C3] = {
	{
		A4_VOUT_VD1_BADDR_Y,
		A4_VOUT_VD1_BADDR_CB,
		A4_VOUT_VD1_BADDR_CR,
		A4_VOUT_VD1_STRIDE_0,
		A4_VOUT_VD1_STRIDE_1,
		A4_VOUT_VD1_BADDR_Y_F1,
		A4_VOUT_VD1_BADDR_CB_F1,
		A4_VOUT_VD1_BADDR_CR_F1,
		A4_VOUT_VD1_STRIDE_0_F1,
		A4_VOUT_VD1_STRIDE_1_F1,
	}
};
...
struct hw_pps_reg_s pps_reg_a4_array[MAX_VD_LAYER_C3] = {
	{
		A4_VOUT_VD1_SCALE_COEF_IDX,
		A4_VOUT_VD1_SCALE_COEF,
		A4_VOUT_VD1_VSC_REGION12_STARTP,
		A4_VOUT_VD1_VSC_REGION34_STARTP,
		A4_VOUT_VD1_VSC_REGION4_ENDP,
		A4_VOUT_VD1_VSC_START_PHASE_STEP,
		A4_VOUT_VD1_VSC_REGION1_PHASE_SLOPE,
		A4_VOUT_VD1_VSC_REGION3_PHASE_SLOPE,
		A4_VOUT_VD1_VSC_PHASE_CTRL,
		A4_VOUT_VD1_VSC_INI_PHASE,
		A4_VOUT_VD1_HSC_REGION12_STARTP,
		A4_VOUT_VD1_HSC_REGION34_STARTP,
		A4_VOUT_VD1_HSC_REGION4_ENDP,
		A4_VOUT_VD1_HSC_START_PHASE_STEP,
		A4_VOUT_VD1_HSC_REGION1_PHASE_SLOPE,
		A4_VOUT_VD1_HSC_REGION3_PHASE_SLOPE,
		A4_VOUT_VD1_HSC_PHASE_CTRL,
		A4_VOUT_VD1_SC_MISC,
		A4_VOUT_VD1_HSC_PHASE_CTRL1,
		A4_VOUT_VD1_PREHSC_COEF,
		A4_VOUT_VD1_PRE_SCALE_CTRL,
		A4_VOUT_VD1_PREVSC_COEF,
		A4_VOUT_VD1_PREHSC_COEF1,
	}
};
...
struct hw_vd_csc_reg_s vd_csc_c3_reg[MAX_VD_LAYER_C3] = {
	{
		...
		VOUT_VD1_CSC_COEF22,
		VOUT_VD1_CSC_COEF13_14,
		VOUT_VD1_CSC_COEF23_24,
		VOUT_VD1_CSC_COEF15_25,
		VOUT_VD1_CSC_CLIP,
		VOUT_VD1_CSC_OFFSET0_1,
		VOUT_VD1_CSC_OFFSET2,
		VOUT_VD1_CSC_PRE_OFFSET0_1,
		VOUT_VD1_CSC_PRE_OFFSET2,
		VOUT_VD1_CSC_EN_CTRL
	}
};

struct hw_vd_csc_reg_s vd_csc_a4_reg[MAX_VD_LAYER_C3] = {
	{
		A4_VOUT_VD1_CSC_COEF00_01,
		A4_VOUT_VD1_CSC_COEF02_10,
		A4_VOUT_VD1_CSC_COEF11_12,
		A4_VOUT_VD1_CSC_COEF20_21,
		A4_VOUT_VD1_CSC_COEF22,
		A4_VOUT_VD1_CSC_COEF13_14,
		A4_VOUT_VD1_CSC_COEF23_24,
		A4_VOUT_VD1_CSC_COEF15_25,
		A4_VOUT_VD1_CSC_CLIP,
		A4_VOUT_VD1_CSC_OFFSET0_1,
		A4_VOUT_VD1_CSC_OFFSET2,
		A4_VOUT_VD1_CSC_PRE_OFFSET0_1,
		A4_VOUT_VD1_CSC_PRE_OFFSET2,
		A4_VOUT_VD1_CSC_EN_CTRL
	}
};

struct hw_vout_blend_reg_s vout_blend_c3_reg = {
	VPU_VOUT_BLEND_CTRL,
...
struct hw_vout_blend_reg_s vout_blend_a4_reg = {

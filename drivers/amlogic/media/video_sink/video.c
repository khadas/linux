...
static void primary_swap_frame(struct vframe_s *vf, int line)
{
...
static void pip_vf_unreg_provider(void)
{
	...
	pr_info("%s: vd1 used: %s, vd2 used: %s, keep_ret:%d, black_out:%d, cur_pipbuf:%p\n",
		__func__,
		layer1_used ? "true" : "false",
		layer2_used ? "true" : "false",
...
static struct amvideo_device_data_s amvideo_tm2_revb = {
	.cpu_type = MESON_CPU_MAJOR_ID_TM2_REVB_,
	.hscaler_8tap_en = 0,
	.pre_hscaler_ntap_en = 0,
};

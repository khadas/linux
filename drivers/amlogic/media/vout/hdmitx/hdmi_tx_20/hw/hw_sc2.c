...
void set_sc2_hpll_clk_out(unsigned int frac_rate, unsigned int clk)
{
	...
	case 4032000:
		...
		break;
	case 252000:
                hd_write_reg(P_ANACTRL_HDMIPLL_CTRL0, 0x3b0004A8);//480X320
                if (frac_rate)
                ...
                break;
        case 251750:
                hd_write_reg(P_ANACTRL_HDMIPLL_CTRL0, 0x3b0004a7);//640x480
                if (frac_rate)
                        hd_write_reg(P_ANACTRL_HDMIPLL_CTRL1, 0x0001ffff);
                else
                        hd_write_reg(P_ANACTRL_HDMIPLL_CTRL1, 0x00018000);
        ...
        case 292300:
                ...
                break;
        case 400000:
                hd_write_reg(P_ANACTRL_HDMIPLL_CTRL0, 0x3b000485);//800x600
                if (frac_rate)
                        hd_write_reg(P_ANACTRL_HDMIPLL_CTRL1, 0x0001ffff);
                else
                        hd_write_reg(P_ANACTRL_HDMIPLL_CTRL1, 0x00018000);
        ...
        case 445800:
                ...
                break;
        case 6500000:
                hd_write_reg(P_ANACTRL_HDMIPLL_CTRL0, 0x3b0004d8);//1024x768
                if (frac_rate)
                        hd_write_reg(P_ANACTRL_HDMIPLL_CTRL1, 0x0001ffff);
                else
                        hd_write_reg(P_ANACTRL_HDMIPLL_CTRL1, 0x00018000);
                ...
                break;
        case 432000:
                hd_write_reg(P_ANACTRL_HDMIPLL_CTRL0, 0x3b000490);//1280x480
                if (frac_rate)
                        hd_write_reg(P_ANACTRL_HDMIPLL_CTRL1, 0x0001ffff);
                else
                        hd_write_reg(P_ANACTRL_HDMIPLL_CTRL1, 0x00018000);
                ...
                break;
        case 835000:
                hd_write_reg(P_ANACTRL_HDMIPLL_CTRL0, 0x3b00048B);//1280x800
                if (frac_rate)
                        hd_write_reg(P_ANACTRL_HDMIPLL_CTRL1, 0x0001554c);
                else
                        hd_write_reg(P_ANACTRL_HDMIPLL_CTRL1, 0x00018000);
                hd_write_reg(P_ANACTRL_HDMIPLL_CTRL2, 0x00000000);
                hd_write_reg(P_ANACTRL_HDMIPLL_CTRL3, 0x0a691c00);
                ...
                break;
        case 1080000:
                hd_write_reg(P_ANACTRL_HDMIPLL_CTRL0, 0x3b0004b3);//1280x1024
                if (frac_rate)
                        hd_write_reg(P_ANACTRL_HDMIPLL_CTRL1, 0x0001ffff);
                else
                        hd_write_reg(P_ANACTRL_HDMIPLL_CTRL1, 0x00018000);
                ...
                break;
        case 855000:
                hd_write_reg(P_ANACTRL_HDMIPLL_CTRL0, 0x3b00048E);//1360x768
                if (frac_rate)
                        hd_write_reg(P_ANACTRL_HDMIPLL_CTRL1, 0x0001ffff);
                else
                        hd_write_reg(P_ANACTRL_HDMIPLL_CTRL1, 0x00018000);
                ...
                break;
        case 1065000:
                hd_write_reg(P_ANACTRL_HDMIPLL_CTRL0, 0x3b0004b1);//1440x900
                if (frac_rate)
                        hd_write_reg(P_ANACTRL_HDMIPLL_CTRL1, 0x0001ffff);
                else
                        hd_write_reg(P_ANACTRL_HDMIPLL_CTRL1, 0x00018000);
                ...
                break;
        case 1620000:
                hd_write_reg(P_ANACTRL_HDMIPLL_CTRL0, 0x3b000486);//1600x1200
                if (frac_rate)
                        hd_write_reg(P_ANACTRL_HDMIPLL_CTRL1, 0x0001ffff);
                else
                        hd_write_reg(P_ANACTRL_HDMIPLL_CTRL1, 0x00018000);
                ...
                break;
        case 1190000:
                hd_write_reg(P_ANACTRL_HDMIPLL_CTRL0, 0x3b0004C6);//1680x1050
                if (frac_rate)
                        hd_write_reg(P_ANACTRL_HDMIPLL_CTRL1, 0x0001ffff);
                else
                        hd_write_reg(P_ANACTRL_HDMIPLL_CTRL1, 0x00018000);
                ...
                break;
        case 1932500:
                hd_write_reg(P_ANACTRL_HDMIPLL_CTRL0, 0x3b0004A1);//1920x1200
                if (frac_rate)
                        hd_write_reg(P_ANACTRL_HDMIPLL_CTRL1, 0x0001ffff);
                else
                        hd_write_reg(P_ANACTRL_HDMIPLL_CTRL1, 0x00018000);
                ...
                break;
        case 1980000:
                hd_write_reg(P_ANACTRL_HDMIPLL_CTRL0, 0x3b0004A5);//2560x1080
                if (frac_rate)
                        hd_write_reg(P_ANACTRL_HDMIPLL_CTRL1, 0x0001ffff);
                else
                        hd_write_reg(P_ANACTRL_HDMIPLL_CTRL1, 0x00018000);
                ...
                break;
        case 2415000:
                hd_write_reg(P_ANACTRL_HDMIPLL_CTRL0, 0x3b0004C9);//2560x1440
                if (frac_rate)
                ...
                break;
        case 2686200:
                hd_write_reg(P_ANACTRL_HDMIPLL_CTRL0, 0x3b0004DF);//2560x1600
                if (frac_rate)
                        hd_write_reg(P_ANACTRL_HDMIPLL_CTRL1, 0x0001ffff);
                else
                        hd_write_reg(P_ANACTRL_HDMIPLL_CTRL1, 0x00018000);

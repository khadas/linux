...
static void bl_extern_init_table_dynamic_size_print(struct bl_extern_config_s
						    *econf, int flag)
{
	int i, j, k, max_len;
...
static void bl_extern_init_table_fixed_size_print(struct bl_extern_config_s
						  *econf, int flag)
{
	int i, j, k, max_len;
	unsigned char cmd_size;
...
static int bl_extern_init_table_dynamic_size_load_dts(struct device_node
						      *of_node,
...
static int bl_extern_init_table_fixed_size_load_dts(struct device_node
						    *of_node,
						    struct bl_extern_config_s
						    *extconf, int flag)
{

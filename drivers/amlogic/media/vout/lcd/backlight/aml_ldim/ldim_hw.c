...
static int ldim_update_matrix(int new_bl_matrix[], int bl_matrix_num)
{
	int data;
...
static void ldim_stts_en(unsigned int resolution, unsigned int pix_drop_mode,
			 unsigned int eol_en, unsigned int hist_mode,
			 unsigned int lpf_en, unsigned int rd_idx_auto_inc_mode,
...
static void ldim_stts_set_region_tl1(unsigned int resolution,
				     /* 0: auto calc by
				      *    height/width/row_start/col_start
				      * 1: 720p
				      * 2: 1080p
				      */

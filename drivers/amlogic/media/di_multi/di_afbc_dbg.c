...
static const struct regs_t reg_bits_tab_afbc[] = {
	...
	{EAFBC_SIZE_OUT, 16, 13, AFBC_B_HSZIE_OUT, "hszie_out"},
...
const struct regs_t reg_bits_tab_afbce[] = {
	...
	{EAFBCE_DEFCOLOR_1,  0, 12,
		E_AFBCE_ENC_DEFALUTCOLOR_0, "enc_defalutcolor_0"},
	{EAFBCE_DEFCOLOR_1, 12, 12,
		E_AFBCE_ENC_DEFALUTCOLOR_3, "enc_defalutcolor_3"},
	{EAFBCE_DEFCOLOR_2,  0, 12,
		E_AFBCE_ENC_DEFALUTCOLOR_1, "enc_defalutcolor_1"},
	{EAFBCE_DEFCOLOR_2, 12, 12,
		E_AFBCE_ENC_DEFALUTCOLOR_2, "enc_defalutcolor_2"},

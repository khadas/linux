 ...
 */
#define VDIN_VER "ver:2020-0214: bringup 5.4 for sm1"

/* define chip match data */
enum vdin_chip_match_id {
	VDIN_MATCH_NULL,
	VDIN_MATCH_TL1,
	VDIN_MATCH_SM1,
	VDIN_MATCH_TM2,
...
struct vdin_dev_s {
	 ...
	 */
	enum vdin_wr_color_depth_e color_depth_support;
	/*color depth config
	 ...
	 */
	enum color_deep_cfg_e color_depth_config;

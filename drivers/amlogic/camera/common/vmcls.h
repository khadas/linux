/*
 * drivers/amlogic/camera/common/vmcls.h
 *
...
static struct class_attribute vm_class_attrs[] = {
				...
				show_vm_info, NULL),
				__ATTR(attr0, S_IRUGO | S_IWUSR,
				read_attr0, write_attr0),
				__ATTR(attr1, S_IRUGO | S_IWUSR,
				read_attr1, write_attr1),
				__ATTR(attr2, S_IRUGO | S_IWUSR,
				read_attr2, write_attr2),
				__ATTR(mirror, S_IRUGO | S_IWUSR,

...
// 0 - reset & pwdn
// 1 - reset-sub & pwdn-sub
// 2 - reset-ssub & pwdn-ssub
// 3 - reset-sssub & pwdn-sssub
static const int32_t config_sensor_idx = 3;                   // 0      1         2           3
static const char * reset_dts_pin_name = "reset-sssub";       // reset reset-sub  reset-ssub reset-sssub
static const char * pwr_dts_pin_name   = "pwdn-sssub";        // pwdn pwdn-sub pwdn-ssub  pwdn-sssub
...
static void sensor_set_mode( void *ctx, uint8_t mode )
{
    ...
    //sensor_set_iface2(&param->modes_table[mode], p_ctx->win_offset, p_ctx);

...
#ifndef __IMX415_CONFIG_H__
#define __IMX415_CONFIG_H__
...
#define SENSOR_TOTAL_HEIGHT 2250
...
typedef struct _imx415_private_t {
    uint32_t rhs1;
    uint32_t rhs2;
    uint32_t shr0;
    uint32_t shr1;

...
static uint32_t _calibration_iridix_ev_lim_no_str[] = {5180000,2600000};
...
static uint32_t _calibration_iridix8_strength_dk_enh_control[] = {
    25,      // dark_prc
    95,      // bright_prc
    1300,     // min_dk: minimum dark enhancement
    1700,    // max_dk: maximum dark enhancement
...
static uint16_t _calibration_ae_control_HDR_target[][2] = {
    {0 * 256, 40}, // HDR AE target should not be higher than LDR target
    {1 * 256, 40},
    {4 * 256, 40},
    {5 * 256, 40},
    {6 * 256, 40},
...
static uint8_t _calibration_pf_radial_lut[] = {0,0,0,0,23,46,70,93,116,139,162,185,209,232,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255,255};
...
static uint32_t _calibration_custom_settings_context[][4] = {
    ...
    //shading
    { 0x1abfc, 0x1f1fe449L, 0xffffffff,4},//shading mesh scale, 0x1f1fe449L: mesh scale=2; 0x1f1fe445: mesh scale=1
    //demosaic
    ...
    { 0x1aec0, 0x80aaaL, 0xffffff,4 }, //grey det thresh/lg det thresh/UU SH Slope
    ...
    //CNR
    { 0x1b0f4, 0x190L, 0x0,2 }, //global_slope
    { 0x1b0fc, 0x12cL, 0xfff,2 }, //uv_seg1_offset
    { 0x1b100, 0x00L, 0x0,2 }, //uv_seg1_slope
...
static uint32_t _calibration_demosaic_rgb_extension_control[][13] = {
    {0 * 256, 150, 128, 170, 500, 10, 8, 1600, 1600, 4000, 4000, 8000, 8000},
    {1 * 256, 150, 128, 170, 500, 10, 8, 1600, 1600, 4000, 4000, 8000, 8000},
    {2 * 256, 150, 128, 170, 500, 10, 8, 1600, 1600, 4000, 4000, 8000, 8000},
    {3 * 256, 150, 128, 170, 500, 10, 8, 1600, 1600, 4000, 4000, 8000, 8000},
    {4 * 256, 150, 128, 170, 500, 10, 8, 1600, 1600, 4000, 4000, 8000, 8000},
    {5 * 256, 150, 128, 170, 500, 10, 8, 1600, 1600, 4000, 4000, 8000, 8000},
    {6 * 256, 150, 128, 170, 500, 10, 8, 1600, 1600, 4000, 4000, 8000, 8000},
    {7 * 256, 150, 128, 170, 500, 10, 8, 1600, 1600, 4000, 4000, 8000, 8000},
};
...
static uint32_t _calibration_cnr_extension_control[][20] = {
    {0 * 256, 1200, 0, 140, 57000, 0, 140, 57000, 0, 140, 57000, 0, 140, 57000, 0, 400, 1500, 0, 400, 1500},
    {1 * 256, 1200, 0, 140, 57000, 0, 140, 57000, 0, 140, 57000, 0, 140, 57000, 0, 400, 2000, 0, 400, 2000},
    {2 * 256, 1200, 0, 140, 57000, 0, 140, 57000, 0, 140, 57000, 0, 140, 57000, 0, 400, 2100, 0, 400, 2100},
    {3 * 256, 1200, 0, 140, 57000, 0, 140, 57000, 0, 140, 57000, 0, 140, 57000, 0, 400, 2100, 0, 400, 2100},
    {4 * 256, 1200, 0, 140, 57000, 0, 140, 57000, 0, 140, 57000, 0, 140, 57000, 0, 400, 3500, 0, 400, 3500},
    {5 * 256, 1200, 0, 140, 57000, 0, 140, 57000, 0, 140, 57000, 0, 140, 57000, 0, 400, 4100, 0, 400, 4100},
    {6 * 256, 1200, 0, 140, 57000, 0, 140, 57000, 0, 140, 57000, 0, 140, 57000, 0, 400, 5900, 0, 400, 5900},
    {7 * 256, 1200, 0, 140, 57000, 0, 140, 57000, 0, 140, 57000, 0, 140, 57000, 0, 400, 6100, 0, 400, 6100},
};

// { GAIN_LOG2_ID*256, svariance, bright_pr, contrast, white_level }
static uint32_t _calibration_iridix_extension_control[][5] = {
    {0 * 256, 2, 170, 150, 809600},
    {1 * 256, 2, 170, 150, 809600},
    {2 * 256, 2, 170, 150, 809600},
    {3 * 256, 2, 170, 150, 809600},
    {4 * 256, 2, 170, 150, 809600},
    {5 * 256, 2, 170, 150, 809600},
    {6 * 256, 2, 170, 150, 809600},
    {7 * 256, 2, 170, 150, 809600},
};
...
uint32_t get_calibrations_dynamic_fs_lin_imx307_demo( ACameraCalibrations *c )
{
    uint32_t result = 0;
    if ( c != 0 ) {

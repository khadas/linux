...
static uint32_t _calibration_iridix_ev_lim_no_str[] = {5522577, 3116186};

static uint8_t _calibration_ae_correction[] = {128, 128, 128, 128, 128, 100, 100, 80, 80, 80, 80, 80};
...
static uint16_t _calibration_ae_control_HDR_target[][2] = {
    {0 * 256, 80}, // HDR AE target should not be higher than LDR target
    {1 * 256, 80},
    {2 * 256, 80},
    {3 * 256, 80},
    {4 * 256, 80},
...
static uint32_t _calibration_awb_mix_light_parameters[] = {
    ...
    90,  //lux low boundary for mix light lux range : range = {500: inf}
...
static uint32_t _calibration_demosaic_rgb_extension_control[][13] = {
    {0 * 256, 96, 128, 160, 100, 50, 110, 10000, 10000, 4000, 100, 10000, 10000},
    {1 * 256, 96, 128, 160, 150, 50, 150, 10000, 10000, 4000, 100, 10000, 10000},
    {2 * 256, 96, 100, 155, 250, 100, 250, 10000, 10000, 4000, 100, 10000, 10000},
    {3 * 256, 96, 100, 155, 300, 100, 250, 10000, 10000, 4000, 100, 10000, 10000},
    {4 * 256, 96, 90, 155, 300, 500, 250, 10000, 10000, 4000, 100, 10000, 10000},
    {5 * 256, 96, 90, 155, 300, 500, 500, 10000, 10000, 4000, 100, 10000, 10000},
    {6 * 256, 96, 90, 155, 300, 600, 600, 10000, 10000, 4000, 50, 8000, 10000},
    {7 * 256, 96, 90, 155, 400, 700, 700, 10000, 10000, 4000, 50, 8000, 10000},
    {8 * 256, 96, 90, 155, 400, 700, 700, 10000, 10000, 4000, 50, 8000, 10000},
};
...
static uint32_t _calibration_fr_sharpen_extension_control[][6] = {
    {0 * 256, 10, 150, 800, 1000, 1700},
    {1 * 256, 10, 200, 800, 1000, 1700},
    {2 * 256, 10, 250, 800, 1000, 1700},
    {3 * 256, 10, 300, 800, 1000, 1700},
    {4 * 256, 10, 300, 800, 1000, 1700},
    {5 * 256, 10, 300, 800, 1000, 1700},
    {6 * 256, 10, 300, 800, 1000, 1700},
    {7 * 256, 10, 300, 800, 1000, 1700},
    {8 * 256, 10, 300, 800, 1000, 1700},
};
...
static uint32_t _calibration_cnr_extension_control[][20] = {
    {0 * 256, 1000, 0, 200, 60000, 0, 200, 60000, 0, 20, 60000, 0, 20, 60000, 0, 100, 5000, 0, 100, 5000},
    {1 * 256, 1000, 0, 200, 60000, 0, 200, 60000, 0, 20, 60000, 0, 20, 60000, 0, 100, 5000, 0, 100, 5000},
    {2 * 256, 1000, 0, 180, 60000, 0, 180, 60000, 0, 40, 60000, 0, 40, 60000, 0, 100, 5000, 0, 100, 5000},
    {3 * 256, 1000, 0, 160, 60000, 0, 160, 60000, 0, 40, 60000, 0, 40, 60000, 0, 100, 5000, 0, 100, 5000},
    {4 * 256, 1000, 0, 160, 60000, 0, 160, 60000, 0, 60, 60000, 0, 60, 60000, 0, 100, 5000, 0, 100, 5000},
    {5 * 256, 1000, 0, 140, 60000, 0, 140, 60000, 0, 80, 60000, 0, 80, 60000, 0, 100, 10000, 0, 100, 10000},
    {6 * 256, 1000, 0, 140, 60000, 0, 140, 60000, 0, 100, 60000, 0, 100, 60000, 0, 100, 20000, 0, 100, 20000},
    {7 * 256, 1000, 0, 120, 65000, 0, 120, 65000, 0, 120, 65000, 0, 120, 65000, 0, 100, 30000, 0, 100, 30000},
    {8 * 256, 1000, 0, 120, 65000, 0, 120, 65000, 0, 120, 65000, 0, 120, 65000, 0, 100, 30000, 0, 100, 30000},
};

// { GAIN_LOG2_ID*256, svariance, bright_pr, contrast, white_level }
static uint32_t _calibration_iridix_extension_control[][5] = {
    {0 * 256, 4, 200, 230, 559600},
    {1 * 256, 4, 200, 230, 559600},
    {2 * 256, 4, 200, 230, 559600},
    {3 * 256, 4, 200, 230, 559600},
    {4 * 256, 4, 200, 230, 559600},
    {5 * 256, 4, 200, 230, 559600},
    {6 * 256, 4, 200, 230, 559600},
    {7 * 256, 4, 200, 230, 559600},
    {8 * 256, 4, 200, 230, 559600},
};
...
uint32_t get_calibrations_dynamic_linear_imx335( ACameraCalibrations *c )
{
    uint32_t result = 0;
    if ( c != 0 ) {

...
static uint32_t _calibration_iridix8_strength_dk_enh_control[] = {
    20,      // dark_prc
    95,      // bright_prc
    400,     // min_dk: minimum dark enhancement   //800
    2000,    // max_dk: maximum dark enhancement   //2000
...
static int32_t _calibration_gamma_threshold[] = {1, 3150709, 3751365};
...
static uint16_t _calibration_gamma_ev1[] =
    ...
    {0, 348, 546, 693, 818, 929, 1026, 1113, 1192, 1263, 1328, 1389, 1443, 1494, 1542, 1587, 1630, 1672, 1712, 1750, 1788, 1825, 1861, 1896, 1931, 1966, 2000, 2034, 2068, 2102, 2135, 2169, 2202, 2235, 2267, 2299, 2331, 2362, 2393, 2423, 2453, 2483, 2513, 2541, 2569, 2597, 2625, 2651, 2678, 2704, 2729, 2753, 2778, 2803, 2826, 2851, 2873, 2896, 2920, 2942, 2964, 2987, 3008, 3029, 3051, 3072, 3092, 3113, 3133, 3154, 3174, 3194, 3213, 3233, 3252, 3271, 3290, 3309, 3328, 3345, 3364, 3382, 3400, 3418, 3435, 3453, 3470, 3487, 3504, 3521, 3538, 3555, 3571, 3587, 3604, 3620, 3635, 3652, 3667, 3683, 3699, 3714, 3729, 3744, 3760, 3775, 3790, 3805, 3819, 3834, 3849, 3863, 3878, 3892, 3906, 3920, 3934, 3948, 3961, 3975, 3989, 4002, 4016, 4029, 4043, 4056, 4069, 4082, 4095};
...
static uint32_t _calibration_iridix_extension_control[][5] = {
    {0 * 256, 10, 200, 180, 809600},
    {1 * 256, 10, 200, 180, 809600},
    {2 * 256, 10, 200, 180, 809600},
    {3 * 256, 10, 200, 180, 809600},
    {4 * 256, 10, 200, 180, 809600},
    {5 * 256, 10, 200, 180, 809600},
    {6 * 256, 10, 200, 180, 809600},
    {7 * 256, 10, 200, 180, 809600},
};
...
uint32_t get_calibrations_dynamic_linear_imx224( ACameraCalibrations *c )
{
    uint32_t result = 0;
    if ( c != 0 ) {

...
static uint32_t _calibration_iridix_ev_lim_no_str[] = {4500000,2500000};
...
static uint32_t _calibration_demosaic_rgb_extension_control[][13] = {
    {0 * 256, 150, 128, 170, 180, 50, 100, 8000, 8000, 4000, 150, 8000, 8000},
    {1 * 256, 150, 110, 165, 180, 50, 100, 8000, 8000, 4000, 140, 8000, 8000},
    {2 * 256, 150, 100, 165, 200, 100, 150, 8000, 8000, 4000, 100, 8000, 8000},
    {3 * 256, 150, 90, 160, 250, 150, 200, 8000, 8000, 4000, 100, 8000, 8000},
    {4 * 256, 150, 60, 160, 250, 200, 250, 8000, 8000, 4000, 90, 8000, 8000},
    {5 * 256, 150, 60, 160, 250, 200, 300, 8000, 8000, 4000, 70, 8000, 8000},
    {6 * 256, 150, 60, 160, 300, 200, 300, 8000, 8000, 4000, 60, 8000, 8000},
    {7 * 256, 150, 60, 160, 350, 250, 350, 8000, 8000, 4000, 50, 8000, 8000},
};
...
static uint32_t _calibration_fr_sharpen_extension_control[][6] = {
    ...
    {2 * 256, 10, 220, 1000, 1000, 1700},
    {3 * 256, 10, 240, 1000, 1000, 1700},
    {4 * 256, 10, 250, 1000, 1000, 1700},
    {5 * 256, 10, 250, 1000, 1000, 1700},
    {6 * 256, 10, 300, 1000, 1000, 1700},
    {7 * 256, 10, 320, 1000, 1000, 1700},
};
...
static uint32_t _calibration_iridix_extension_control[][5] = {
    {0 * 256, 5, 200, 200, 809600},
    {1 * 256, 5, 200, 220, 809600},
    {2 * 256, 5, 200, 240, 809600},
    {3 * 256, 5, 200, 240, 809600},
    {4 * 256, 5, 200, 240, 809600},
    {5 * 256, 5, 200, 240, 809600},
    {6 * 256, 5, 200, 240, 809600},
    {7 * 256, 5, 200, 240, 809600},
};

...
static uint32_t _calibration_iridix8_strength_dk_enh_control[] = {
    ...
    900,    // max_dk: maximum dark enhancement
    8,       // pD_cut_min: minimum intensity cut for dark regions in which dk_enh will be applied
    60,      // pD_cut_max: maximum intensity cut for dark regions in which dk_enh will be applied
...
static uint32_t _calibration_custom_settings_context[][4] = {
    ...
    { 0x1aec0, 0x00aab4L, 0xffffff,4 }, //grey det thresh/lg det thresh/UU SH Slope
    { 0x1aec8, 0x157c1388L, 0xffffffff,4 }, //grey det slope/lg det slope
    { 0x1aeb4, 0x1f40L, 0x1fff,2 }, //min_d_strength
    { 0x1aeb8, 0x1f40L, 0x1fff,2 }, //min_ud_strength
    { 0x1aecc, 0x2580258L, 0x1fff1fff,4 }, //max_ud_strength/max_d_strength
    //CNR
    { 0x1b0f4, 0x333L, 0x0,2 }, //global_slope
    { 0x1b0fc, 0x12cL, 0xfff,2 }, //uv_seg1_offset
    { 0x1b100, 0xcf08L, 0x0,2 }, //uv_seg1_slope
    { 0x1b13c, 0xee48L, 0x0,2 }, //uv_var1_slope
    { 0x1b148, 0xee48L, 0x0,2 }, //uv_var2_slope
    { 0x1b138, 0xbb8L, 0xfff,2 }, //uv_var1_offset
...
static uint32_t _calibration_demosaic_rgb_extension_control[][13] = {
    {0 * 256, 150, 110, 160, 260, 360, 360, 7500, 7500, 4000, 100, 8000, 8000},
    {1 * 256, 150, 110, 160, 260, 360, 360, 7500, 7500, 4000, 100, 8000, 8000},
    {2 * 256, 150, 110, 160, 260, 360, 360, 7500, 7500, 4000, 100, 8000, 8000},
    {3 * 256, 150, 110, 160, 280, 360, 360, 7500, 7500, 4000, 100, 8000, 8000},
    {4 * 256, 150, 110, 160, 280, 380, 380, 7500, 7500, 4000, 500, 8000, 8000},
    {5 * 256, 150, 110, 160, 280, 380, 380, 7500, 7500, 4000, 500, 8000, 8000},
    {6 * 256, 150, 110, 160, 300, 400, 400, 7000, 7000, 4000, 1000, 8000, 8000},
    {7 * 256, 150, 110, 160, 300, 420, 420, 7000, 7000, 4000, 1000, 8000, 8000},
};
...
static uint32_t _calibration_fr_sharpen_extension_control[][6] = {
    {0 * 256, 10, 400, 1000, 1000, 1700},
    {1 * 256, 10, 400, 1000, 1000, 1700},
    {2 * 256, 10, 450, 1000, 1000, 1700},
    {3 * 256, 10, 450, 1000, 1000, 1700},
    {4 * 256, 10, 450, 1000, 1000, 1700},
...
static uint32_t _calibration_iridix_extension_control[][5] = {
    {0 * 256, 10, 230, 150, 300000},
    {1 * 256, 10, 230, 150, 300000},
    {2 * 256, 10, 230, 150, 300000},
    {3 * 256, 10, 230, 150, 300000},
    {4 * 256, 10, 230, 150, 300000},
    {5 * 256, 10, 230, 150, 300000},
    {6 * 256, 10, 230, 150, 300000},
    {7 * 256, 10, 230, 150, 300000},
};
...
uint32_t get_calibrations_dynamic_linear_os08a10_panel( ACameraCalibrations *c )
{
    uint32_t result = 0;
    if ( c != 0 ) {

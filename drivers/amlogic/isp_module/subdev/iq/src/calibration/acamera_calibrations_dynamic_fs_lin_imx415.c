...
static uint16_t _calibration_ccm_one_gain_threshold[] = {256 * 9};
...
static uint32_t _calibration_iridix_ev_lim_no_str[] = {4800000,2800000};

static uint8_t _calibration_ae_correction[] = {128, 128, 128, 128, 128, 110, 98, 98, 90, 80, 70, 70};
...
static uint32_t _calibration_iridix8_strength_dk_enh_control[] = {
    25,      // dark_prc
    99,      // bright_prc
    1000,     // min_dk: minimum dark enhancement
    1600,    // max_dk: maximum dark enhancement
    4,       // pD_cut_min: minimum intensity cut for dark regions in which dk_enh will be applied
    80,      // pD_cut_max: maximum intensity cut for dark regions in which dk_enh will be applied
    25 << 8, // dark contrast min
    68 << 8, // dark contrast max
...
static uint32_t _calibration_ae_control[] = {
    ...
    0,  // AE tail weight
    100,  // WDR mode only: Max percentage of clipped pixels for long exposure: WDR mode only: 256 = 100% clipped pixels
    ...
    80,  // control for clipping: highlights percentage (hi_target_prc): target for tail of histogram
...
static uint32_t _calibration_custom_settings_context[][4] = {
    ...
    {0x1aa28, 0x02L, 0x1f,1 }, //global offset [7:0]/Black Reflect/use_exp_mask/use LUT
...
static uint32_t _calibration_demosaic_rgb_extension_control[][13] = {
    {0 * 256, 150, 128, 170, 150, 50, 100, 8000, 8000, 4000, 130, 8000, 10000},
    {1 * 256, 150, 114, 170, 200, 50, 100, 8000, 8000, 4000, 130, 8000, 10000},
    {2 * 256, 150, 100, 165, 250, 50, 100, 8000, 8000, 4000, 120, 8000, 10000},
    {3 * 256, 150, 75, 160, 250, 100, 150, 8000, 8000, 4000, 120, 8000, 10000},
    {4 * 256, 150, 50, 160, 300, 150, 180, 8000, 8000, 4000, 100, 8000, 10000},
    {5 * 256, 150, 30, 160, 350, 200, 220, 6000, 6000, 4000, 80, 8000, 12000},
    {6 * 256, 150, 20, 150, 350, 200, 220, 6000, 6000, 4000, 80, 8000, 12000},
    {7 * 256, 150, 20, 150, 350, 200, 220, 4000, 4000, 4000, 80, 8000, 12000},
    {8 * 256, 150, 20, 150, 400, 200, 220, 2000, 2000, 4000, 50, 8000, 16000},
};
...
static uint32_t _calibration_fr_sharpen_extension_control[][6] = {
    {0 * 256, 10, 100, 1000, 1000, 1700},
    {1 * 256, 10, 100, 1000, 1000, 1700},
    {2 * 256, 10, 100, 1000, 1000, 1700},
    {3 * 256, 10, 200, 1000, 1000, 1700},
    {4 * 256, 10, 230, 1000, 1000, 1700},
    {5 * 256, 10, 300, 1000, 1000, 1700},
    {6 * 256, 10, 300, 1000, 1000, 1700},
    {7 * 256, 10, 300, 1000, 1000, 1700},
    {8 * 256, 10, 300, 1000, 1000, 1700},
};
...
static uint32_t _calibration_iridix_extension_control[][5] = {
    {0 * 256, 2, 200, 220, 559600},
    {1 * 256, 2, 200, 220, 559600},
    {2 * 256, 2, 200, 220, 559600},
    {3 * 256, 2, 200, 220, 559600},
    {4 * 256, 2, 200, 220, 559600},
    {5 * 256, 2, 200, 220, 559600},
    {6 * 256, 2, 200, 220, 559600},
    {7 * 256, 2, 200, 220, 559600},
    {8 * 256, 2, 200, 220, 559600},
};
...
uint32_t get_calibrations_dynamic_fs_lin_imx415( ACameraCalibrations *c )
{
    uint32_t result = 0;
    if ( c != 0 ) {

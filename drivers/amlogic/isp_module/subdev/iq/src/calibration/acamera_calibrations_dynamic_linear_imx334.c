...
static uint32_t _calibration_iridix_ev_lim_no_str[] = {5000000, 3500000};

static uint8_t _calibration_ae_correction[] = {128, 128, 128, 128, 128, 128, 114, 100, 88, 78, 68, 58};
...
static uint32_t _calibration_iridix8_strength_dk_enh_control[] = {
    25,      // dark_prc
    95,      // bright_prc
    650,     // min_dk: minimum dark enhancement
...
static uint16_t _calibration_gamma_ev1[] =
    ...
    {0, 192, 387, 553, 698, 827, 940, 1041, 1130, 1209, 1278, 1341, 1398, 1453, 1505, 1554, 1601, 1647, 1691, 1733, 1774, 1814, 1853, 1891, 1928, 1964, 2000, 2034, 2068, 2102, 2135, 2167, 2199, 2230, 2261, 2291, 2321, 2350, 2379, 2407, 2435, 2463, 2491, 2517, 2544, 2570, 2596, 2621, 2646, 2671, 2695, 2719, 2743, 2767, 2790, 2814, 2836, 2859, 2882, 2904, 2926, 2948, 2969, 2990, 3012, 3033, 3053, 3074, 3094, 3115, 3135, 3155, 3174, 3194, 3213, 3233, 3252, 3271, 3290, 3308, 3327, 3345, 3364, 3382, 3400, 3418, 3436, 3453, 3471, 3488, 3506, 3523, 3540, 3557, 3574, 3591, 3607, 3624, 3640, 3657, 3673, 3689, 3705, 3721, 3737, 3753, 3769, 3785, 3800, 3816, 3831, 3846, 3862, 3877, 3892, 3907, 3922, 3937, 3951, 3966, 3981, 3995, 4010, 4024, 4039, 4053, 4067, 4081, 4095};
...
static uint32_t _calibration_demosaic_rgb_extension_control[][13] = {
    {0*256, 150, 128, 170, 100, 10, 40, 8000, 8000, 4000, 100, 8000, 10000},
    {1*256, 150, 128, 165, 100, 30, 60, 8000, 8000, 4000, 100, 8000, 10000},
    {2*256, 150, 128, 160, 200, 50, 80, 8000, 8000, 4000, 80, 8000, 12000},
    {3*256, 150, 128, 155, 250, 100, 300, 8000, 8000, 4000, 80, 8000, 12000},
    {4*256, 150, 128, 155, 300, 150, 400, 8000, 8000, 4000, 70, 8000, 12000},
    {5*256, 150, 128, 155, 350, 150, 400, 8000, 8000, 4000, 50, 8000, 12000},
    {6*256, 150, 128, 155, 400, 150, 300, 8000, 8000, 4000, 50, 8000, 14000},
    {7*256, 150, 128, 155, 400, 150, 300, 8000, 8000, 4000, 40, 8000, 14000},
    {8*256, 150, 128, 155, 400, 200, 300, 8000, 8000, 4000, 40, 8000, 14000},
};
...
static uint32_t _calibration_iridix_extension_control[][5] = {
    {0*256, 2, 200, 220, 650000},
    {1*256, 2, 200, 220, 650000},
    {2*256, 2, 200, 220, 500000},
    {3*256, 2, 200, 230, 400000},
    {4*256, 2, 200, 230, 400000},
    {5*256, 2, 200, 230, 400000},
    {6*256, 2, 200, 230, 400000},
    {7*256, 2, 200, 230, 400000},
    {8*256, 2, 200, 230, 400000},
};

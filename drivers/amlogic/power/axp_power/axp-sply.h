/*
 * drivers/amlogic/power/axp_power/axp-sply.h
 *
...
/*
 * export global axp_charger struct so this struct can be
...
extern int axp_set_usb_voltage_limit(int voltage);
extern int axp_set_noe_delay(int delay);
extern int axp_set_pek_on_time(int time);
extern int axp_set_pek_long_time(int time);
extern int axp_set_pek_off_en(int en);
extern int axp_set_pwrok_delay(int delay);
extern int axp_set_pek_off_time(int time);
extern int axp_set_ot_power_off_en(int en);
extern int axp_set_poweroff_voltage(int voltage);
extern int axp_charger_set_usbcur_limit_extern(int usbcur_limit);

extern int axp_get_battery_percent(void);
extern int axp_get_battery_voltage(void);
extern int axp_get_battery_current(void);

/*
 * drivers/amlogic/power/axp_power/axp-mfd.h
 *
 ...
 *		     when have charge current, even battery voltage is
 *		     over ocv_full;
...
extern int axp202_usb_charger(struct notifier_block *nb,
			      unsigned long value, void *pdata);
extern int axp202_otg_change(struct notifier_block *nb,
			     unsigned long value, void *pdata);

...
static struct sec_pm_private_domain p1_pm_domains[] = {
	[PDID_P1_DSPA] = POWER_DOMAIN(dspa, PDID_P1_DSPA, DOMAIN_INIT_ON, GENPD_FLAG_ALWAYS_ON),
	[PDID_P1_DSPB] = POWER_DOMAIN(dspb, PDID_P1_DSPB, DOMAIN_INIT_ON, GENPD_FLAG_ALWAYS_ON),

	[PDID_P1_M4A] = POWER_DOMAIN(m4a, PDID_P1_M4A, DOMAIN_INIT_ON, GENPD_FLAG_ALWAYS_ON),
	[PDID_P1_M4B] = POWER_DOMAIN(m4b, PDID_P1_M4B, DOMAIN_INIT_ON, GENPD_FLAG_ALWAYS_ON),

	[PDID_P1_ISP_A] = TOP_DOMAIN(ispa, PDID_P1_ISP_A, DOMAIN_INIT_ON,
			GENPD_FLAG_ALWAYS_ON, PDID_P1_MIPI_ISP_TOP),
	[PDID_P1_ISP_B] = TOP_DOMAIN(ispb, PDID_P1_ISP_B, DOMAIN_INIT_ON,
			GENPD_FLAG_ALWAYS_ON, PDID_P1_MIPI_ISP_TOP),
	[PDID_P1_ISP_C] = TOP_DOMAIN(ispc, PDID_P1_ISP_C, DOMAIN_INIT_ON,
			GENPD_FLAG_ALWAYS_ON, PDID_P1_MIPI_ISP_TOP),
	[PDID_P1_ISP_D] = TOP_DOMAIN(ispd, PDID_P1_ISP_D, DOMAIN_INIT_ON,
			GENPD_FLAG_ALWAYS_ON, PDID_P1_MIPI_ISP_TOP),
	[PDID_P1_MIPI_ISP_TOP] = POWER_DOMAIN(mipiisptop, PDID_P1_DSPB,
			DOMAIN_INIT_ON, GENPD_FLAG_ALWAYS_ON),
	...
	[PDID_P1_NAND_EMMC] = POWER_DOMAIN(nandemmc, PDID_P1_NAND_EMMC,
			DOMAIN_INIT_ON, GENPD_FLAG_ALWAYS_ON),
	[PDID_P1_NNA_A] = TOP_DOMAIN(nnaa, PDID_P1_NNA_A, DOMAIN_INIT_ON,
			GENPD_FLAG_ALWAYS_ON, PDID_P1_NNA_TOP),
	[PDID_P1_NNA_B] = TOP_DOMAIN(nnab, PDID_P1_NNA_B, DOMAIN_INIT_ON,
			GENPD_FLAG_ALWAYS_ON, PDID_P1_NNA_TOP),
	[PDID_P1_NNA_C] = TOP_DOMAIN(nnac, PDID_P1_NNA_C, DOMAIN_INIT_ON,
			GENPD_FLAG_ALWAYS_ON, PDID_P1_NNA_TOP),
	[PDID_P1_NNA_D] = TOP_DOMAIN(nnad, PDID_P1_NNA_D, DOMAIN_INIT_ON,
			GENPD_FLAG_ALWAYS_ON, PDID_P1_NNA_TOP),
	[PDID_P1_NNA_E] = TOP_DOMAIN(nnae, PDID_P1_NNA_E, DOMAIN_INIT_ON,
			GENPD_FLAG_ALWAYS_ON, PDID_P1_NNA_TOP),
	[PDID_P1_NNA_F] = TOP_DOMAIN(nnaf, PDID_P1_NNA_F, DOMAIN_INIT_ON,
			GENPD_FLAG_ALWAYS_ON, PDID_P1_NNA_TOP),
	[PDID_P1_NNA_TOP] = POWER_DOMAIN(nnatop, PDID_P1_NNA_TOP,
			DOMAIN_INIT_ON, GENPD_FLAG_ALWAYS_ON),

	[PDID_P1_GE2D] = TOP_DOMAIN(ge2d, PDID_P1_GE2D, DOMAIN_INIT_ON,
			GENPD_FLAG_ALWAYS_ON, PDID_P1_FDLE),
	[PDID_P1_DEWA] = TOP_DOMAIN(dewa, PDID_P1_DEWA, DOMAIN_INIT_ON,
			GENPD_FLAG_ALWAYS_ON, PDID_P1_FDLE),
	[PDID_P1_DEWB] = TOP_DOMAIN(dewb, PDID_P1_DEWB, DOMAIN_INIT_ON,
			GENPD_FLAG_ALWAYS_ON, PDID_P1_FDLE),
	[PDID_P1_DEWC] = TOP_DOMAIN(dewc, PDID_P1_DEWC, DOMAIN_INIT_ON,
			GENPD_FLAG_ALWAYS_ON, PDID_P1_FDLE),

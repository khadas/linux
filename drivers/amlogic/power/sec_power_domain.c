...
static struct sec_pm_private_domain s5_pm_domains[] = {
	[PDID_S5_MALI_0] = POWER_DOMAIN(mali_0, PDID_S5_MALI_0,
			DOMAIN_INIT_ON, GENPD_FLAG_ALWAYS_ON),
	[PDID_S5_MALI_1] = POWER_DOMAIN(mali_1, PDID_S5_MALI_1,
			DOMAIN_INIT_ON, GENPD_FLAG_ALWAYS_ON),
	[PDID_S5_MALI_2] = POWER_DOMAIN(mali_2, PDID_S5_MALI_2,
			DOMAIN_INIT_ON, GENPD_FLAG_ALWAYS_ON),
	...
	[PDID_S5_DOS_TOP_WRAP] = POWER_DOMAIN(dos_top_wrap, PDID_S5_DOS_TOP_WRAP,
			DOMAIN_INIT_ON, GENPD_FLAG_ALWAYS_ON),
	[PDID_S5_DOS_VDEC] = POWER_DOMAIN(dos_vdec, PDID_S5_DOS_VDEC,
			DOMAIN_INIT_ON, GENPD_FLAG_ALWAYS_ON),
	[PDID_S5_DOS_HCODEC] = POWER_DOMAIN(dos_hcode, PDID_S5_DOS_HCODEC,
			DOMAIN_INIT_ON, GENPD_FLAG_ALWAYS_ON),
	[PDID_S5_DOS_HEVC_TOP] = POWER_DOMAIN(dos_hevc_top, PDID_S5_DOS_HEVC_TOP,
			DOMAIN_INIT_ON, GENPD_FLAG_ALWAYS_ON),
	[PDID_S5_DOS_HEVC_CORE1] = POWER_DOMAIN(dos_hevc_core1, PDID_S5_DOS_HEVC_CORE1,
			DOMAIN_INIT_ON, GENPD_FLAG_ALWAYS_ON),
	[PDID_S5_USB2] = POWER_DOMAIN(usb2, PDID_S5_USB2,
			DOMAIN_INIT_ON, GENPD_FLAG_ALWAYS_ON),
	[PDID_S5_PCIE0] = POWER_DOMAIN(pcie0, PDID_S5_PCIE0,
			DOMAIN_INIT_ON, GENPD_FLAG_ALWAYS_ON),
	[PDID_S5_GE2D] = POWER_DOMAIN(ge2d, PDID_S5_GE2D,
			DOMAIN_INIT_ON, GENPD_FLAG_ALWAYS_ON),
	[PDID_S5_VC9000E] = POWER_DOMAIN(vc9000e, PDID_S5_VC9000E,
			DOMAIN_INIT_ON, GENPD_FLAG_ALWAYS_ON),
	[PDID_S5_VICP] = POWER_DOMAIN(vicp, PDID_S5_VICP,
			DOMAIN_INIT_ON, GENPD_FLAG_ALWAYS_ON),
	[PDID_S5_VGE_TOP] = POWER_DOMAIN(vge_top, PDID_S5_VGE_TOP,
			DOMAIN_INIT_ON, GENPD_FLAG_ALWAYS_ON),
	[PDID_S5_VI_CLK1] = POWER_DOMAIN(vi_clk1, PDID_S5_VI_CLK1,
			DOMAIN_INIT_ON, GENPD_FLAG_ALWAYS_ON),
	[PDID_S5_VI_CLK2] = POWER_DOMAIN(vi_clk2, PDID_S5_VI_CLK2,
			DOMAIN_INIT_ON, GENPD_FLAG_ALWAYS_ON),
	...
	[PDID_S5_PCIE1] = POWER_DOMAIN(pcie1, PDID_S5_PCIE1,
			DOMAIN_INIT_ON, GENPD_FLAG_ALWAYS_ON),
	[PDID_S5_VPU_DOLBY] = POWER_DOMAIN(vpu_dolby, PDID_S5_VPU_DOLBY,
			DOMAIN_INIT_ON, GENPD_FLAG_ALWAYS_ON),
	...
	[PDID_S5_DDRPHY1] = POWER_DOMAIN(ddrphy1, PDID_S5_DDRPHY1,
			DOMAIN_INIT_ON, GENPD_FLAG_ALWAYS_ON),
	[PDID_S5_NOC_DMC_WRAP] = POWER_DOMAIN(noc_dmc_wrap, PDID_S5_NOC_DMC_WRAP,
			DOMAIN_INIT_ON, GENPD_FLAG_ALWAYS_ON),
};

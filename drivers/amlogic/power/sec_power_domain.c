...
static struct sec_pm_private_domain p1_pm_domains[] = {
	...
	[PDID_P1_GE2D] = POWER_DOMAIN(ge2d, PDID_P1_GE2D,
			DOMAIN_INIT_ON, GENPD_FLAG_ALWAYS_ON),
	[PDID_P1_DEWA] = POWER_DOMAIN(dewa, PDID_P1_DEWA,
			DOMAIN_INIT_ON, GENPD_FLAG_ALWAYS_ON),
	[PDID_P1_DEWB] = POWER_DOMAIN(dewb, PDID_P1_DEWB,
			DOMAIN_INIT_ON, GENPD_FLAG_ALWAYS_ON),
	[PDID_P1_DEWC] = POWER_DOMAIN(dewc, PDID_P1_DEWC,
			DOMAIN_INIT_ON, GENPD_FLAG_ALWAYS_ON),

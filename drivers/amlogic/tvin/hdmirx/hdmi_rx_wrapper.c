...
,
	...
	if (((edid_mode&0x100) == 0) &&
		...
		if ((edid_mode&0xf) == 0) {
			...
			for (i = 0; i < 256; i++) {
				value = aml_edid_DD[i];
				if (value == 0x03) {
					if ((0x0c == aml_edid_DD[i+1]) &&
						(0x00 == aml_edid_DD[i+2]) &&
						(0x00 == aml_edid_DD[i+4])) {
						aml_edid_DD[i+3] = 0x10;
						phy_addr_offset = i+3;
					}
				}
				if ((i >= 128) && (i < 255)) {

/*
 * drivers/amlogic/tvin/bt656/bt656_601_in.h
 *
...
#define BT_ANCISADR		0x0b /* Removed in gx */
#define BT_ANCIEADR		0x0c /* Removed in gx */
...
#define BT_ANCI_STATUS	0x16 /* Removed in gx */
#define BT_VLINE_STATUS 0x17
#define BT_AFIFO_PTR	0x18 /* Removed in gx */
#define BT_JPEGBYTENUM	0x19 /* Changed in gx */
#define BT_ERR_CNT		0x1a /* Changed in gx */
#define BT_JPEG_STATUS0 0x1b /* Removed in gx */
#define BT_JPEG_STATUS1 0x1c /* Removed in gx */
#define BT_LCNT_STATUS	0x1d /* Changed in gx */
#define BT_PCNT_STATUS	0x1e /* Changed in gx */
#define BT656_ADDR_END	0x1f /* removed in gx */

#define BT_VLINE_STATUS_GX  0x17
#define BT_ERR_CNT_GX       0x19
#define BT_LCNT_STATUS_GX   0x1a
#define BT_PCNT_STATUS_GX   0x1c
#define BT_DELAY_CTRL_GX    0x1d
		...
		unsigned int *val)
{
	if (index <= BT656_MAX_DEVS) {
		*val = readl(bt656_reg_base[index]+reg);
		return 0;
	} else
		return -1;
}
...
{
	if (index <= BT656_MAX_DEVS) {
		writel(val, (bt656_reg_base[index]+reg));
		return 0;
	} else
		return -1;
}

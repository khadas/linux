...
//                       if couter won't be clear it can cause HDCP interrupts
// Accepts: none
// Returns: none
// Globals: none
//----------------------------------------------------------------------------*/
...
// Function Description: Initilize RX interrupts
...
// Function Description: Initilize software reset register
//----------------------------------------------------------------------------*/
...
BYTE GetRXDevId(void)
{
	...
	HDMIIN_PD("%s: abDevInfo=0x%02x,0x%02x, wDevId=0x%04x, bDevId=%d\n",
...
// Function Description: Intialize RX
//

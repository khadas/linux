/*
 * drivers/amlogic/tvin/hdmirx_ext/platform_iface.h
 *
...
/* for i2c function */
int __plat_i2c_init(struct hdmiin_hw_s *phw, unsigned char dev_i2c_addr);
...
void __plat_gpio_output(struct hdmiin_gpio_s *gpio, unsigned int value);

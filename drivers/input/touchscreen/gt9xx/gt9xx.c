...
int gtp_rst_gpio;
EXPORT_SYMBOL(gtp_rst_gpio);
int gtp_int_gpio;
EXPORT_SYMBOL(gtp_int_gpio);
static u32 rotation;
...
EXPORT_SYMBOL(gtp_i2c_read_dbl_check);
/*******************************************************
Function:
    Send config.
Input:
...
EXPORT_SYMBOL_GPL(gtp_reset_guitar);
...
EXPORT_SYMBOL(gtp_read_version);
/*******************************************************
Function:
    I2c test Function.
Input:
...
EXPORT_SYMBOL(gtp_parse_dt_cfg);
/**

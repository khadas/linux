...
/*****************************************************************************
*
* File Name: focaltech_upgrade_ft5822u.c
*
...
*****************************************************************************/
/************************************************************************
* Name: fts_ft5822u_upgrade
* Brief:
* Input:
* Output:
* Return: return 0 if success, otherwise return error code
***********************************************************************/
static int fts_ft5822u_upgrade(u8 *buf, u32 len)
{
    int ret = 0;
    u32 start_addr = 0;
    u8 cmd[4] = { 0 };
    int ecc_in_host = 0;
    int ecc_in_tp = 0;
    u8 app_flag[6] = {0x57, 0xA8, 0x26, 0xD9, 0x03, 0xFC};

    FTS_INFO("%s: begin to upgrade", __func__);
    if (NULL == buf) {
    ...
    /* write app */
    start_addr = upgrade_func_ft5822u.appoff;
...
struct upgrade_func upgrade_func_ft5822u = {
    .ctype = {0x86},
    .fwveroff = 0x10A,
    .fwcfgoff = 0x103B0,
    .appoff = 0x0000,

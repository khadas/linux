...
#ifndef _EPD_GOODIX_GT9XX_CFG_H_
#define _EPD_GOODIX_GT9XX_CFG_H_

/* CFG for GT911 */
static u8 epd_gtp_dat_gt11[] = {
	/* <1200, 1920>*/
	#include "WGJ89006B_GT911_Config_20140625_085816_0X43.cfg"
};

static u8 epd_gtp_dat_gt9110[] = {
	/* <1200, 1920>*/
	#include "GT9110P(2020)V71_Config_20201028_170326.cfg"
};

static u8 epd_gtp_dat_gt9111[] = {
	#include "HLS-0102-1398V1-1060-GT911_Config_20201204_V66.cfg"
};

static u8 epd_gtp_dat_8_9[] = {

...
{
	g_stCfg_MCap_DetailThreshold.InvalidNode = (unsigned char (*)[RX_NUM_MAX])kmalloc(TX_NUM_MAX*RX_NUM_MAX*sizeof(unsigned char), GFP_ATOMIC); 
	g_stCfg_MCap_DetailThreshold.InvalidNode_SC = (unsigned char (*)[RX_NUM_MAX])kmalloc(TX_NUM_MAX*RX_NUM_MAX*sizeof(unsigned char), GFP_ATOMIC); 
	g_stCfg_MCap_DetailThreshold.RawDataTest_Min = (int (*)[RX_NUM_MAX])kmalloc(TX_NUM_MAX*RX_NUM_MAX*sizeof(int), GFP_ATOMIC); 
	g_stCfg_MCap_DetailThreshold.RawDataTest_Max = (int (*)[RX_NUM_MAX])kmalloc(TX_NUM_MAX*RX_NUM_MAX*sizeof(int), GFP_ATOMIC); 
	g_stCfg_MCap_DetailThreshold.RawDataTest_Low_Min = (int (*)[RX_NUM_MAX])kmalloc(TX_NUM_MAX*RX_NUM_MAX*sizeof(int), GFP_ATOMIC); 
	g_stCfg_MCap_DetailThreshold.RawDataTest_Low_Max = (int (*)[RX_NUM_MAX])kmalloc(TX_NUM_MAX*RX_NUM_MAX*sizeof(int), GFP_ATOMIC); 
	g_stCfg_MCap_DetailThreshold.RawDataTest_High_Min = (int (*)[RX_NUM_MAX])kmalloc(TX_NUM_MAX*RX_NUM_MAX*sizeof(int), GFP_ATOMIC); 
	g_stCfg_MCap_DetailThreshold.RawDataTest_High_Max = (int (*)[RX_NUM_MAX])kmalloc(TX_NUM_MAX*RX_NUM_MAX*sizeof(int), GFP_ATOMIC); 
	g_stCfg_MCap_DetailThreshold.RxLinearityTest_Max = (int (*)[RX_NUM_MAX])kmalloc(TX_NUM_MAX*RX_NUM_MAX*sizeof(int), GFP_ATOMIC); 
	g_stCfg_MCap_DetailThreshold.TxLinearityTest_Max = (int (*)[RX_NUM_MAX])kmalloc(TX_NUM_MAX*RX_NUM_MAX*sizeof(int), GFP_ATOMIC); 
	g_stCfg_MCap_DetailThreshold.SCapRawDataTest_ON_Max = (int (*)[RX_NUM_MAX])kmalloc(TX_NUM_MAX*RX_NUM_MAX*sizeof(int), GFP_ATOMIC); 
	g_stCfg_MCap_DetailThreshold.SCapRawDataTest_ON_Min = (int (*)[RX_NUM_MAX])kmalloc(TX_NUM_MAX*RX_NUM_MAX*sizeof(int), GFP_ATOMIC); 
	g_stCfg_MCap_DetailThreshold.SCapRawDataTest_OFF_Max = (int (*)[RX_NUM_MAX])kmalloc(TX_NUM_MAX*RX_NUM_MAX*sizeof(int), GFP_ATOMIC); 
	g_stCfg_MCap_DetailThreshold.SCapRawDataTest_OFF_Min = (int (*)[RX_NUM_MAX])kmalloc(TX_NUM_MAX*RX_NUM_MAX*sizeof(int), GFP_ATOMIC); 
	g_stCfg_MCap_DetailThreshold.SCapCbTest_ON_Max = (int (*)[RX_NUM_MAX])kmalloc(TX_NUM_MAX*RX_NUM_MAX*sizeof(int), GFP_ATOMIC); 
	g_stCfg_MCap_DetailThreshold.SCapCbTest_ON_Min = (int (*)[RX_NUM_MAX])kmalloc(TX_NUM_MAX*RX_NUM_MAX*sizeof(int), GFP_ATOMIC); 
	g_stCfg_MCap_DetailThreshold.SCapCbTest_OFF_Max = (int (*)[RX_NUM_MAX])kmalloc(TX_NUM_MAX*RX_NUM_MAX*sizeof(int), GFP_ATOMIC); 
	g_stCfg_MCap_DetailThreshold.SCapCbTest_OFF_Min = (int (*)[RX_NUM_MAX])kmalloc(TX_NUM_MAX*RX_NUM_MAX*sizeof(int), GFP_ATOMIC); 
	g_stCfg_MCap_DetailThreshold.NoistTest_Coefficient = (int (*)[RX_NUM_MAX])kmalloc(TX_NUM_MAX*RX_NUM_MAX*sizeof(int), GFP_ATOMIC); 
		
}
void free_struct_DetailThreshold(void)
{
	int *NoistTest_Coefficient[RX_NUM_MAX];kmalloc(sizeof(ST_INI_FILE_DATA)*MAX_KEY_NUM, GFP_ATOMIC);

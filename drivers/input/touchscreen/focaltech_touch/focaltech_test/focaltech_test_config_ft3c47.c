...
void OnInit_FT3C47_TestItem(char *strIniFile)
{
	...
	//g_stCfg_FT3C47_TestItem.RX_SHORT_TEST = atoi(str);

	/////////////////////////////////// TX_SHORT_TEST
	//GetPrivateProfileString("TestItem","TX_SHORT_TEST","1",str,strIniFile);
	//g_stCfg_FT3C47_TestItem.TX_SHORT_TEST = atoi(str);
	...
	//g_stCfg_FT3C47_TestItem.SCAP_DIFFER_TEST = atoi(str);

	/////////////////////////////////// SCAP_CLB_TEST
	//GetPrivateProfileString("TestItem","SCAP_CLB_TEST","0",str,strIniFile);
	//g_stCfg_FT3C47_TestItem.SCAP_CLB_TEST = atoi(str);

	/////////////////////////////////// RX_CROSSTALK_TEST
	//GetPrivateProfileString("TestItem","RX_CROSSTALK_TEST","0",str,strIniFile);
	//g_stCfg_FT3C47_TestItem.RX_CROSSTALK_TEST = atoi(str);
...
void OnInit_FT3C47_BasicThreshold(char *strIniFile)
{
	...
	g_stCfg_FT3C47_BasicThreshold.FW_VER_VALUE = atoi(str);

	//////////////////////////////////////////////////////////// Factory ID
	GetPrivateProfileString("Basic_Threshold","Factory_ID_Number","255",str,strIniFile);
	g_stCfg_FT3C47_BasicThreshold.Factory_ID_Number = atoi(str);
	...
	//g_stCfg_FT3C47_BasicThreshold.SCapDifferTest_Min = atoi(str);
	//GetPrivateProfileString("Basic_Threshold","SCapDifferTest_Max","10000",str,strIniFile);
	//g_stCfg_FT3C47_BasicThreshold.SCapDifferTest_Max = atoi(str);
	//GetPrivateProfileString("Basic_Threshold","SCapDifferTest_CbLevel","2",str,strIniFile);
	//g_stCfg_FT3C47_BasicThreshold.SCapDifferTest_CbLevel = atoi(str);

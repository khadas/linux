/* drivers/input/sensors/gyro/icm20602_gyro.c
 *
...
struct sensor_operate gyro_icm20602_ops = {
	.name				= "icm20602_gyro",
	.type				= SENSOR_TYPE_GYROSCOPE,
	.id_i2c				= GYRO_ID_ICM20602,
	.read_reg			= ICM20602_GYRO_XOUT_H,
	.read_len			= 6,
...
{
	return &gyro_icm20602_ops;
}


static int __init gyro_icm20602_init(void)
{
...
static void __exit gyro_icm20602_exit(void)
{
	struct sensor_operate *ops = gyro_get_ops();
	int type = ops->type;
...
/* must register after icm20602_acc */
device_initcall_sync(gyro_icm20602_init);
module_exit(gyro_icm20602_exit);

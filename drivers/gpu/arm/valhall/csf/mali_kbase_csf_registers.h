...
#define CSG_ALLOW_NEURAL_LO 0x0018 /* () Allowed neural endpoints, low word */
#define CSG_ALLOW_NEURAL_HI 0x001C /* () Allowed neural endpoints, high word */

#define CS_FAULT_TRACE_ID0 0x00A0 /* () Additional trace information about a recoverable fault */
#define CS_FAULT_TRACE_ID1 0x00A4 /* () Additional trace information about a recoverable fault */
#define CS_FAULT_TRACE_TASK 0x00A8 /* () Additional trace information about a recoverable fault */
#define CS_FATAL_TRACE_ID0 \
	0x00B0 /* () Additional trace information about a non-recoverable fault */
#define CS_FATAL_TRACE_ID1 \
	0x00B4 /* () Additional trace information about a non-recoverable fault */
#define CS_FATAL_TRACE_TASK \
	0x00B8 /* () Additional trace information about a non-recoverable fault */
...
/* () Maximum number of endpoints allowed, low word 64-bit aligned */
#define CSG_EP_REQ_LO_64B_ALIGNED 0x0038
/* () Maximum number of endpoints allowed, high word 64-bit aligned */
#define CSG_EP_REQ_HI_64B_ALIGNED 0x003C
...
#define GLB_FATAL_INFO_LO 0x0020 /* () Global fatal error information, low word */
#define GLB_FATAL_INFO_HI 0x0024 /* () Global fatal error information, high word */
...
#ifdef CONFIG_MALI_VALHALL_CORESIGHT
...
#endif /* CONFIG_MALI_VALHALL_CORESIGHT */
...
#define CS_STATUS_REQ_RESOURCE_NEURAL_RESOURCES_SHIFT 4
#define CS_STATUS_REQ_RESOURCE_NEURAL_RESOURCES_MASK \
	(0x1 << CS_STATUS_REQ_RESOURCE_NEURAL_RESOURCES_SHIFT)
#define CS_STATUS_REQ_RESOURCE_NEURAL_RESOURCES_GET(reg_val)         \
	(((reg_val)&CS_STATUS_REQ_RESOURCE_NEURAL_RESOURCES_MASK) >> \
	 CS_STATUS_REQ_RESOURCE_NEURAL_RESOURCES_SHIFT)
...
#define CSG_EP_REQ_NEURAL_EP_SHIFT 32
#define CSG_EP_REQ_NEURAL_EP_MASK ((u64)0xFF << CSG_EP_REQ_NEURAL_EP_SHIFT)
#define CSG_EP_REQ_NEURAL_EP_GET(reg_val) \
	(((reg_val)&CSG_EP_REQ_NEURAL_EP_MASK) >> CSG_EP_REQ_NEURAL_EP_SHIFT)
#define CSG_EP_REQ_NEURAL_EP_SET(reg_val, value)    \
	(((reg_val) & ~CSG_EP_REQ_NEURAL_EP_MASK) | \
	 ((((u64)value) << CSG_EP_REQ_NEURAL_EP_SHIFT) & CSG_EP_REQ_NEURAL_EP_MASK))

#define CSG_EP_REQ_COMP_PRI_THRESHOLD_SHIFT GPU_U(40)
#define CSG_EP_REQ_COMP_PRI_THRESHOLD_MASK (GPU_ULL(0xFF) << CSG_EP_REQ_COMP_PRI_THRESHOLD_SHIFT)
#define CSG_EP_REQ_COMP_PRI_THRESHOLD_GET(reg_val) \
	(((reg_val)&CSG_EP_REQ_COMP_PRI_THRESHOLD_MASK) >> CSG_EP_REQ_COMP_PRI_THRESHOLD_SHIFT)
#define CSG_EP_REQ_COMP_PRI_THRESHOLD_SET(reg_val, value)              \
	(~(~(reg_val) | CSG_EP_REQ_COMP_PRI_THRESHOLD_MASK) |          \
	 (((uint64_t)(value) << CSG_EP_REQ_COMP_PRI_THRESHOLD_SHIFT) & \
	  CSG_EP_REQ_COMP_PRI_THRESHOLD_MASK))
#define CSG_EP_REQ_COMP_PRI_RATIO_SHIFT GPU_U(48)
#define CSG_EP_REQ_COMP_PRI_RATIO_MASK (GPU_ULL(0xF) << CSG_EP_REQ_COMP_PRI_RATIO_SHIFT)
#define CSG_EP_REQ_COMP_PRI_RATIO_GET(reg_val) \
	(((reg_val)&CSG_EP_REQ_COMP_PRI_RATIO_MASK) >> CSG_EP_REQ_COMP_PRI_RATIO_SHIFT)
#define CSG_EP_REQ_COMP_PRI_RATIO_SET(reg_val, value)              \
	(~(~(reg_val) | CSG_EP_REQ_COMP_PRI_RATIO_MASK) |          \
	 (((uint64_t)(value) << CSG_EP_REQ_COMP_PRI_RATIO_SHIFT) & \
	  CSG_EP_REQ_COMP_PRI_RATIO_MASK))

/* CS_FAULT_TRACE_ID0 register */
#define CS_FAULT_TRACE_ID0_EXCEPTION_TRACE_ID0_SHIFT GPU_U(0)
#define CS_FAULT_TRACE_ID0_EXCEPTION_TRACE_ID0_MASK \
	(GPU_U(0xFFFFFFFF) << CS_FAULT_TRACE_ID0_EXCEPTION_TRACE_ID0_SHIFT)
#define CS_FAULT_TRACE_ID0_EXCEPTION_TRACE_ID0_GET(reg_val)         \
	(((reg_val)&CS_FAULT_TRACE_ID0_EXCEPTION_TRACE_ID0_MASK) >> \
	 CS_FAULT_TRACE_ID0_EXCEPTION_TRACE_ID0_SHIFT)
#define CS_FAULT_TRACE_ID0_EXCEPTION_TRACE_ID0_SET(reg_val, value)     \
	(~(~(reg_val) | CS_FAULT_TRACE_ID0_EXCEPTION_TRACE_ID0_MASK) | \
	 (((value) << CS_FAULT_TRACE_ID0_EXCEPTION_TRACE_ID0_SHIFT) &  \
	  CS_FAULT_TRACE_ID0_EXCEPTION_TRACE_ID0_MASK))
/* CS_FAULT_TRACE_ID1 register */
#define CS_FAULT_TRACE_ID1_EXCEPTION_TRACE_ID1_SHIFT GPU_U(0)
#define CS_FAULT_TRACE_ID1_EXCEPTION_TRACE_ID1_MASK \
	(GPU_U(0xFFFFFFFF) << CS_FAULT_TRACE_ID1_EXCEPTION_TRACE_ID1_SHIFT)
#define CS_FAULT_TRACE_ID1_EXCEPTION_TRACE_ID1_GET(reg_val)         \
	(((reg_val)&CS_FAULT_TRACE_ID1_EXCEPTION_TRACE_ID1_MASK) >> \
	 CS_FAULT_TRACE_ID1_EXCEPTION_TRACE_ID1_SHIFT)
#define CS_FAULT_TRACE_ID1_EXCEPTION_TRACE_ID1_SET(reg_val, value)     \
	(~(~(reg_val) | CS_FAULT_TRACE_ID1_EXCEPTION_TRACE_ID1_MASK) | \
	 (((value) << CS_FAULT_TRACE_ID1_EXCEPTION_TRACE_ID1_SHIFT) &  \
	  CS_FAULT_TRACE_ID1_EXCEPTION_TRACE_ID1_MASK))
/* CS_FAULT_TRACE_TASK register */
#define CS_FAULT_TRACE_TASK_EXCEPTION_TRACE_TASK_SHIFT GPU_U(0)
#define CS_FAULT_TRACE_TASK_EXCEPTION_TRACE_TASK_MASK \
	(GPU_U(0xFFFFFFFF) << CS_FAULT_TRACE_TASK_EXCEPTION_TRACE_TASK_SHIFT)
#define CS_FAULT_TRACE_TASK_EXCEPTION_TRACE_TASK_GET(reg_val)         \
	(((reg_val)&CS_FAULT_TRACE_TASK_EXCEPTION_TRACE_TASK_MASK) >> \
	 CS_FAULT_TRACE_TASK_EXCEPTION_TRACE_TASK_SHIFT)
#define CS_FAULT_TRACE_TASK_EXCEPTION_TRACE_TASK_SET(reg_val, value)     \
	(~(~(reg_val) | CS_FAULT_TRACE_TASK_EXCEPTION_TRACE_TASK_MASK) | \
	 (((value) << CS_FAULT_TRACE_TASK_EXCEPTION_TRACE_TASK_SHIFT) &  \
	  CS_FAULT_TRACE_TASK_EXCEPTION_TRACE_TASK_MASK))
/* CS_FATAL_TRACE_ID0 register */
#define CS_FATAL_TRACE_ID0_EXCEPTION_TRACE_ID0_SHIFT GPU_U(0)
#define CS_FATAL_TRACE_ID0_EXCEPTION_TRACE_ID0_MASK \
	(GPU_U(0xFFFFFFFF) << CS_FATAL_TRACE_ID0_EXCEPTION_TRACE_ID0_SHIFT)
#define CS_FATAL_TRACE_ID0_EXCEPTION_TRACE_ID0_GET(reg_val)         \
	(((reg_val)&CS_FATAL_TRACE_ID0_EXCEPTION_TRACE_ID0_MASK) >> \
	 CS_FATAL_TRACE_ID0_EXCEPTION_TRACE_ID0_SHIFT)
#define CS_FATAL_TRACE_ID0_EXCEPTION_TRACE_ID0_SET(reg_val, value)     \
	(~(~(reg_val) | CS_FATAL_TRACE_ID0_EXCEPTION_TRACE_ID0_MASK) | \
	 (((value) << CS_FATAL_TRACE_ID0_EXCEPTION_TRACE_ID0_SHIFT) &  \
	  CS_FATAL_TRACE_ID0_EXCEPTION_TRACE_ID0_MASK))
/* CS_FATAL_TRACE_ID1 register */
#define CS_FATAL_TRACE_ID1_EXCEPTION_TRACE_ID1_SHIFT GPU_U(0)
#define CS_FATAL_TRACE_ID1_EXCEPTION_TRACE_ID1_MASK \
	(GPU_U(0xFFFFFFFF) << CS_FATAL_TRACE_ID1_EXCEPTION_TRACE_ID1_SHIFT)
#define CS_FATAL_TRACE_ID1_EXCEPTION_TRACE_ID1_GET(reg_val)         \
	(((reg_val)&CS_FATAL_TRACE_ID1_EXCEPTION_TRACE_ID1_MASK) >> \
	 CS_FATAL_TRACE_ID1_EXCEPTION_TRACE_ID1_SHIFT)
#define CS_FATAL_TRACE_ID1_EXCEPTION_TRACE_ID1_SET(reg_val, value)     \
	(~(~(reg_val) | CS_FATAL_TRACE_ID1_EXCEPTION_TRACE_ID1_MASK) | \
	 (((value) << CS_FATAL_TRACE_ID1_EXCEPTION_TRACE_ID1_SHIFT) &  \
	  CS_FATAL_TRACE_ID1_EXCEPTION_TRACE_ID1_MASK))
/* CS_FATAL_TRACE_TASK register */
#define CS_FATAL_TRACE_TASK_EXCEPTION_TRACE_TASK_SHIFT GPU_U(0)
#define CS_FATAL_TRACE_TASK_EXCEPTION_TRACE_TASK_MASK \
	(GPU_U(0xFFFFFFFF) << CS_FATAL_TRACE_TASK_EXCEPTION_TRACE_TASK_SHIFT)
#define CS_FATAL_TRACE_TASK_EXCEPTION_TRACE_TASK_GET(reg_val)         \
	(((reg_val)&CS_FATAL_TRACE_TASK_EXCEPTION_TRACE_TASK_MASK) >> \
	 CS_FATAL_TRACE_TASK_EXCEPTION_TRACE_TASK_SHIFT)
#define CS_FATAL_TRACE_TASK_EXCEPTION_TRACE_TASK_SET(reg_val, value)     \
	(~(~(reg_val) | CS_FATAL_TRACE_TASK_EXCEPTION_TRACE_TASK_MASK) | \
	 (((value) << CS_FATAL_TRACE_TASK_EXCEPTION_TRACE_TASK_SHIFT) &  \
	  CS_FATAL_TRACE_TASK_EXCEPTION_TRACE_TASK_MASK))
...
#define CSG_STATUS_EP_CURRENT_NEURAL_EP_SHIFT 24
#define CSG_STATUS_EP_CURRENT_NEURAL_EP_MASK (0xFFU << CSG_STATUS_EP_CURRENT_NEURAL_EP_SHIFT)
#define CSG_STATUS_EP_CURRENT_NEURAL_EP_GET(reg_val) \
	(((reg_val)&CSG_STATUS_EP_CURRENT_NEURAL_EP_MASK) >> CSG_STATUS_EP_CURRENT_NEURAL_EP_SHIFT)
#define CSG_STATUS_EP_CURRENT_NEURAL_EP_SET(reg_val, value)    \
	(((reg_val) & ~CSG_STATUS_EP_CURRENT_NEURAL_EP_MASK) | \
	 (((value) << CSG_STATUS_EP_CURRENT_NEURAL_EP_SHIFT) & \
	  CSG_STATUS_EP_CURRENT_NEURAL_EP_MASK))
...
#define CSG_STATUS_EP_REQ_EXCLUSIVE_NEURAL_SHIFT 22
#define CSG_STATUS_EP_REQ_EXCLUSIVE_NEURAL_MASK (0x1U << CSG_STATUS_EP_REQ_EXCLUSIVE_NEURAL_SHIFT)
#define CSG_STATUS_EP_REQ_EXCLUSIVE_NEURAL_GET(reg_val)         \
	(((reg_val)&CSG_STATUS_EP_REQ_EXCLUSIVE_NEURAL_MASK) >> \
	 CSG_STATUS_EP_REQ_EXCLUSIVE_NEURAL_SHIFT)
#define CSG_STATUS_EP_REQ_EXCLUSIVE_NEURAL_SET(reg_val, value)    \
	(((reg_val) & ~CSG_STATUS_EP_REQ_EXCLUSIVE_NEURAL_MASK) | \
	 (((value) << CSG_STATUS_EP_REQ_EXCLUSIVE_NEURAL_SHIFT) & \
	  CSG_STATUS_EP_REQ_EXCLUSIVE_NEURAL_MASK))
#define CSG_STATUS_EP_REQ_NEURAL_EP_SHIFT 24
#define CSG_STATUS_EP_REQ_NEURAL_EP_MASK (0xFFU << CSG_STATUS_EP_REQ_NEURAL_EP_SHIFT)
#define CSG_STATUS_EP_REQ_NEURAL_EP_GET(reg_val) \
	(((reg_val)&CSG_STATUS_EP_REQ_NEURAL_EP_MASK) >> CSG_STATUS_EP_REQ_NEURAL_EP_SHIFT)
#define CSG_STATUS_EP_REQ_NEURAL_EP_SET(reg_val, value)    \
	(((reg_val) & ~CSG_STATUS_EP_REQ_NEURAL_EP_MASK) | \
	 (((value) << CSG_STATUS_EP_REQ_NEURAL_EP_SHIFT) & CSG_STATUS_EP_REQ_NEURAL_EP_MASK))
...
#define STREAM_FEATURES_NEURAL_SHIFT 19
#define STREAM_FEATURES_NEURAL_MASK (0x1 << STREAM_FEATURES_NEURAL_SHIFT)
#define STREAM_FEATURES_NEURAL_GET(reg_val) \
	(((reg_val)&STREAM_FEATURES_NEURAL_MASK) >> STREAM_FEATURES_NEURAL_SHIFT)
#define STREAM_FEATURES_NEURAL_SET(reg_val, value)    \
	(((reg_val) & ~STREAM_FEATURES_NEURAL_MASK) | \
	 (((value) << STREAM_FEATURES_NEURAL_SHIFT) & STREAM_FEATURES_NEURAL_MASK))
...
/* The following register fields are for headers 14.x.6 onwards */
#define GLB_REQ_STATE_SHIFT GPU_U(12)
#define GLB_REQ_STATE_MASK (GPU_U(0x7) << GLB_REQ_STATE_SHIFT)
#define GLB_REQ_STATE_GET(reg_val) (((reg_val)&GLB_REQ_STATE_MASK) >> GLB_REQ_STATE_SHIFT)
#define GLB_REQ_STATE_SET(reg_val, value)     \
	(~(~(reg_val) | GLB_REQ_STATE_MASK) | \
	 (((value) << GLB_REQ_STATE_SHIFT) & GLB_REQ_STATE_MASK))
/* GLB_REQ_STATE values */
#define GLB_REQ_STATE_ACTIVE 0x0
#define GLB_REQ_STATE_HALT 0x1
#define GLB_REQ_STATE_SLEEP 0x2
#define GLB_REQ_STATE_SUSPEND 0x3
/* End of GLB_REQ_STATE values */
#define GLB_REQ_YIELD_ENABLE_SHIFT GPU_U(15)
#define GLB_REQ_YIELD_ENABLE_MASK (GPU_U(0x1) << GLB_REQ_YIELD_ENABLE_SHIFT)
#define GLB_REQ_YIELD_ENABLE_GET(reg_val) \
	(((reg_val)&GLB_REQ_YIELD_ENABLE_MASK) >> GLB_REQ_YIELD_ENABLE_SHIFT)
#define GLB_REQ_YIELD_ENABLE_SET(reg_val, value)     \
	(~(~(reg_val) | GLB_REQ_YIELD_ENABLE_MASK) | \
	 (((value) << GLB_REQ_YIELD_ENABLE_SHIFT) & GLB_REQ_YIELD_ENABLE_MASK))

#define GLB_ACK_IRQ_MASK_YIELD_ENABLE_SHIFT GPU_U(15)
#define GLB_ACK_IRQ_MASK_YIELD_ENABLE_MASK (GPU_U(0x1) << GLB_ACK_IRQ_MASK_YIELD_ENABLE_SHIFT)
#define GLB_ACK_IRQ_MASK_YIELD_ENABLE_GET(reg_val) \
	(((reg_val)&GLB_ACK_IRQ_MASK_YIELD_ENABLE_MASK) >> GLB_ACK_IRQ_MASK_YIELD_ENABLE_SHIFT)
#define GLB_ACK_IRQ_MASK_YIELD_ENABLE_SET(reg_val, value)     \
	(~(~(reg_val) | GLB_ACK_IRQ_MASK_YIELD_ENABLE_MASK) | \
	 (((value) << GLB_ACK_IRQ_MASK_YIELD_ENABLE_SHIFT) & GLB_ACK_IRQ_MASK_YIELD_ENABLE_MASK))

#define GLB_ACK_STATE_SHIFT GPU_U(12)
#define GLB_ACK_STATE_MASK (GPU_U(0x7) << GLB_ACK_STATE_SHIFT)
#define GLB_ACK_STATE_GET(reg_val) (((reg_val)&GLB_ACK_STATE_MASK) >> GLB_ACK_STATE_SHIFT)
#define GLB_ACK_STATE_SET(reg_val, value)     \
	(~(~(reg_val) | GLB_ACK_STATE_MASK) | \
	 (((value) << GLB_ACK_STATE_SHIFT) & GLB_ACK_STATE_MASK))
/* GLB_ACK_STATE values */
#define GLB_ACK_STATE_ACTIVE 0x0
#define GLB_ACK_STATE_HALT 0x1
#define GLB_ACK_STATE_SLEEP 0x2
#define GLB_ACK_STATE_SUSPEND 0x3
/* End of GLB_ACK_STATE values */

#define GLB_ACK_IRQ_MASK_STATE_SHIFT GPU_U(12)
#define GLB_ACK_IRQ_MASK_STATE_MASK (GPU_U(0x7) << GLB_ACK_IRQ_MASK_STATE_SHIFT)

 ...
 *		suspend	buffer.
 * @alloc_retries:	Number of times we retried allowing physical pages
 ...
 *                      smaller number).
 * @jit_lock:           Lock to serialize JIT operations.
 ...
 *                          @db_file_offsets, facilitates the use of uniqiue

...
#define PB_STATIC_ASSERT(COND, MSG) \
	typedef char PB_STATIC_ASSERT_MSG(MSG, __LINE__, __COUNTER__)[(COND) ? 1 : -1];
...
/* data offset for subsequent fields inside a union (oneof) */
...
#define PB_ONEOF_FIELD(union_name, tag, type, rules, \
	allocation, placement, message, field, prevfield, ptr) \
...
#define PB_ANONYMOUS_ONEOF_FIELD(union_name, tag, type, rules, \
	allocation, placement, message, field, prevfield, ptr) \

...
static const struct pinctrl_pin_desc meson_t7_periphs_pins[] = {
	MESON_PIN(GPIOB_0),
	MESON_PIN(GPIOB_1),
	MESON_PIN(GPIOB_2),
	MESON_PIN(GPIOB_3),
...
static struct meson_bank meson_t7_periphs_banks[] = {
	...
	BANK_DS("GPIOD_", GPIOD_0,    GPIOD_12, 57, 69,
		0x03,  0,  0x04,  0,  0x02,  0, 0x01, 0,  0x00, 0, 0x07, 0),
	BANK_DS("GPIOE_", GPIOE_0,    GPIOE_6,  70, 76,
		0x0b,  0,  0x0c,  0,  0x0a,  0, 0x09, 0,  0x08, 0, 0x0f, 0),
	BANK_DS("GPIOZ_", GPIOZ_0,    GPIOZ_13, 77, 90,
		0x13,  0,  0x14,  0,  0x12, 0,  0x11, 0,  0x10, 0, 0x17, 0),
	BANK_DS("GPIOH_", GPIOH_0,    GPIOH_7,  148, 155,
		0x1b,  0,  0x1c,  0,  0x1a, 0,  0x19, 0,  0x18, 0, 0x1f, 0),
	BANK_DS("GPIOC_", GPIOC_0,    GPIOC_6,  13, 19,
		0x23,  0,  0x24,  0,  0x22, 0,  0x21, 0,  0x20, 0, 0x27, 0),
	BANK_DS("GPIOB_", GPIOB_0,    GPIOB_12, 0, 12,
		0x2b,  0,  0x2c,  0,  0x2a, 0,  0x29, 0,  0x28, 0, 0x2f, 0),
	BANK_DS("GPIOX_", GPIOX_0,    GPIOX_19, 20, 39,
		0x33,  0,  0x34,  0,  0x32, 0,  0x31, 0,  0x30, 0, 0x37, 0),
	BANK_DS("GPIOT_", GPIOT_0,    GPIOT_23, 91, 114,
		0x43,  0,  0x44,  0,  0x42, 0,  0x41, 0,  0x40, 0, 0x47, 0),
	BANK_DS("GPIOY_", GPIOY_0,    GPIOY_18, 129, 147,
		0x53,  0,  0x54,  0,  0x52, 0,  0x51, 0,  0x50, 0, 0x57, 0),
	BANK_DS("GPIOW_", GPIOW_0,    GPIOW_16, 40, 56,
		0x63,  0,  0x64,  0,  0x62, 0,  0x61, 0,  0x60, 0, 0x67, 0),
	BANK_DS("GPIOM_", GPIOM_0,    GPIOM_13, 115, 128,
		0x73,  0,  0x74,  0,  0x72, 0,  0x71, 0,  0x70, 0, 0x77, 0),
	BANK_DS("GPIO_TEST_N", GPIO_TEST_N,    GPIO_TEST_N, 156, 156,
...
static struct meson_pinctrl_data meson_t7_periphs_pinctrl_data __refdata = {
	...
	.num_pins	= ARRAY_SIZE(meson_t7_periphs_pins),
...
static const struct of_device_id meson_t7_pinctrl_dt_match[] = {
	{
...
static struct platform_driver meson_t7_pinctrl_driver = {
	.probe  = meson_pinctrl_probe,
	.driver = {
		.name	= "meson-t7-pinctrl",
		.of_match_table = meson_t7_pinctrl_dt_match,
	},
};

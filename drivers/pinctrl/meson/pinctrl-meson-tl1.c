...
static struct meson_bank meson_tl1_periphs_banks[] = {
	...
	BANK_DS("H",    GPIOH_0,    GPIOH_22, 23, 45,
	2,  0,  2,  0,  6,  0,  7,  0,  8,  0, 2, 0),
	BANK_DS("BOOT", BOOT_0,     BOOT_13,  46, 59,
	0,  0,  0,  0,  0,  0,  1, 0,  2, 0, 0, 0),
	BANK_DS("C",    GPIOC_0,    GPIOC_14,  60, 74,
	3,  0,  3,  0,  9,  0,  10, 0,  11, 0, 4, 0),
	BANK_DS("W",    GPIOW_0,    GPIOW_11,  75, 86,
	4,  0,  4,  0,  12,  0,  13,  0,  14,  0, 5, 0),
	BANK_DS("DV",    GPIODV_0,    GPIODV_11,   87, 98,
...
static struct meson_bank meson_tl1_aobus_banks[] = {
	...
	BANK_DS("E",   GPIOE_0,  GPIOE_2,   99, 101,
...
#else
int __init meson_tl1_pinctrl_init(void)
{
	meson_tl1_pinctrl_driver.driver.of_match_table =
			meson_tl1_pinctrl_dt_match;
	return platform_driver_register(&meson_tl1_pinctrl_driver);
}
#endif

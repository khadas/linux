...
static struct rockchip_clk_branch rk3576_clk_branches[] __initdata = {
	...
	GATE(FCLK_DDR_CM0_CORE, "fclk_ddr_cm0_core", "hclk_ddr_root", 0,
	...
	COMPOSITE(DCLK_VP0_SRC, "dclk_vp0_src", gpll_cpll_vpll_bpll_lpll_p, 0,
			RK3576_CLKSEL_CON(145), 8, 3, MFLAGS, 0, 8, DFLAGS,
			RK3576_CLKGATE_CON(61), 10, GFLAGS),
	COMPOSITE(DCLK_VP1_SRC, "dclk_vp1_src", gpll_cpll_vpll_bpll_lpll_p, 0,
			RK3576_CLKSEL_CON(146), 8, 3, MFLAGS, 0, 8, DFLAGS,
			RK3576_CLKGATE_CON(61), 11, GFLAGS),
	COMPOSITE(DCLK_VP2_SRC, "dclk_vp2_src", gpll_cpll_vpll_bpll_lpll_p, 0,
...
static void __iomem *rk3576_cru_base;

static void rk3576_dump_cru(void)
{
	if (rk3576_cru_base) {
		pr_warn("CRU SEL:\n");
		print_hex_dump(KERN_WARNING, "", DUMP_PREFIX_OFFSET,
			       32, 4, rk3576_cru_base + 0x300,
			       0x300, false);
		pr_warn("CRU GATE:\n");
		print_hex_dump(KERN_WARNING, "", DUMP_PREFIX_OFFSET,
			       32, 4, rk3576_cru_base + 0x800,
			       0x300, false);
	}
}

...
static struct rockchip_clk_branch rv1126b_clk_branches[] __initdata = {
	...
	COMPOSITE_NODIV(CLK_CM_FRAC0_SRC, "clk_cm_frac0_src", mux_24m_gpll_aupll_cpll_p, 0,
			RV1126B_CLKSEL_CON(10), 0, 2, MFLAGS,
			RV1126B_CLKGATE_CON(1), 0, GFLAGS),
	COMPOSITE_FRAC_V2(CLK_CM_FRAC0, "clk_cm_frac0", "clk_cm_frac0_src", 0,
			RV1126B_CLKSEL_CON(25), 16, 16,
			RV1126B_CLK_CM_FRAC0_DIV_H, 8, 8, 0),
	COMPOSITE_NODIV(CLK_CM_FRAC1_SRC, "clk_cm_frac1_src", mux_24m_gpll_aupll_cpll_p, 0,
			RV1126B_CLKSEL_CON(10), 2, 2, MFLAGS,
			RV1126B_CLKGATE_CON(1), 1, GFLAGS),
	COMPOSITE_FRAC_V2(CLK_CM_FRAC1, "clk_cm_frac1", "clk_cm_frac1_src", 0,
			RV1126B_CLKSEL_CON(26), 16, 16,
			RV1126B_CLK_CM_FRAC1_DIV_H, 8, 8, 0),
	COMPOSITE_NODIV(CLK_CM_FRAC2_SRC, "clk_cm_frac2_src", mux_24m_gpll_aupll_cpll_p, 0,
			RV1126B_CLKSEL_CON(10), 4, 2, MFLAGS,
			RV1126B_CLKGATE_CON(1), 2, GFLAGS),
	COMPOSITE_FRAC_V2(CLK_CM_FRAC2, "clk_cm_frac2", "clk_cm_frac2_src", 0,
			RV1126B_CLKSEL_CON(27), 16, 16,
			RV1126B_CLK_CM_FRAC2_DIV_H, 8, 8, 0),
	COMPOSITE_NODIV(CLK_UART_FRAC0_SRC, "clk_uart_frac0_src", mux_24m_gpll_cpll_p, 0,
			RV1126B_CLKSEL_CON(10), 6, 2, MFLAGS,
			RV1126B_CLKGATE_CON(1), 3, GFLAGS),
	COMPOSITE_FRAC_V2(CLK_UART_FRAC0, "clk_uart_frac0", "clk_uart_frac0_src", 0,
			RV1126B_CLKSEL_CON(28), 16, 16,
			RV1126B_CLK_UART_FRAC0_DIV_H, 8, 8, CLK_FRAC_DIVIDER_NO_LIMIT),
	COMPOSITE_NODIV(CLK_UART_FRAC1_SRC, "clk_uart_frac1_src", mux_24m_gpll_cpll_p, 0,
			RV1126B_CLKSEL_CON(10), 8, 2, MFLAGS,
			RV1126B_CLKGATE_CON(1), 4, GFLAGS),
	COMPOSITE_FRAC_V2(CLK_UART_FRAC1, "clk_uart_frac1", "clk_uart_frac1_src", 0,
			RV1126B_CLKSEL_CON(29), 16, 16,
			RV1126B_CLK_UART_FRAC1_DIV_H, 8, 8, CLK_FRAC_DIVIDER_NO_LIMIT),
	COMPOSITE_NODIV(CLK_AUDIO_FRAC0_SRC, "clk_audio_frac0_src", mux_24m_gpll_aupll_p, 0,
			RV1126B_CLKSEL_CON(10), 10, 2, MFLAGS,
			RV1126B_CLKGATE_CON(1), 5, GFLAGS),
	COMPOSITE_FRAC_V2(CLK_AUDIO_FRAC0, "clk_audio_frac0", "clk_audio_frac0_src", 0,
			RV1126B_CLKSEL_CON(30), 16, 16,
			RV1126B_CLK_AUDIO_FRAC0_DIV_H, 8, 8, 0),
	COMPOSITE_NODIV(CLK_AUDIO_FRAC1_SRC, "clk_audio_frac1_src", mux_24m_gpll_aupll_p, 0,
			RV1126B_CLKSEL_CON(10), 12, 2, MFLAGS,
			RV1126B_CLKGATE_CON(1), 6, GFLAGS),
	COMPOSITE_FRAC_V2(CLK_AUDIO_FRAC1, "clk_audio_frac1", "clk_audio_frac1_src", 0,
			RV1126B_CLKSEL_CON(31), 16, 16,
			RV1126B_CLK_AUDIO_FRAC1_DIV_H, 8, 8, 0),
...
static void __iomem *rv1126b_cru_base;
static struct rockchip_clk_provider *cru_ctx;

static void rv1126b_dump_cru(void)
{
	if (rv1126b_cru_base) {
		pr_warn("CRU:\n");
		print_hex_dump(KERN_WARNING, "", DUMP_PREFIX_OFFSET,
			       32, 4, rv1126b_cru_base,
			       0x588, false);
	}
}
...
MODULE_DEVICE_TABLE(of, clk_rv1126b_match_table);

static int __init clk_rv1126b_probe(struct platform_device *pdev)
{
	struct device_node *np = pdev->dev.of_node;
	const struct of_device_id *match;
	const struct clk_rv1126b_inits *init_data;

	match = of_match_device(clk_rv1126b_match_table, &pdev->dev);
	if (!match || !match->data)
		return -EINVAL;
...
MODULE_DESCRIPTION("Rockchip RV1126B Clock Driver");
MODULE_LICENSE("GPL");
#endif /* MODULE */

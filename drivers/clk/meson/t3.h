...
//`define CLKCTRL_PWM_CLK_AO_AB_CTRL      10'h68
//`define CLKCTRL_PWM_CLK_AO_CD_CTRL      10'h69
//`define CLKCTRL_PWM_CLK_AO_EF_CTRL      10'h6A
//`define CLKCTRL_PWM_CLK_AO_GH_CTRL      10'h6B
...
#define CLKCTRL_HDMI_VID_PLL_CLK_DIV               (0x0081  << 2)
#define CLKCTRL_DEMOD_CLK_CNTL                     (0x0082  << 2)
#define CLKCTRL_DEMOD_CLK_CNTL1                    (0x0083  << 2)
#define CLKCTRL_DEMOD_32K_CNTL0                    (0x0084  << 2)
#define CLKCTRL_DEMOD_32K_CNTL1                    (0x0085  << 2)
#define CLKCTRL_ATV_DMD_SYS_CLK_CNTL               (0x0086  << 2)
#define CLKCTRL_TCON_CLK_CNTL                      (0x0087  << 2)
...
//`define CLKCTRL_EFUSE_ENCP_CFG0         10'h122
...
#define ANACTRL_DADC_CNTL                          (0x0090  << 2)
#define ANACTRL_DADC_CNTL2                         (0x0091  << 2)
#define ANACTRL_DADC_CNTL3                         (0x0092  << 2)
#define ANACTRL_DADC_CNTL4                         (0x0093  << 2)
#define ANACTRL_S2_DADC_CNTL                       (0x0094  << 2)
#define ANACTRL_S2_DADC_CNTL2                      (0x0095  << 2)
#define ANACTRL_DADC_RDBK0_I                       (0x0096  << 2)
#define ANACTRL_ADC_PLL_CNTL                       (0x0097  << 2)
#define ANACTRL_ADC_PLL_CNTL1                      (0x0098  << 2)
#define ANACTRL_ADC_PLL_CNTL2                      (0x0099  << 2)
#define ANACTRL_ADC_PLL_CNTL3                      (0x009a  << 2)
#define ANACTRL_ADC_PLL_CNTL4                      (0x009b  << 2)
#define ANACTRL_ADC_PLL_CNTL5                      (0x009c  << 2)
#define ANACTRL_ADC_PLL_CNTL6                      (0x009d  << 2)
#define ANACTRL_ADC_PLL_STS                        (0x009e  << 2)
#define ANACTRL_CVBS_DETECT_CNTL                   (0x009f  << 2)
#define ANACTRL_HDMIRX_AUD_PLL_CNTL                (0x00a0  << 2)
#define ANACTRL_HDMIRX_AUD_PLL_CNTL2               (0x00a1  << 2)
#define ANACTRL_HDMIRX_AUD_PLL_CNTL3               (0x00a2  << 2)
#define ANACTRL_HDMIRX_AUD_PLL_STS                 (0x00a3  << 2)
#define ANACTRL_HDMIRX_AUD_PLL4X_SCAN_CNTL         (0x00a4  << 2)
...
#define ANACTRL_DIF_PHY_CNTL1                      (0x00c8  << 2)
#define ANACTRL_DIF_PHY_CNTL2                      (0x00c9  << 2)
#define ANACTRL_DIF_PHY_CNTL3                      (0x00ca  << 2)
#define ANACTRL_DIF_PHY_CNTL4                      (0x00cb  << 2)
#define ANACTRL_DIF_PHY_CNTL5                      (0x00cc  << 2)
#define ANACTRL_DIF_PHY_CNTL6                      (0x00cd  << 2)
#define ANACTRL_DIF_PHY_CNTL7                      (0x00ce  << 2)
#define ANACTRL_DIF_PHY_CNTL8                      (0x00cf  << 2)
#define ANACTRL_DIF_PHY_CNTL9                      (0x00d0  << 2)
#define ANACTRL_DIF_PHY_CNTL10                     (0x00d1  << 2)
#define ANACTRL_DIF_PHY_CNTL11                     (0x00d2  << 2)
#define ANACTRL_DIF_PHY_CNTL12                     (0x00d3  << 2)
#define ANACTRL_DIF_PHY_CNTL13                     (0x00d4  << 2)
#define ANACTRL_DIF_PHY_CNTL14                     (0x00d5  << 2)
#define ANACTRL_DIF_PHY_CNTL15                     (0x00d6  << 2)
#define ANACTRL_DIF_PHY_CNTL16                     (0x00d7  << 2)
#define ANACTRL_DIF_PHY_CNTL17                     (0x00d8  << 2)
#define ANACTRL_DIF_PHY_CNTL18                     (0x00d9  << 2)
#define ANACTRL_DIF_PHY_CNTL19                     (0x00da  << 2)
#define ANACTRL_DIF_PHY_CNTL20                     (0x00db  << 2)
#define ANACTRL_DIF_PHY_CNTL21                     (0x00dc  << 2)
#define ANACTRL_TCON_PLL0_CNTL0                    (0x00e0  << 2)
#define ANACTRL_TCON_PLL0_CNTL1                    (0x00e1  << 2)
#define ANACTRL_TCON_PLL0_CNTL2                    (0x00e2  << 2)
#define ANACTRL_TCON_PLL0_CNTL3                    (0x00e3  << 2)
#define ANACTRL_TCON_PLL0_CNTL4                    (0x00e4  << 2)
#define ANACTRL_TCON_PLL1_CNTL0                    (0x00e5  << 2)
#define ANACTRL_TCON_PLL1_CNTL1                    (0x00e6  << 2)
#define ANACTRL_TCON_PLL1_CNTL2                    (0x00e7  << 2)
#define ANACTRL_TCON_PLL1_CNTL3                    (0x00e8  << 2)
#define ANACTRL_TCON_PLL1_CNTL4                    (0x00e9  << 2)
#define ANACTRL_TCON_PLL2_CNTL0                    (0x00ea  << 2)
#define ANACTRL_TCON_PLL2_CNTL1                    (0x00eb  << 2)
#define ANACTRL_TCON_PLL2_CNTL2                    (0x00ec  << 2)
#define ANACTRL_TCON_PLL2_CNTL3                    (0x00ed  << 2)
#define ANACTRL_TCON_PLL2_CNTL4                    (0x00ee  << 2)
#define ANACTRL_TCON_PLL0_STS                      (0x00ef  << 2)
#define ANACTRL_TCON_PLL1_STS                      (0x00f0  << 2)
#define ANACTRL_TCON_PLL2_STS                      (0x00f1  << 2)
#define ANACTRL_TCON_PLL_VLOCK                     (0x00f2  << 2)
//`define ANACTRL_DIF_PHY_STS       8'hf3
#define ANACTRL_LVDS_TX_PHY_CNTL0                  (0x00f4  << 2)
#define ANACTRL_LVDS_TX_PHY_CNTL1                  (0x00f5  << 2)
#define ANACTRL_LVDS_TX_PHY_CNTL2                  (0x00f6  << 2)
#define ANACTRL_LVDS_TX_PHY_CNTL3                  (0x00f7  << 2)
#define ANACTRL_VID_PLL_CLK_DIV                    (0x00f8  << 2)

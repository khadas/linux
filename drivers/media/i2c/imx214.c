...
#define IMX214_LINK_FREQ_FULL		600000000
#define IMX214_LINK_FREQ_BINNING		600000000
				   ...
				   struct i2c_client *client)
{
	...
	if (ret) {
		dev_err(dev, "imx214 Read chip ID register error\n");
	}
	if (id != CHIP_ID) {

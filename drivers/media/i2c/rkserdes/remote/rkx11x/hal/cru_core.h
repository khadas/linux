...
#ifndef __RKX11X_CRU_CORE_H__
#define __RKX11X_CRU_CORE_H__

#include "hal_def.h"
#include "hal_os_def.h"

#define RKX11X_DEBUG_CRU_INIT 0 /* debug cru clock tree when cru init */
#define RKX11X_CRU_LOGLEVEL   3

#define __cru_print(level, fmt, ...)                                        \
({                                                                          \
    level < RKX11X_CRU_LOGLEVEL ? HAL_SYSLOG("[HAL CRU] " fmt, ##__VA_ARGS__) : 0; \
})
...
/************************** chip ops *************************************/
extern struct clkOps rkx110_ser_clk_ops;
extern struct clkOps rkx111_ser_clk_ops;

#endif /* __RKX11X_CRU_CORE_H__ */

...
enum cif_reg_index {
	...
	CIF_REG_DVP_ID0_CTRL0,
	CIF_REG_DVP_ID0_CTRL1,
	CIF_REG_DVP_ID1_CTRL0,
	CIF_REG_DVP_ID1_CTRL1,
	CIF_REG_DVP_ID2_CTRL0,
	CIF_REG_DVP_ID2_CTRL1,
	CIF_REG_DVP_ID3_CTRL0,
	CIF_REG_DVP_ID3_CTRL1,
	CIF_REG_DVP_VLW_ID0,
	CIF_REG_DVP_VLW_ID1,
	CIF_REG_DVP_VLW_ID2,
	CIF_REG_DVP_VLW_ID3,
	CIF_REG_DVP_ID0_CROP_START,
	CIF_REG_DVP_ID1_CROP_START,
	CIF_REG_DVP_ID2_CROP_START,
	CIF_REG_DVP_ID3_CROP_START,
	CIF_REG_DVP_FRAME_NUM_ID0,
	CIF_REG_DVP_FRAME_NUM_ID1,
	CIF_REG_DVP_FRAME_NUM_ID2,
	CIF_REG_DVP_FRAME_NUM_ID3,
	CIF_REG_DVP_SET_SIZE_ID0,
	CIF_REG_DVP_SET_SIZE_ID1,
	CIF_REG_DVP_SET_SIZE_ID2,
	CIF_REG_DVP_SET_SIZE_ID3,
	CIF_REG_DVP_LINE_INT_NUM_ID0_1,
	CIF_REG_DVP_LINE_INT_NUM_ID2_3,
	CIF_REG_DVP_LINE_LINE_CNT_ID0_1,
	CIF_REG_DVP_LINE_LINE_CNT_ID2_3,
	CIF_REG_DVP_HIST_START,
	CIF_REG_DVP_HIST_SIZE,
	CIF_REG_DVP_HIST_SUM,
...
/* RV1126B DVP Registers Offset */
#define DVP_ID0_CTRL0_RV1126B			0x100
#define DVP_ID0_CTRL1_RV1126B			0x104
#define DVP_ID1_CTRL0_RV1126B			0x108
#define DVP_ID1_CTRL1_RV1126B			0x10C
#define DVP_ID2_CTRL0_RV1126B			0x110
#define DVP_ID2_CTRL1_RV1126B			0x114
#define DVP_ID3_CTRL0_RV1126B			0x118
#define DVP_ID3_CTRL1_RV1126B			0x11C
#define DVP_CTRL_RV1126B			0x120
#define DVP_FRM0_ADDR_Y_ID0_RV1126B		0x124
#define DVP_FRM1_ADDR_Y_ID0_RV1126B		0x128
#define DVP_FRM0_ADDR_UV_ID0_RV1126B		0x12C
#define DVP_FRM1_ADDR_UV_ID0_RV1126B		0x130
#define DVP_VLW_ID0_RV1126B			0x134
#define DVP_FRM0_ADDR_Y_ID1_RV1126B		0x138
#define DVP_FRM1_ADDR_Y_ID1_RV1126B		0x13C
#define DVP_FRM0_ADDR_UV_ID1_RV1126B		0x140
#define DVP_FRM1_ADDR_UV_ID1_RV1126B		0x144
#define DVP_VLW_ID1_RV1126B			0x148
#define DVP_FRM0_ADDR_Y_ID2_RV1126B		0x14C
#define DVP_FRM1_ADDR_Y_ID2_RV1126B		0x150
#define DVP_FRM0_ADDR_UV_ID2_RV1126B		0x154
#define DVP_FRM1_ADDR_UV_ID2_RV1126B		0x158
#define DVP_VLW_ID2_RV1126B			0x15C
#define DVP_FRM0_ADDR_Y_ID3_RV1126B		0x160
#define DVP_FRM1_ADDR_Y_ID3_RV1126B		0x164
#define DVP_FRM0_ADDR_UV_ID3_RV1126B		0x168
#define DVP_FRM1_ADDR_UV_ID3_RV1126B		0x16C
#define DVP_VLW_ID3_RV1126B			0x170
#define DVP_INTEN_RV1126B			0x174
#define DVP_INTSTAT_RV1126B			0x178
#define DVP_SAV_EAV_RV1126B			0x17C
#define DVP_ID0_CROP_START_RV1126B		0x190
#define DVP_ID1_CROP_START_RV1126B		0x194
#define DVP_ID2_CROP_START_RV1126B		0x198
#define DVP_ID3_CROP_START_RV1126B		0x19C
#define DVP_SET_FRAME_SIZE_ID0_RV1126B		0x1A0
#define DVP_SET_FRAME_SIZE_ID1_RV1126B		0x1A4
#define DVP_SET_FRAME_SIZE_ID2_RV1126B		0x1A8
#define DVP_SET_FRAME_SIZE_ID3_RV1126B		0x1AC
#define DVP_LINE_INT_NUM_ID0_1_RV1126B		0x1B0
#define DVP_LINE_INT_NUM_ID2_3_RV1126B		0x1B4
#define DVP_LINE_CNT_ID0_1_RV1126B		0x1B8
#define DVP_LINE_CNT_ID2_3_RV1126B		0x1BC
#define DVP_SET_FRAME_NUM_ID0_RV1126B		0x1C0
#define DVP_SET_FRAME_NUM_ID1_RV1126B		0x1C4
#define DVP_SET_FRAME_NUM_ID2_RV1126B		0x1C8
#define DVP_SET_FRAME_NUM_ID3_RV1126B		0x1CC
#define DVP_HIST_START_RV1126B			0x1D4
#define DVP_HIST_SIZE_RV1126B			0x1D8
#define DVP_HIST_SUM_RV1126B			0x1DC

/* RV1126B CSI Registers Offset */
#define CSI_MIPI0_ID0_CTRL0_RV1126B		0x200
#define CSI_MIPI0_ID0_CTRL1_RV1126B		0x204
#define CSI_MIPI0_ID1_CTRL0_RV1126B		0x208
#define CSI_MIPI0_ID1_CTRL1_RV1126B		0x20C
#define CSI_MIPI0_ID2_CTRL0_RV1126B		0x210
#define CSI_MIPI0_ID2_CTRL1_RV1126B		0x214
#define CSI_MIPI0_ID3_CTRL0_RV1126B		0x218
#define CSI_MIPI0_ID3_CTRL1_RV1126B		0x21C
#define CSI_MIPI0_CTRL_RV1126B			0x220
#define CSI_MIPI0_FRM0_ADDR_Y_ID0_RV1126B	0x224
#define CSI_MIPI0_FRM1_ADDR_Y_ID0_RV1126B	0x228
#define CSI_MIPI0_FRM0_ADDR_UV_ID0_RV1126B	0x22C
#define CSI_MIPI0_FRM1_ADDR_UV_ID0_RV1126B	0x230
#define CSI_MIPI0_VLW_ID0_RV1126B		0x234
#define CSI_MIPI0_FRM0_ADDR_Y_ID1_RV1126B	0x238
#define CSI_MIPI0_FRM1_ADDR_Y_ID1_RV1126B	0x23C
#define CSI_MIPI0_FRM0_ADDR_UV_ID1_RV1126B	0x240
#define CSI_MIPI0_FRM1_ADDR_UV_ID1_RV1126B	0x244
#define CSI_MIPI0_VLW_ID1_RV1126B		0x248
#define CSI_MIPI0_FRM0_ADDR_Y_ID2_RV1126B	0x24C
#define CSI_MIPI0_FRM1_ADDR_Y_ID2_RV1126B	0x250
#define CSI_MIPI0_FRM0_ADDR_UV_ID2_RV1126B	0x254
#define CSI_MIPI0_FRM1_ADDR_UV_ID2_RV1126B	0x258
#define CSI_MIPI0_VLW_ID2_RV1126B		0x25C
#define CSI_MIPI0_FRM0_ADDR_Y_ID3_RV1126B	0x260
#define CSI_MIPI0_FRM1_ADDR_Y_ID3_RV1126B	0x264
#define CSI_MIPI0_FRM0_ADDR_UV_ID3_RV1126B	0x268
#define CSI_MIPI0_FRM1_ADDR_UV_ID3_RV1126B	0x26C
#define CSI_MIPI0_VLW_ID3_RV1126B		0x270
#define CSI_MIPI0_INTEN_RV1126B			0x274
#define CSI_MIPI0_INTSTAT_RV1126B		0x278
#define CSI_MIPI0_ON_PAD_RV1126B		0x27C
#define CSI_MIPI0_EFFECT_CODE_ID0_RV1126B	0x280
#define CSI_MIPI0_EFFECT_CODE_ID1_RV1126B	0x284
#define CSI_MIPI0_EFFECT_CODE_ID2_RV1126B	0x288
#define CSI_MIPI0_EFFECT_CODE_ID3_RV1126B	0x28C
#define CSI_MIPI0_ID0_CROP_START_RV1126B	0x290
#define CSI_MIPI0_ID1_CROP_START_RV1126B	0x294
#define CSI_MIPI0_ID2_CROP_START_RV1126B	0x298
#define CSI_MIPI0_ID3_CROP_START_RV1126B	0x29C
#define CSI_MIPI0_SET_FRAME_SIZE_ID0_RV1126B	0x2A0
#define CSI_MIPI0_SET_FRAME_SIZE_ID1_RV1126B	0x2A4
#define CSI_MIPI0_SET_FRAME_SIZE_ID2_RV1126B	0x2A8
#define CSI_MIPI0_SET_FRAME_SIZE_ID3_RV1126B	0x2AC
#define CSI_MIPI0_LINE_INT_NUM_ID0_1_RV1126B	0x2B0
#define CSI_MIPI0_LINE_INT_NUM_ID2_3_RV1126B	0x2B4
#define CSI_MIPI0_LINE_CNT_ID0_1_RV1126B	0x2B8
#define CSI_MIPI0_LINE_CNT_ID2_3_RV1126B	0x2BC
#define CSI_MIPI0_FRAME_SIZE_ID0_RV1126B	0x2C0
#define CSI_MIPI0_FRAME_SIZE_ID1_RV1126B	0x2C4
#define CSI_MIPI0_FRAME_SIZE_ID2_RV1126B	0x2C8
#define CSI_MIPI0_FRAME_SIZE_ID3_RV1126B	0x2CC
#define CSI_MIPI0_FRAME_NUM_VC0_RV1126B		0x2D0
#define CSI_MIPI0_FRAME_NUM_VC1_RV1126B		0x2D4
#define CSI_MIPI0_FRAME_NUM_VC2_RV1126B		0x2D8
#define CSI_MIPI0_FRAME_NUM_VC3_RV1126B		0x2DC
#define CIF_LVDS_SAV_EAV_ACT0_ID0_RV1126B	0x3C0
#define CIF_LVDS_SAV_EAV_BLK0_ID0_RV1126B	0x3C4
#define CIF_LVDS_SAV_EAV_ACT1_ID0_RV1126B	0x3C8
#define CIF_LVDS_SAV_EAV_BLK1_ID0_RV1126B	0x3CC
#define CIF_LVDS_SAV_EAV_ACT0_ID1_RV1126B	0x3D0
#define CIF_LVDS_SAV_EAV_BLK0_ID1_RV1126B	0x3D4
#define CIF_LVDS_SAV_EAV_ACT1_ID1_RV1126B	0x3D8
#define CIF_LVDS_SAV_EAV_BLK1_ID1_RV1126B	0x3DC
#define CIF_LVDS_SAV_EAV_ACT0_ID2_RV1126B	0x3E0
#define CIF_LVDS_SAV_EAV_BLK0_ID2_RV1126B	0x3E4
#define CIF_LVDS_SAV_EAV_ACT1_ID2_RV1126B	0x3E8
#define CIF_LVDS_SAV_EAV_BLK1_ID2_RV1126B	0x3EC
#define CIF_LVDS_SAV_EAV_ACT0_ID3_RV1126B	0x3F0
#define CIF_LVDS_SAV_EAV_BLK0_ID3_RV1126B	0x3F4
#define CIF_LVDS_SAV_EAV_ACT1_ID3_RV1126B	0x3F8
#define CIF_LVDS_SAV_EAV_BLK1_ID3_RV1126B	0x3FC
#define SCL_CTRL_RV1126B			0x040
#define SCL_FRM0_ADDR_CH0_RV1126B		0x044
#define SCL_FRM1_ADDR_CH0_RV1126B		0x048
#define SCL_VLW_CH0_RV1126B			0x04C
#define SCL_BLC_CH0_RV1126B			0x050
#define TOISP0_CH_CTRL_RV1126B			0x0A0
#define TOISP0_CROP_SIZE_RV1126B		0x0A4
#define TOISP0_CROP_RV1126B			0x0A8
#define TOISP0_CH1_CTRL_RV1126B			0x0B0
#define TOISP0_CH1_CROP_SIZE_RV1126B		0x0B4
#define TOISP0_CH1_CROP_RV1126B			0x0B8

#define MIPI0_WORK_RV1126B			BIT(20)
#define MIPI1_WORK_RV1126B			BIT(21)
#define MIPI2_WORK_RV1126B			BIT(22)
#define MIPI3_WORK_RV1126B			BIT(23)
#define LVDS_PATH_EN_RV1126B			BIT(4)
#define DMA_ADAPT_EN_RV1126B			BIT(22)
#define LVDS_MODE_RV1126B(mode)			(((mode) & 0x7) << 24)
#define LVDS_FID_RV1126B(id)			(((id) & 0x3) << 28)
#define SKIP_FRM_MASK_RV1126B			(0xf << 24)
#define SKIP_FRM_OFFSET_RV1126B			(24)
#define CIF_SCALE_EN_RV1126B			(BIT(0))
#define SCALE_SOFT_RESET_RV1126B		(0x2 << 16)
#define CIF_SCALE_SW_WATER_LINE_RV1126B(val)	(val << 20)
#define CIF_SCALE_DMA_EN_RV1126B		(1 << 1)
#define CIF_SCALE_SW_SRC_RV1126B(val)		((val & 0x1f) << 9)
#define CIF_SCALE_SW_MODE_RV1126B(val)		((val & 0x3) << 4)
#define INPUT_BT601_RV1126B			(0x00 << 1)
#define INPUT_BT656_RV1126B			(0x01 << 1)
#define INPUT_BT1120_RV1126B			(0x02 << 1)
#define INPUT_SONY_RAW_RV1126B			(0x03 << 1)
#define BT1120_CLOCK_SINGLE_EDGES_RV1126B	(0x00 << 3)
#define BT1120_CLOCK_DOUBLE_EDGES_RV1126B	(0x01 << 3)
#define	CIF_IO_HIGH_ALIGN_RV1126B		(0x01 << 4)
#define BT1120_YC_SWAP_RV1126B			(0x01 << 5)
#define BT656_1120_MULTI_ID_DISABLE_RV1126B	(0x00 << 12)
#define BT656_1120_MULTI_ID_ENABLE_RV1126B	(0x01 << 12)
#define BT656_1120_MULTI_ID_SEL_MSB_RV1126B	(0x00 << 13)
#define BT656_1120_MULTI_ID_SEL_LSB_RV1126B	(0x01 << 13)
#define BT656_1120_MULTI_ID_MODE_1_RV1126B	(0x00 << 14)
#define BT656_1120_MULTI_ID_MODE_2_RV1126B	(0x01 << 14)
#define BT656_1120_MULTI_ID_MODE_4_RV1126B	(0x02 << 14)
#define DVP_SW_WATER_LINE_75_RV1126B		(0x0 << 20)
#define DVP_SW_WATER_LINE_50_RV1126B		(0x1 << 20)
#define DVP_SW_WATER_LINE_25_RV1126B		(0x2 << 20)
#define DVP_SW_WATER_LINE_00_RV1126B		(0x3 << 20)
#define GRF_VICIF_M0_CON_RV1126B		(0x38B94)
#define GRF_VICIF_M1_CON_RV1126B		(0x30B98)
...
#define RV1126B_CIF_PCLK_SAMPLING_EDGE_RISING	(0x01000000)
#define RV1126B_CIF_PCLK_SAMPLING_EDGE_FALLING	(0x01000100)

...
static int rkvpss_stream_crop_ch4_5(struct rkvpss_stream *stream, bool on, bool sync);
...
static const struct capture_fmt scl2_3_4_5_fmts[] = {
	{
		.fourcc = V4L2_PIX_FMT_NV16,
		.fmt_type = FMT_YUV,
		.bpp = { 8, 16 },
...
static struct stream_config scl0_config = {
	...
	.scale = {
		.ctrl = RKVPSS2X_SCALE0_CTRL,
		.update = RKVPSS2X_SCALE0_UPDATE,
		.src_size = RKVPSS2X_SCALE0_SRC_SIZE,
		.dst_size = RKVPSS2X_SCALE0_DST_SIZE,
		.hy_fac = RKVPSS2X_SCALE0_HY_FAC,
		.hc_fac = RKVPSS2X_SCALE0_HC_FAC,
		.vy_fac = RKVPSS2X_SCALE0_VY_FAC,
		.vc_fac = RKVPSS2X_SCALE0_VC_FAC,
		.hy_offs = RKVPSS2X_SCALE0_HY_OFFS,
		...
		.hc_offs_mi = RKVPSS2X_SCALE0_HC_OFFS_MI,
		.in_crop_offs = RKVPSS2X_SCALE0_IN_CROP_OFFSET,
		.ctrl_shd = RKVPSS2X_SCALE0_CTRL_SHD,
		.src_size_shd = RKVPSS2X_SCALE0_SRC_SIZE_SHD,
		.dst_size_shd = RKVPSS2X_SCALE0_DST_SIZE_SHD,
		.hy_fac_shd = RKVPSS2X_SCALE0_HY_FAC_SHD,
		.hc_fac_shd = RKVPSS2X_SCALE0_HC_FAC_SHD,
		.vy_fac_shd = RKVPSS2X_SCALE0_VY_FAC_SHD,
		.vc_fac_shd = RKVPSS2X_SCALE0_VC_FAC_SHD,
		.hy_offs_shd = RKVPSS2X_SCALE0_HY_OFFS_SHD,
		...
		.hc_offs_mi_shd = RKVPSS2X_SCALE0_HC_OFFS_MI_SHD,
		.in_crop_offs_shd = RKVPSS2X_SCALE0_IN_CROP_OFFSET_SHD,
	},
	.mi = {
...
static struct stream_config scl2_config = {
	.fmts = scl2_3_4_5_fmts,
	.fmt_size = ARRAY_SIZE(scl2_3_4_5_fmts),
...
static struct stream_config scl4_config = {
	.fmts = scl2_3_4_5_fmts,
	.fmt_size = ARRAY_SIZE(scl2_3_4_5_fmts),
	.frame_end_id = RKVPSS2X_MI_CHN4_FRM_END,
	.crop = {
		.ctrl = RKVPSS_CROP1_CTRL,
		.update = RKVPSS_CROP1_UPDATE,
		.ch_4_5_offs = RKVPSS2X_CROP1_4_OFFS,
		.ch_4_5_size = RKVPSS2X_CROP1_4_SIZE,
		.ch_4_5_offs_shd = RKVPSS2X_CROP1_4_OFFS_SHD,
		.ch_4_5_size_shd = RKVPSS2X_CROP1_4_SIZE_SHD,
	},
	.scale = {
		.ctrl = RKVPSS2X_SCALE4_CTRL,
		.update = RKVPSS2X_SCALE4_UPDATE,
		.src_size = RKVPSS2X_SCALE4_SRC_SIZE,
		.dst_size = RKVPSS2X_SCALE4_DST_SIZE,
		.hy_fac = RKVPSS2X_SCALE4_HY_FAC,
		.hc_fac = RKVPSS2X_SCALE4_HC_FAC,
		.vy_fac = RKVPSS2X_SCALE4_VY_FAC,
		.vc_fac = RKVPSS2X_SCALE4_VC_FAC,
		.hy_offs = RKVPSS2X_SCALE4_HY_OFFS,
		.hc_offs = RKVPSS2X_SCALE4_HC_OFFS,
		.vy_offs = RKVPSS2X_SCALE4_VY_OFFS,
		.vc_offs = RKVPSS2X_SCALE4_VC_OFFS,
		.hy_size = RKVPSS2X_SCALE4_HY_SIZE,
		.hc_size = RKVPSS2X_SCALE4_HC_SIZE,
		.hy_offs_mi = RKVPSS2X_SCALE4_HY_OFFS_MI,
		.hc_offs_mi = RKVPSS2X_SCALE4_HC_OFFS_MI,
		.in_crop_offs = RKVPSS2X_SCALE4_IN_CROP_OFFSET,
		.ctrl_shd = RKVPSS2X_SCALE4_CTRL_SHD,
		.src_size_shd = RKVPSS2X_SCALE4_SRC_SIZE_SHD,
		.dst_size_shd = RKVPSS2X_SCALE4_DST_SIZE_SHD,
		.hy_fac_shd = RKVPSS2X_SCALE4_HY_FAC_SHD,
		.hc_fac_shd = RKVPSS2X_SCALE4_HC_FAC_SHD,
		.vy_fac_shd = RKVPSS2X_SCALE4_VY_FAC_SHD,
		.vc_fac_shd = RKVPSS2X_SCALE4_VC_FAC_SHD,
		.hy_offs_shd = RKVPSS2X_SCALE4_HY_OFFS_SHD,
		.hc_offs_shd = RKVPSS2X_SCALE4_HC_OFFS_SHD,
		.vy_offs_shd = RKVPSS2X_SCALE4_VY_OFFS_SHD,
		.vc_offs_shd = RKVPSS2X_SCALE4_VC_OFFS_SHD,
		.hy_size_shd = RKVPSS2X_SCALE4_HY_SIZE_SHD,
		.hc_size_shd = RKVPSS2X_SCALE4_HC_SIZE_SHD,
		.hy_offs_mi_shd = RKVPSS2X_SCALE4_HY_OFFS_MI_SHD,
		.hc_offs_mi_shd = RKVPSS2X_SCALE4_HC_OFFS_MI_SHD,
		.in_crop_offs_shd = RKVPSS2X_SCALE4_IN_CROP_OFFSET_SHD,
	},
	.mi = {
		.ctrl = RKVPSS2X_MI_CHN4_WR_CTRL,
		.stride = RKVPSS2X_MI_CHN4_WR_Y_STRIDE,
		.y_base = RKVPSS2X_MI_CHN4_WR_Y_BASE,
		.uv_base = RKVPSS2X_MI_CHN4_WR_CB_BASE,
		.y_size = RKVPSS2X_MI_CHN4_WR_Y_SIZE,
		.uv_size = RKVPSS2X_MI_CHN4_WR_CB_SIZE,
		.y_offs_cnt = RKVPSS2X_MI_CHN4_WR_Y_OFFS_CNT,
		.uv_offs_cnt = RKVPSS2X_MI_CHN4_WR_CB_OFFS_CNT,
		.y_pic_width = RKVPSS2X_MI_CHN4_WR_Y_PIC_WIDTH,
		.y_pic_size = RKVPSS2X_MI_CHN4_WR_Y_PIC_SIZE,
...
static struct stream_config scl5_config = {
	.fmts = scl2_3_4_5_fmts,
	.fmt_size = ARRAY_SIZE(scl2_3_4_5_fmts),
	.frame_end_id = RKVPSS2X_MI_CHN5_FRM_END,
	.crop = {
		.ctrl = RKVPSS_CROP1_CTRL,
		.update = RKVPSS_CROP1_UPDATE,
		.ch_4_5_offs = RKVPSS2X_CROP1_5_OFFS,
		.ch_4_5_size = RKVPSS2X_CROP1_5_SIZE,
		.ch_4_5_offs_shd = RKVPSS2X_CROP1_5_OFFS_SHD,
		.ch_4_5_size_shd = RKVPSS2X_CROP1_5_SIZE_SHD,
	},
	.scale = {
		.ctrl = RKVPSS2X_SCALE5_CTRL,
		.update = RKVPSS2X_SCALE5_UPDATE,
		.src_size = RKVPSS2X_SCALE5_SRC_SIZE,
		.dst_size = RKVPSS2X_SCALE5_DST_SIZE,
		.hy_fac = RKVPSS2X_SCALE5_HY_FAC,
		.hc_fac = RKVPSS2X_SCALE5_HC_FAC,
		.vy_fac = RKVPSS2X_SCALE5_VY_FAC,
		.vc_fac = RKVPSS2X_SCALE5_VC_FAC,
		.hy_offs = RKVPSS2X_SCALE5_HY_OFFS,
		.hc_offs = RKVPSS2X_SCALE5_HC_OFFS,
		.vy_offs = RKVPSS2X_SCALE5_VY_OFFS,
		.vc_offs = RKVPSS2X_SCALE5_VC_OFFS,
		.hy_size = RKVPSS2X_SCALE5_HY_SIZE,
		.hc_size = RKVPSS2X_SCALE5_HC_SIZE,
		.hy_offs_mi = RKVPSS2X_SCALE5_HY_OFFS_MI,
		.hc_offs_mi = RKVPSS2X_SCALE5_HC_OFFS_MI,
		.in_crop_offs = RKVPSS2X_SCALE5_IN_CROP_OFFSET,
		.ctrl_shd = RKVPSS2X_SCALE5_CTRL_SHD,
		.src_size_shd = RKVPSS2X_SCALE5_SRC_SIZE_SHD,
		.dst_size_shd = RKVPSS2X_SCALE5_DST_SIZE_SHD,
		.hy_fac_shd = RKVPSS2X_SCALE5_HY_FAC_SHD,
		.hc_fac_shd = RKVPSS2X_SCALE5_HC_FAC_SHD,
		.vy_fac_shd = RKVPSS2X_SCALE5_VY_FAC_SHD,
		.vc_fac_shd = RKVPSS2X_SCALE5_VC_FAC_SHD,
		.hy_offs_shd = RKVPSS2X_SCALE5_HY_OFFS_SHD,
		.hc_offs_shd = RKVPSS2X_SCALE5_HC_OFFS_SHD,
		.vy_offs_shd = RKVPSS2X_SCALE5_VY_OFFS_SHD,
		.vc_offs_shd = RKVPSS2X_SCALE5_VC_OFFS_SHD,
		.hy_size_shd = RKVPSS2X_SCALE5_HY_SIZE_SHD,
		.hc_size_shd = RKVPSS2X_SCALE5_HC_SIZE_SHD,
		.hy_offs_mi_shd = RKVPSS2X_SCALE5_HY_OFFS_MI_SHD,
		.hc_offs_mi_shd = RKVPSS2X_SCALE5_HC_OFFS_MI_SHD,
		.in_crop_offs_shd = RKVPSS2X_SCALE5_IN_CROP_OFFSET_SHD,
	},
	.mi = {
		.ctrl = RKVPSS2X_MI_CHN5_WR_CTRL,
		.stride = RKVPSS2X_MI_CHN5_WR_Y_STRIDE,
		.y_base = RKVPSS2X_MI_CHN5_WR_Y_BASE,
		.uv_base = RKVPSS2X_MI_CHN5_WR_CB_BASE,
		.y_size = RKVPSS2X_MI_CHN5_WR_Y_SIZE,
		.uv_size = RKVPSS2X_MI_CHN5_WR_CB_SIZE,
		.y_offs_cnt = RKVPSS2X_MI_CHN5_WR_Y_OFFS_CNT,
...
static void scl_config_mi(struct rkvpss_stream *stream)
{
	...
	/* argb alpha value */
	if (stream->id == RKVPSS_OUTPUT_CH1 &&
	    (fmt->fourcc == V4L2_PIX_FMT_XBGR32 || fmt->fourcc == V4L2_PIX_FMT_XRGB32))
		val |= RKVPSS2X_CH1_WR_RGB888_ALPHA(stream->alpha);
...
static void scl_enable_mi(struct rkvpss_stream *stream)
{
	...
	case RKVPSS_OUTPUT_CH3:
		...
		break;
	case RKVPSS_OUTPUT_CH4:
		val = RKVPSS2X_ISP2VPSS_CHN4_SEL(2);
		mask = RKVPSS2X_ISP2VPSS_CHN4_SEL(3);
		break;
	case RKVPSS_OUTPUT_CH5:
		val = RKVPSS2X_ISP2VPSS_CHN5_SEL(2);
		mask = RKVPSS2X_ISP2VPSS_CHN5_SEL(3);
		break;
	default:
		return;
	}
...
static void rkvpss_frame_end(struct rkvpss_stream *stream)
{
	...
	if (buf) {
		...
		if (vb2_buf->memory)
			...
			rkvpss_rockit_buf_done(stream, ROCKIT_DVBM_END, buf);
...
static int rkvpss_stream_crop_ch4_5(struct rkvpss_stream *stream, bool on, bool sync)
{
	...
	u32 reg_ch4_5_offs = stream->config->crop.ch_4_5_offs;
	u32 reg_ch4_5_size = stream->config->crop.ch_4_5_size;
	u32 val;
...
static void average_scale_down(struct rkvpss_stream *stream, bool on, bool sync)
{
	...
	if (in_w == out_w && in_h == out_h)
		rkvpss_unite_clear_bits(dev, RKVPSS_VPSS_CLK_GATE, clk_mask);
	else
...
static int rkvpss_start_streaming(struct vb2_queue *queue, unsigned int count)
{
	...
	stream->rockit_on = true;
	stream->dbg.id = -1;
	stream->dbg.frameloss = 0;
	v4l2_dbg(1, rkvpss_debug, &dev->v4l2_dev,
		 "%s %s id:%d exit\n", __func__,
		 node->vdev.name, stream->id);
	mutex_unlock(&hw->dev_lock);
			  ...
			  bool try)
{
	...
	if (fmt->fourcc == V4L2_PIX_FMT_TILE420 || fmt->fourcc == V4L2_PIX_FMT_TILE422) {
		if ((stream->id == 0) &&
		    dev->stream_vdev.stream[1].streaming &&
		...
		if ((stream->id == 1) &&
		    dev->stream_vdev.stream[0].streaming &&
...
struct rockit_vpss_ops rockit_vpss_ops = {
	.rkvpss_stream_start = rkvpss_stream_start,
	.rkvpss_stream_stop = rkvpss_stream_stop,
	.rkvpss_set_fmt = rkvpss_set_fmt,
};
			       ...
			       int unite_index)
{
	...
	if (ctrl) {
		ctrl |= RKVPSS_CMSC_EN;
		ctrl |= RKVPSS2X_CMSC_BLK_SIZE(cfg->mosaic_block);
	}
...
static int rkvpss_get_wrap_line(struct rkvpss_stream *stream, int *wrap_line)
{
...
static int rkvpss_set_wrap_line(struct rkvpss_stream *stream, int *wrap_line)
{
	struct rkvpss_device *vpss_dev = stream->dev;
				 ...
				 bool valid_prio, unsigned int cmd, void *arg)
{
	...
	case RKVPSS_CMD_STREAM_ATTACH_INFO:
		...
		break;
	case RKVPSS_CMD_GET_WRAP_LINE:
		ret = rkvpss_get_wrap_line(stream, arg);
		break;
	case RKVPSS_CMD_SET_WRAP_LINE:
		ret = rkvpss_set_wrap_line(stream, arg);
		break;
	case RKVPSS_CMD_GET_ALPHA:
		*(int *)arg = stream->alpha;
		break;
	case RKVPSS_CMD_SET_ALPHA:
		stream->alpha = *(int *)arg;
		break;
	case RKVPSS_CMD_GET_AVG_SCL_DOWN:
		if (stream->avg_scl_down)
			*(int *)arg = 1;
		else
			*(int *)arg = 0;
		break;
	case RKVPSS_CMD_SET_AVG_SCL_DOWN:
		stream->avg_scl_down = !!*(int *)arg;
		break;
	default:
		ret = -EINVAL;
	}
...
int rkvpss_register_stream_vdevs_v20(struct rkvpss_device *dev)
{
	...
	for (i = 0; i < RKVPSS_OUT_V20_MAX; i++) {
		...
		case RKVPSS_OUTPUT_CH3:
			...
			break;
		case RKVPSS_OUTPUT_CH4:
			vdev_name = S4_VDEV_NAME;
			stream->ops = &scl_stream_ops;
			stream->config = &scl4_config;
			break;
		case RKVPSS_OUTPUT_CH5:
			vdev_name = S5_VDEV_NAME;
			stream->ops = &scl_stream_ops;
			stream->config = &scl5_config;
			break;
		default:
...
void rkvpss_mi_isr_v20(struct rkvpss_device *dev, u32 mis_val)
{
	...
	rkvpss_check_idle(dev, (((ris & 0xf) << 3)) | ((ris >> 9) & 0x180));
}

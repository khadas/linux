...
target_defconfig=meson64_a64_U_defconfig
...
export PATH=/opt/clang-r487747c/bin/:/opt/gcc-linaro-6.3.1-2017.02-x86_64_aarch64-linux-gnu/bin/:$PATH
...
if [ $target_defconfig != meson64_a64_U_defconfig ];then
	exit 0;
fi

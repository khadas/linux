...
#define CLKID_SMARTCARD				(GATE_BASE0 + 9)
#define CLKID_UART0				(GATE_BASE0 + 10)
#define CLKID_STREAM				(GATE_BASE0 + 11)
#define CLKID_ASYNC_FIFO			(GATE_BASE0 + 12)
#define CLKID_TVFE				(GATE_BASE0 + 13)
#define CLKID_HIU_REG				(GATE_BASE0 + 14)
#define CLKID_HDMIRX_PCLK			(GATE_BASE0 + 15)
#define CLKID_ATV_DEMOD				(GATE_BASE0 + 16)
#define CLKID_ASSIST_MISC			(GATE_BASE0 + 17)
#define CLKID_PWR_CTRL				(GATE_BASE0 + 18)
#define CLKID_SD_EMMC_C				(GATE_BASE0 + 19)
#define CLKID_ADEC				(GATE_BASE0 + 20)
#define CLKID_ACODEC				(GATE_BASE0 + 21)
#define CLKID_TCON				(GATE_BASE0 + 22)
...
#define CLKID_RANDOM				(GATE_OTHER + 11)

...
#ifndef __A4_AUDIO_CLK_H__
#define __A4_AUDIO_CLK_H__
...
#define CLKID_AUDIO_GATE_RESAMPLEB              14
...
/* Audio2 CLK Gate En0 */
#define CLKID_AUDIO2_GATE_DDR_ARB               16
#define CLKID_AUDIO2_GATE_PDM                   17
#define CLKID_AUDIO2_GATE_TDMINC                18
#define CLKID_AUDIO2_GATE_TODDRC                19
#define CLKID_AUDIO2_GATE_TOVAD                 20
#define CLKID_AUDIO2_GATE_CLKRST                21
#define CLKID_AUDIO2_GATE_LRQFIFOCNT1           22
#define CLKID_AUDIO2_GATE_LRQFIFOCNT2           23

#define CLKID_AUDIO2_GATE_MAX        24
...
/* AUDIO TOP VAD */
#define CLKID_AUDIO2_MCLK_VAD        (MCLK_BASE + 17)
#define CLKID_AUDIO2_VAD_CLK         (MCLK_BASE + 18)
#define CLKID_AUDIO2_PDM_DCLK        (MCLK_BASE + 19)
#define CLKID_AUDIO2_PDM_SYSCLK      (MCLK_BASE + 20)

#define NUM_AUDIO_CLKS                          (MCLK_BASE + 21)
#endif /* __A4_AUDIO_CLK_H__ */

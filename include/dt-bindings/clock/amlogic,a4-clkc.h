...
#define CLKID_VOUT_MCLK_SEL		(CLKID_BASE + 73)
#define CLKID_VOUT_MCLK_DIV		(CLKID_BASE + 74)
#define CLKID_VOUT_MCLK			(CLKID_BASE + 75)
#define CLKID_VOUT_VENC_MCLK_SEL	(CLKID_BASE + 76)
#define CLKID_VOUT_VENC_MCLK_DIV	(CLKID_BASE + 77)
#define CLKID_VOUT_VENC_MCLK		(CLKID_BASE + 78)
#define CLKID_AUDIO_CORE_SEL		(CLKID_BASE + 79)
#define CLKID_AUDIO_CORE_DIV		(CLKID_BASE + 80)
#define CLKID_AUDIO_CORE		(CLKID_BASE + 81)

#define CLKID_SYS_CLK_EN		(CLKID_BASE + 82)

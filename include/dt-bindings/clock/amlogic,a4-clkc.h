...
#define CLKID_MPLL_50M			(CLKID_PLL_BASE + 16)
#define CLKID_GP0_PLL_DCO		(CLKID_PLL_BASE + 17)
#define CLKID_GP0_PLL			(CLKID_PLL_BASE + 18)
#define CLKID_GP1_PLL_DCO		(CLKID_PLL_BASE + 19)
#define CLKID_GP1_PLL			(CLKID_PLL_BASE + 20)
#define CLKID_HIFI_PLL_DCO		(CLKID_PLL_BASE + 21)
#define CLKID_HIFI_PLL			(CLKID_PLL_BASE + 22)

#define CLKID_CPU_BASE			(CLKID_PLL_BASE  + 23)
...
#define CLKID_AXI_CLK_1_SEL		(CLKID_BASE + 12)
#define CLKID_AXI_CLK_1_DIV		(CLKID_BASE + 13)
#define CLKID_AXI_CLK_1			(CLKID_BASE + 14)
#define CLKID_AXI_CLK_0_SEL		(CLKID_BASE + 15)
#define CLKID_AXI_CLK_0_DIV		(CLKID_BASE + 16)
#define CLKID_AXI_CLK_0			(CLKID_BASE + 17)
#define CLKID_AXI_CLK			(CLKID_BASE + 18)
#define CLKID_RAMA_CLK_1_SEL		(CLKID_BASE + 19)
#define CLKID_RAMA_CLK_1_DIV		(CLKID_BASE + 20)
#define CLKID_RAMA_CLK_1		(CLKID_BASE + 21)
#define CLKID_RAMA_CLK_0_SEL		(CLKID_BASE + 22)
#define CLKID_RAMA_CLK_0_DIV		(CLKID_BASE + 23)
#define CLKID_RAMA_CLK_0		(CLKID_BASE + 24)
#define CLKID_RAMA_CLK			(CLKID_BASE + 25)
#define CLKID_24M_CLK_GATE		(CLKID_BASE + 26)
#define CLKID_12M_CLK_DIV		(CLKID_BASE + 27)
#define CLKID_12M_CLK_GATE		(CLKID_BASE + 28)
#define CLKID_25M_CLK_DIV		(CLKID_BASE + 29)
#define CLKID_25M_CLK_GATE		(CLKID_BASE + 30)
#define CLKID_ETH_RMII_SEL		(CLKID_BASE + 31)
#define CLKID_ETH_RMII_DIV		(CLKID_BASE + 32)
#define CLKID_ETH_RMII			(CLKID_BASE + 33)
#define CLKID_ETH_DIV8			(CLKID_BASE + 34)
#define CLKID_ETH_125M			(CLKID_BASE + 35)
#define CLKID_TS_CLK_DIV		(CLKID_BASE + 36)
#define CLKID_TS_CLK			(CLKID_BASE + 37)
#define CLKID_SD_EMMC_C_CLK_SEL		(CLKID_BASE + 38)
#define CLKID_SD_EMMC_C_CLK_DIV		(CLKID_BASE + 39)
#define CLKID_SD_EMMC_C_CLK		(CLKID_BASE + 40)
#define CLKID_SD_EMMC_A_CLK_SEL		(CLKID_BASE + 41)
#define CLKID_SD_EMMC_A_CLK_DIV		(CLKID_BASE + 42)
#define CLKID_SD_EMMC_A_CLK		(CLKID_BASE + 43)
#define CLKID_SPICC0_SEL		(CLKID_BASE + 44)
#define CLKID_SPICC0_DIV		(CLKID_BASE + 45)
#define CLKID_SPICC0			(CLKID_BASE + 46)
#define CLKID_SPICC1_SEL		(CLKID_BASE + 47)
#define CLKID_SPICC1_DIV		(CLKID_BASE + 48)
#define CLKID_SPICC1			(CLKID_BASE + 49)
#define CLKID_PWM_A_SEL			(CLKID_BASE + 50)
#define CLKID_PWM_A_DIV			(CLKID_BASE + 51)
#define CLKID_PWM_A			(CLKID_BASE + 52)
#define CLKID_PWM_B_SEL			(CLKID_BASE + 53)
#define CLKID_PWM_B_DIV			(CLKID_BASE + 54)
#define CLKID_PWM_B			(CLKID_BASE + 55)
#define CLKID_PWM_C_SEL			(CLKID_BASE + 56)
#define CLKID_PWM_C_DIV			(CLKID_BASE + 57)
#define CLKID_PWM_C			(CLKID_BASE + 58)
#define CLKID_PWM_D_SEL			(CLKID_BASE + 59)
#define CLKID_PWM_D_DIV			(CLKID_BASE + 60)
#define CLKID_PWM_D			(CLKID_BASE + 61)
#define CLKID_PWM_E_SEL			(CLKID_BASE + 62)
#define CLKID_PWM_E_DIV			(CLKID_BASE + 63)
#define CLKID_PWM_E			(CLKID_BASE + 64)
#define CLKID_PWM_F_SEL			(CLKID_BASE + 65)
#define CLKID_PWM_F_DIV			(CLKID_BASE + 66)
#define CLKID_PWM_F			(CLKID_BASE + 67)
#define CLKID_PWM_G_SEL			(CLKID_BASE + 68)
#define CLKID_PWM_G_DIV			(CLKID_BASE + 69)
#define CLKID_PWM_G			(CLKID_BASE + 70)
#define CLKID_PWM_H_SEL			(CLKID_BASE + 71)
#define CLKID_PWM_H_DIV			(CLKID_BASE + 72)
#define CLKID_PWM_H			(CLKID_BASE + 73)
#define CLKID_SARADC_SEL		(CLKID_BASE + 74)
#define CLKID_SARADC_DIV		(CLKID_BASE + 75)
#define CLKID_SARADC			(CLKID_BASE + 76)
#define CLKID_GEN_SEL			(CLKID_BASE + 77)
#define CLKID_GEN_DIV			(CLKID_BASE + 78)
#define CLKID_GEN			(CLKID_BASE + 79)
#define CLKID_VOUT_MCLK_SEL		(CLKID_BASE + 80)
#define CLKID_VOUT_MCLK_DIV		(CLKID_BASE + 81)
#define CLKID_VOUT_MCLK			(CLKID_BASE + 82)
#define CLKID_VOUT_VENC_MCLK_SEL	(CLKID_BASE + 83)
#define CLKID_VOUT_VENC_MCLK_DIV	(CLKID_BASE + 84)
#define CLKID_VOUT_VENC_MCLK		(CLKID_BASE + 85)
#define CLKID_AUDIO_CORE_SEL		(CLKID_BASE + 86)
#define CLKID_AUDIO_CORE_DIV		(CLKID_BASE + 87)
#define CLKID_AUDIO_CORE		(CLKID_BASE + 88)

#define CLKID_SYS_CLK_EN		(CLKID_BASE + 89)

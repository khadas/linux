...
#ifndef __T7_AUDIO_CLK_H__
#define __T7_AUDIO_CLK_H__
...
#define CLKID_AUDIO_GATE_PDM_B                  41
#define CLKID_AUDIO_GATE_TDMINLB_B              42
#define CLKID_AUDIO_GATE_TDMIND                 43
#define CLKID_AUDIO_GATE_TDMOUTD                44

#define CLKID_AUDIO_GATE_MAX                    45
...
#define CLKID_AUDIO_PDMIN2                      (MCLK_BASE + 25)
#define CLKID_AUDIO_PDMIN3                      (MCLK_BASE + 26)
#define NUM_AUDIO_CLKS                          (MCLK_BASE + 27)

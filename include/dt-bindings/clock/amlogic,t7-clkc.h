...
#define CLKID_CPU1_CLK			(CLKID_CPU_BASE + 8)
#define CLKID_CPU2_CLK			(CLKID_CPU_BASE + 9)
#define CLKID_CPU3_CLK			(CLKID_CPU_BASE + 10)

#define CLKID_PLL1_BASE			(CLKID_CPU_BASE + 11)
...
#define CLKID_BASE			(CLKID_PLL1_BASE + 20)
...
#define CLKID_SPICC0_MUX		(PERI_BASE + 36)
#define CLKID_SPICC0_DIV		(PERI_BASE + 37)
#define CLKID_SPICC0_GATE		(PERI_BASE + 38)
#define CLKID_SPICC1_MUX		(PERI_BASE + 39)
#define CLKID_SPICC1_DIV		(PERI_BASE + 40)
#define CLKID_SPICC1_GATE		(PERI_BASE + 41)
#define CLKID_SPICC2_MUX		(PERI_BASE + 42)
#define CLKID_SPICC2_DIV		(PERI_BASE + 43)
#define CLKID_SPICC2_GATE		(PERI_BASE + 44)
#define CLKID_SPICC3_MUX		(PERI_BASE + 45)
#define CLKID_SPICC3_DIV		(PERI_BASE + 46)
#define CLKID_SPICC3_GATE		(PERI_BASE + 47)
#define CLKID_SPICC4_MUX		(PERI_BASE + 48)
#define CLKID_SPICC4_DIV		(PERI_BASE + 49)
#define CLKID_SPICC4_GATE		(PERI_BASE + 50)
#define CLKID_SPICC5_MUX		(PERI_BASE + 51)
#define CLKID_SPICC5_DIV		(PERI_BASE + 52)
#define CLKID_SPICC5_GATE		(PERI_BASE + 53)
#define CLKID_SD_EMMC_C_CLK_MUX		(PERI_BASE + 54)
#define CLKID_SD_EMMC_C_CLK_DIV		(PERI_BASE + 56)
#define CLKID_SD_EMMC_C_CLK		(PERI_BASE + 57)
#define CLKID_SD_EMMC_A_CLK_MUX		(PERI_BASE + 58)
#define CLKID_SD_EMMC_A_CLK_DIV		(PERI_BASE + 59)
#define CLKID_SD_EMMC_A_CLK		(PERI_BASE + 60)
#define CLKID_SD_EMMC_B_CLK_MUX		(PERI_BASE + 61)
#define CLKID_SD_EMMC_B_CLK_DIV		(PERI_BASE + 62)
#define CLKID_SD_EMMC_B_CLK		(PERI_BASE + 63)
#define CLKID_ETH_RMII_SEL		(PERI_BASE + 64)
#define CLKID_ETH_RMII_DIV		(PERI_BASE + 65)
#define CLKID_ETH_RMII			(PERI_BASE + 66)
#define CLKID_ETH_DIV8			(PERI_BASE + 67)
#define CLKID_ETH_125M			(PERI_BASE + 68)
#define CLKID_SARADC_MUX		(PERI_BASE + 69)
#define CLKID_SARADC_DIV		(PERI_BASE + 70)
#define CLKID_SARADC_GATE		(PERI_BASE + 71)
#define CLKID_GEN_MUX			(PERI_BASE + 72)
#define CLKID_GEN_DIV			(PERI_BASE + 73)
#define CLKID_GEN_GATE			(PERI_BASE + 74)

#define MEDIA_BASE			(PERI_BASE + 75)
...
#define CLKID_HDMITX_2M_MUX		(MEDIA_BASE + 50)
#define CLKID_HDMITX_2M_DIV		(MEDIA_BASE + 51)
#define CLKID_HDMITX_2M			(MEDIA_BASE + 52)
#define CLKID_HDMITX_5M_MUX		(MEDIA_BASE + 53)
#define CLKID_HDMITX_5M_DIV		(MEDIA_BASE + 54)
#define CLKID_HDMITX_5M			(MEDIA_BASE + 55)
#define CLKID_HDMITX_CFG_MUX		(MEDIA_BASE + 56)
#define CLKID_HDMITX_CFG_DIV		(MEDIA_BASE + 57)
#define CLKID_HDMITX_CFG		(MEDIA_BASE + 58)

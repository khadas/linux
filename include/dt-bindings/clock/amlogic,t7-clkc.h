...
#define CLKID_BASE			(CLKID_PLL_BASE + 20)
...
#define CLKID_MCLK_0_DIV		(MEDIA_BASE + 72)
#define CLKID_MCLK_0			(MEDIA_BASE + 73)
#define CLKID_MCLK_1_SEL		(MEDIA_BASE + 74)
#define CLKID_MCLK_1_DIV		(MEDIA_BASE + 75)
#define CLKID_MCLK_1			(MEDIA_BASE + 76)

#define SYS_BASE			(MEDIA_BASE + 77)

...
#define INFUN dmtprintk(KERN_DEBUG "@DMT@ In %s: %s: %i\n", \
	__FILE__, __func__, __LINE__)
#define PRINT_X_Y_Z(x, y, z) dmtprintk(KERN_INFO \
	"@DMT@ X/Y/Z axis: %04d , %04d , %04d\n", (x), (y), (z))
#define PRINT_OFFSET(x, y, z) dmtprintk(KERN_INFO \
	"@offset@  X/Y/Z axis: %04d , %04d , %04d\n", \
...
/* AFEN set 0 , ATM[2:0]=b'000(normal),EN_Z/Y/X/T=1 */
#define VALUE_AFEM_Normal		0x0f
#define VALUE_INTC			0x00	/* INTC[6:5]=b'00 */
/* INTC[6:5]=b'01 (Data ready interrupt enable, active high at INT0) */
#define VALUE_INTC_Interrupt_En		0x20
/* ODR[3:0]=b'0000 (0.78125Hz), CCK[3:0]=b'0000 (102.4kHZ) */
#define VALUE_CKSEL_ODR_0		0x05
/* ODR[3:0]=b'0001 (1.5625Hz), CCK[3:0]=b'0000 (102.4kHZ) */
#define VALUE_CKSEL_ODR_1		0x15
/* ODR[3:0]=b'0010 (3.125Hz), CCK[3:0]=b'0000 (102.4kHZ) */
#define VALUE_CKSEL_ODR_3		0x25
/* ODR[3:0]=b'0011 (6.25Hz), CCK[3:0]=b'0000 (102.4kHZ) */
#define VALUE_CKSEL_ODR_6		0x35
/* ODR[3:0]=b'0100 (12.5Hz), CCK[3:0]=b'0000 (102.4kHZ) */
#define VALUE_CKSEL_ODR_12		0x45
/* ODR[3:0]=b'0101 (25Hz), CCK[3:0]=b'0000 (102.4kHZ) */
#define VALUE_CKSEL_ODR_25		0x55
/* ODR[3:0]=b'0110 (50Hz), CCK[3:0]=b'0000 (102.4kHZ) */
#define VALUE_CKSEL_ODR_50		0x65
/* ODR[3:0]=b'0111 (100Hz), CCK[3:0]=b'0101(102.4kHZ) */
#define VALUE_CKSEL_ODR_100		0x75

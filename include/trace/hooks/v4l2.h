...
#if !defined(_TRACE_HOOK_V4L2_H) || defined(TRACE_HEADER_MULTI_READ)
#define _TRACE_HOOK_V4L2_H
 ...
 */
DECLARE_HOOK(android_vh_v4l2_meta_ptr_update,
	TP_PROTO(struct vb2_v4l2_buffer *vbuf, struct v4l2_buffer *b),
	TP_ARGS(vbuf, b));

DECLARE_HOOK(android_vh_v4l2_fill_fmtdesc,

...
#ifdef CONFIG_COMPACTION
static void ClearPageMovable(struct page *page);
#else
static inline void ClearPageMovable(struct page *page) {}
#endif
static void reset_page(struct page *page)
{
	ClearPageMovable(page);
...
#ifdef CONFIG_COMPACTION
static void SetPageMovable(struct page *page, struct address_space *mapping)
{
	VM_BUG_ON_PAGE(!PageLocked(page), page);
				...
				struct page *newpage, struct page *oldpage)
{
	...
	SetPageMovable(newpage, page_mapping(oldpage));
}
...
static void SetZsPageMovable(struct zs_pool *pool, struct zspage *zspage)
{
	...
	do {
		...
		SetPageMovable(page, pool->inode->i_mapping);
		unlock_page(page);
	} while ((page = get_next_page(page)) != NULL);
}
#endif

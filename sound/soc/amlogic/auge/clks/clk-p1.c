...
/* pdmin0 */
CLOCK_COM_MUX(pdmin2, AUD_ADDR_OFFSET(EE_AUDIO_CLK_PDMIN_CTRL2), 0x7, 24);
CLOCK_COM_DIV(pdmin2, AUD_ADDR_OFFSET(EE_AUDIO_CLK_PDMIN_CTRL2), 0, 16);
CLOCK_COM_GATE(pdmin2, AUD_ADDR_OFFSET(EE_AUDIO_CLK_PDMIN_CTRL2), 31);
/* pdmin1 */
CLOCK_COM_MUX(pdmin3, AUD_ADDR_OFFSET(EE_AUDIO_CLK_PDMIN_CTRL3), 0x7, 24);
CLOCK_COM_DIV(pdmin3, AUD_ADDR_OFFSET(EE_AUDIO_CLK_PDMIN_CTRL3), 0, 16);
CLOCK_COM_GATE(pdmin3, AUD_ADDR_OFFSET(EE_AUDIO_CLK_PDMIN_CTRL3), 31);
...
static int p1_clks_init(struct clk **clks, void __iomem *iobase)
{
	...
	IOMAP_COM_CLK(pdmin2, iobase);
	clks[CLKID_AUDIO_PDMIN2] = REGISTER_CLK_COM(pdmin2);
	WARN_ON(IS_ERR_OR_NULL(clks[CLKID_AUDIO_PDMIN2]));

	IOMAP_COM_CLK(pdmin3, iobase);
	clks[CLKID_AUDIO_PDMIN3] = REGISTER_CLK_COM(pdmin3);
	WARN_ON(IS_ERR_OR_NULL(clks[CLKID_AUDIO_PDMIN3]));

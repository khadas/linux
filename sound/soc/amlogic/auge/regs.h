...
/* AUDIO RESAMPLE_ACC */
#define AUDIO_RSAMP_ACC_CTRL0              0x000
#define AUDIO_RSAMP_ACC_CTRL1              0x001
#define AUDIO_RSAMP_ACC_CTRL2              0x002
#define AUDIO_RSAMP_ACC_PHSINIT            0x003
#define AUDIO_RSAMP_ACC_PHSSTEP            0x004
#define AUDIO_RSAMP_ACC_SHIFT              0x005
#define AUDIO_RSAMP_ACC_ADJ_CTRL0          0x006
#define AUDIO_RSAMP_ACC_ADJ_CTRL1          0x007
#define AUDIO_RSAMP_ACC_ADJ_SFT            0x008
#define AUDIO_RSAMP_ACC_ADJ_IDET_LEN       0x009
#define AUDIO_RSAMP_ACC_ADJ_FORCE          0x00a
#define AUDIO_RSAMP_ACC_ADJ_KI_FORCE       0x00b
#define AUDIO_RSAMP_ACC_WATCHDOG_THRD      0x00c
#define AUDIO_RSAMP_ACC_DBG_INFO           0x00d
#define AUDIO_RSAMP_ACC_AOUT_FORCE         0x00e
#define AUDIO_RSAMP_ACC_IRQ_CTRL           0x00f
#define AUDIO_RSAMP_ACC_PKG_CTRL           0x019
#define AUDIO_RSAMP_ACC_POST_COEF0         0x020
#define AUDIO_RSAMP_ACC_POST_COEF1         0x021
#define AUDIO_RSAMP_ACC_POST_COEF2         0x022
#define AUDIO_RSAMP_ACC_POST_COEF3         0x023
#define AUDIO_RSAMP_ACC_POST_COEF4         0x024
#define AUDIO_RSAMP_ACC_AA_COEF_ADDR       0x030
#define AUDIO_RSAMP_ACC_AA_COEF_DATA       0x031
#define AUDIO_RSAMP_ACC_SINC_COEF_ADDR     0x040
#define AUDIO_RSAMP_ACC_SINC_COEF_DATA     0x041
#define AUDIO_RSAMP_ACC_RO_STATUS          0x050
#define AUDIO_RSAMP_ACC_RO_ADJ_FREQ        0x051
#define AUDIO_RSAMP_ACC_RO_ADJ_DIFF_BAK    0x052
#define AUDIO_RSAMP_ACC_RO_ADJ_DIFF_DLT    0x053
#define AUDIO_RSAMP_ACC_RO_ADJ_PHS_ERR     0x054
#define AUDIO_RSAMP_ACC_RO_ADJ_KI_OUT      0x055
#define AUDIO_RSAMP_ACC_RO_IN_CNT          0x056
#define AUDIO_RSAMP_ACC_RO_OUT_CNT         0x057
#define AUDIO_RSAMP_ACC_RO_ADJ_PHS_ERR_VAR 0x058

/* AUDIO ASRC WRAPPER */
#define AUDIO_ACC_ASRC_WRAPPER_TOP_CTL0    0x000
#define AUDIO_ACC_ASRC_WRAPPER_TOP_CTL1    0x001
#define AUDIO_ACC_ASRC_WRAPPER_TOP_CTL2    0x002
#define AUDIO_ACC_ASRC_WRAPPER_TOP_CTL3    0x003
#define AUDIO_ACC_ASRC_WRAPPER_TOP_CTL4    0x004
#define AUDIO_ACC_ASRC_WRAPPER_TOP_ST0     0x010
#define AUDIO_ACC_ASRC_WRAPPER_TOP_ST1     0x011

/* AUDIO EQDRC WRAPPER */
#define AUDIO_ACC_EQDRC_WRAPPER_TOP_CTL0   0x000
#define AUDIO_ACC_EQDRC_WRAPPER_TOP_CTL1   0x001
#define AUDIO_ACC_EQDRC_WRAPPER_TOP_CTL2   0x002
#define AUDIO_ACC_EQDRC_WRAPPER_TOP_CTL3   0x003
#define AUDIO_ACC_EQDRC_WRAPPER_TOP_CTL4   0x004
#define AUDIO_ACC_EQDRC_WRAPPER_TOP_ST0    0x010
#define AUDIO_ACC_EQDRC_WRAPPER_TOP_ST1    0x011

/* AUDIO ACC TOP */
#define AUDIO_ACC_CLK_GATE_EN              0x000
#define AUDIO_ACC_SW_RESERT                0x001
#define AUDIO_ACC_SECURITY_CTRL_0          0x00a
#define AUDIO_ACC_SECURITY_CTRL_1          0x00b
#define AUDIO_ACC_SECURITY_CTRL_2          0x00c
#define AUDIO_ACC_DBG_0                    0x010
#define AUDIO_ACC_DBG_1                    0x011
#define AUDIO_ACC_FRDDR_0_CTRL0            0x020
#define AUDIO_ACC_FRDDR_0_CTRL1            0x021
#define AUDIO_ACC_FRDDR_0_CTRL2            0x022
#define AUDIO_ACC_FRDDR_0_START_ADDR       0x023
#define AUDIO_ACC_FRDDR_0_INIT_ADDR        0x024
#define AUDIO_ACC_FRDDR_0_FINISH_ADDR      0x025
#define AUDIO_ACC_FRDDR_0_START_ADDRB      0x026
#define AUDIO_ACC_FRDDR_0_FINISH_ADDRB     0x027
#define AUDIO_ACC_FRDDR_0_INT_ADDR         0x028
#define AUDIO_ACC_FRDDR_0_RO_STATUS1       0x029
#define AUDIO_ACC_FRDDR_0_RO_STATUS2       0x02a
#define AUDIO_ACC_FRDDR_0_CTRL3            0x02b
#define AUDIO_ACC_FRDDR_1_CTRL0            0x030
#define AUDIO_ACC_FRDDR_1_CTRL1            0x031
#define AUDIO_ACC_FRDDR_1_CTRL2            0x032
#define AUDIO_ACC_FRDDR_1_START_ADDR       0x033
#define AUDIO_ACC_FRDDR_1_INIT_ADDR        0x034
#define AUDIO_ACC_FRDDR_1_FINISH_ADDR      0x035
#define AUDIO_ACC_FRDDR_1_START_ADDRB      0x036
#define AUDIO_ACC_FRDDR_1_FINISH_ADDRB     0x037
#define AUDIO_ACC_FRDDR_1_INT_ADDR         0x038
#define AUDIO_ACC_FRDDR_1_RO_STATUS1       0x039
#define AUDIO_ACC_FRDDR_1_RO_STATUS2       0x03a
#define AUDIO_ACC_FRDDR_1_CTRL3            0x03b
#define AUDIO_ACC_TODDR_0_CTRL0            0x040
#define AUDIO_ACC_TODDR_0_CTRL1            0x041
#define AUDIO_ACC_TODDR_0_CTRL2            0x042
#define AUDIO_ACC_TODDR_0_START_ADDR       0x043
#define AUDIO_ACC_TODDR_0_INIT_ADDR        0x044
#define AUDIO_ACC_TODDR_0_FINISH_ADDR      0x045
#define AUDIO_ACC_TODDR_0_START_ADDRB      0x046
#define AUDIO_ACC_TODDR_0_FINISH_ADDRB     0x047
#define AUDIO_ACC_TODDR_0_INT_ADDR         0x048
#define AUDIO_ACC_TODDR_0_RO_STATUS1       0x049
#define AUDIO_ACC_TODDR_0_RO_STATUS2       0x04a
#define AUDIO_ACC_TODDR_0_CHSYNC_CTRL      0x04b
#define AUDIO_ACC_TODDR_0_CHNUM_ID_0       0x04c
#define AUDIO_ACC_TODDR_0_CHNUM_ID_1       0x04d
#define AUDIO_ACC_TODDR_0_CHNUM_ID_2       0x04e
#define AUDIO_ACC_TODDR_0_CHNUM_ID_3       0x04f
#define AUDIO_ACC_TODDR_0_CHNUM_ID_4       0x050
#define AUDIO_ACC_TODDR_0_CHNUM_ID_5       0x051
#define AUDIO_ACC_TODDR_0_CHNUM_ID_6       0x052
#define AUDIO_ACC_TODDR_0_CHNUM_ID_7       0x053
#define AUDIO_ACC_TODDR_0_CTRL3            0x054
#define AUDIO_ACC_TODDR_1_CTRL0            0x060
#define AUDIO_ACC_TODDR_1_CTRL1            0x061
#define AUDIO_ACC_TODDR_1_CTRL2            0x062
#define AUDIO_ACC_TODDR_1_START_ADDR       0x063
#define AUDIO_ACC_TODDR_1_INIT_ADDR        0x064
#define AUDIO_ACC_TODDR_1_FINISH_ADDR      0x065
#define AUDIO_ACC_TODDR_1_START_ADDRB      0x066
#define AUDIO_ACC_TODDR_1_FINISH_ADDRB     0x067
#define AUDIO_ACC_TODDR_1_INT_ADDR         0x068
#define AUDIO_ACC_TODDR_1_RO_STATUS1       0x069
#define AUDIO_ACC_TODDR_1_RO_STATUS2       0x06a
#define AUDIO_ACC_TODDR_1_CHSYNC_CTRL      0x06b
#define AUDIO_ACC_TODDR_1_CHNUM_ID_0       0x06c
#define AUDIO_ACC_TODDR_1_CHNUM_ID_1       0x06d
#define AUDIO_ACC_TODDR_1_CHNUM_ID_2       0x06e
#define AUDIO_ACC_TODDR_1_CHNUM_ID_3       0x06f
#define AUDIO_ACC_TODDR_1_CHNUM_ID_4       0x070
#define AUDIO_ACC_TODDR_1_CHNUM_ID_5       0x071
#define AUDIO_ACC_TODDR_1_CHNUM_ID_6       0x072
#define AUDIO_ACC_TODDR_1_CHNUM_ID_7       0x073
#define AUDIO_ACC_TODDR_1_CTRL3            0x074
#define AUDIO_ACC_A2P_CONV_0               0x080
#define AUDIO_ACC_A2P_CONV_1               0x081
#define AUDIO_ACC_PATH_CTRL                0x082
